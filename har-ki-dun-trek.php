...
$Title = "Har Ki Dun Trek"; // Replace with the actual title of the trek
$canonical_link = "https://himalayayatri.com/har-ki-dun-trek.php"; // Replace with the actual canonical link for the trek
?>
...
<head>
  ...
  <title>Har Ki Dun Trek | The Trekker</title>
  <meta name="description" content="Har Dun Trek is a breath-taking adventure in the Indian Himalayas of the Indian Himalayas of Uttarakhand. Often referred to as the valley of gods, this trek mixes natural splendor with rich cultural heritage and deep spiritual significance. ">
  <meta name="author" content="Fusejack">
  <meta name="keywords" content="Har Ki Dun Trek, Har Ki Dun, Har Ki Dun Trek package, Har Ki Dun Trek best time" />
...
<body>
  ...
  <div class="gallery-container">
    ...
    <div class="gallery-main">
      <a href="img/packageImage/har-ki-dun-trek.jpg" data-lightbox="trek-gallery">
        <img src="img/packageImage/har-ki-dun-trek.jpg" alt="Har Ki Dun Trek">
      </a>
    </div>

    <!-- Side Images -->
    <div class="gallery-side">
      <a href="img/packageImage/har-ki-dun-trek-1.jpg" data-lightbox="trek-gallery">
        <img src="img/packageImage/har-ki-dun-trek-1.jpg" alt="Har Ki Dun Trek">
      </a>
      <a href="img/packageImage/har-ki-dun-trek-2.jpg" data-lightbox="trek-gallery">
        <img src="img/packageImage/har-ki-dun-trek-2.jpg" alt="Har Ki Dun Trek">
      </a>
      <a href="img/packageImage/har-ki-dun-trek-3.jpg" data-lightbox="trek-gallery">
        <img src="img/packageImage/har-ki-dun-trek-3.jpg" alt="Har Ki Dun Trek">
      </a>
      <a href="img/packageImage/har-ki-dun-trek-4.jpg" data-lightbox="trek-gallery">
        <img src="img/packageImage/har-ki-dun-trek-4.jpg" alt="Har Ki Dun Trek">
      </a>
    </div>
  ...
  <div class="slider-container">
    ...
    <!-- Images -->
    <img src="img/packageImage/har-ki-dun-trek.jpg" alt="Har Ki Dun Trek" class="active">
    <img src="img/packageImage/har-ki-dun-trek-1.jpg" alt="Har Ki Dun Trek">
    <img src="img/packageImage/har-ki-dun-trek-2.jpg" alt="Har Ki Dun Trek">
    <img src="img/packageImage/har-ki-dun-trek-3.jpg" alt="Har Ki Dun Trek">
  ...
  <h1 class="responsive-heading">Har Ki Dun Trek</h1>
  ...
  <div id="newPackageCard" class="package-box">
    <div class="">
      <div class="price-wrapper">
        <div>
          <small>Starting from <span class="old-price">&#8377; 8398</span></small><br>
      ...
      <div class="package-details" style="margin-top: 5px;margin-bottom: 5px; font-size: 14px;">
        <span style="font-weight: bold;">Package Option:</span> INR 8500/- Rishikesh to Rishikesh
      </div>
  ...
  <div id="packageCard" class="sticky-package">
    <div class="package-container-price">
      <div class="pricing-wrapper">
        <div>
          <small>Starting from <span class="crossed-price">&#8377; 8398</span></small><br>
        ...
        <div class="col-lg-8 active show scroll-offset" id="OVERVIEW-ITINERARY" role="tabpanel" aria-labelledby="OVERVIEW-ITINERARY-tab">
          ...
          <div id="ITINERARY" class="scroll-offset " role="tabpanel" aria-labelledby="Things-To-Carry-tab">
            ...
            <div class="package-side-box mobile-short-itinerary p-4 mb-8" style="background:#f6f6f6;border-radius:15px">
              ...
              <br>
              <h2>Har Ki Dun Trek Overview</h2>
              
              <p>Har Dun Trek is a breath-taking adventure in the Indian Himalayas of the Indian Himalayas of Uttarakhand. Often referred to as the "valley of gods", this trek mixes natural splendor with rich cultural heritage and deep spiritual significance. </p>
              <p>Through trekkers through green grasslands, ancient villages, dense forests and ice-covered peaks, it becomes an unforgettable experience of the untouched beauty of nature. Reaching a maximum height of 11,700 feet (3,566 m) with a base camp at 6,400 feet (1,950 m) at 6,400 feet (1,950 m), the trek panoramic offers Himalayan views that actually feel like standing on top of the world. </p>
                 <p>Drawing the trekkers in the ancient forest of Uttarakhand, the winds of the footpaths through various scenarios including Tranwil Meadows, dense oak and pine forests and royal mountains. The best weather for each's Dun trek is spring (April -zoon) and autumn (September -November) when clear sky and pleasant weather increases trekking experience. Moderately challenging, the trek is suitable for both beginner and experienced courageous. Spread for 7 to 8 days and covering about 47 km, it offers enough time to absorb the calm environment and cultural prosperity of the region</p>
                   
             <hr/>
             
             <p><b>Mythological and Historical Significance</b></p>
             <p>Har Ki Dun Valley is immersed in mythological importance, especially associated with Mahabharata. It is believed that the Pandavas took this route on their last visit to heaven. Located among the powerful Swargorohini peaks, the Galley holds a special place in Indian folklore. Historically, this ancient route has been used by local shepherds and traders for centuries, which combines its charm. The timeless villages of this region still preserve the old customs, architecture and methods of life, which offer a glimpse in the rich past of Uttarakhand.</p>
              ...
              <hr/>
               ...
               <p><b>The Harmony of Spirituality, Culture, and Nature</b></p>
               <p>Har Ki Dun trek is an ideal mix of spiritual peace, cultural immersion and natural beauty. As trekkers pass through remote villages, they get a first experience of Garhwali traditions and hospitality. The trek takes you through lush green grasslands, ancient oak and cedar forests and pine-covered peaks, which offers a trip that refreshes both the body and the soul.</p>
              ...
              <p>The journey begins with the morning drive from Dehradun to narrow, which is a base camp for Har's Dun trek. This scenic drive takes you through green forests, attractive villages and curved mountain roads. The route passes through Mussoorie, Purola and Mori, offering breathtaking scenes of Ton River Valley. As soon as you climb, the landscape turns from dense forests to rugged mountains. On reaching Sankri, you can settle in a guesthouse or homestay, enjoy a warm food, and be ready for further trek.</p>
              
              

              <p>Day 2: Sankri to Dhatmeer (Drive) & Trek to Osla Village</p>
              <ul>
                 <li><strong> Altitude:</strong> Dhatmeer 8,000 Ft. | Osla 9,000 Ft.</li>
                 <li><strong>Drive Distance:</strong> Sankri to Dhatmeer 18 km | 1-1.5 Hours</li>
                <li><strong>Trek Distance:</strong> 18 km | 6-7 Hours</li>
                
           
                
              </ul>
              <p>After an early breakfast, a small drive from narrow to Dhatmeer marks the onset of trek. The trek begins with a soft climb through dense cedar and cedar forests, flowing along the river. As you move forward, you pass through strange Garhwali villages, terraced fields and wooden houses, which are accompanied by complex carving. After a gradual climb, you reach Osla village, which is known for its unique wooden architecture and ancient temples. Here, you can interact with the locals and experience the rich culture of the region before resting for the night.</p>

              <p>Day 3: Osla Village to Basla Khal</p>
              <ul>
                  <li><strong>Altitude Basla Khal:</strong> 10,700 Ft.</li>
                  <li><strong>Trek Distance:</strong> 7 km | 4-5 Hours</li>
               
                
              </ul>
              <p>The trek from Osla to Basla Khal mesmerizes the Swargarohini peaks. The scar gradually passes through dense forests of oak, pine and rhododendron, sometimes opens to panoramic grasslands. The way, you are grazing the sheep and shepherd huts, adding the attraction of the journey. When you reach Basla Khal, with the amazing scenes of Har Ki Dun Valley, the scenes become even more spectacular. The camp makes an overnight camp for an unforgettable experience under a star-lit sky.</p>

             <p>Day 4: Basla Khal to Har Ki Dun and Back to Basla Khal</p>
              <ul>
                  <li><strong>Altitude Har Ki Dun:</strong>  11,800 Ft.</li>
                  <li><strong>Trek Distance:</strong> 8 km (one way) | 6-7 Hours</li>
               
              
              </ul>
              <p>This is the most exciting and rewarding day of the trek, as you make your way to the Dun Valley, amazing. The scar gradually passes through Alpine Meadows, Glassel Moren and River Crossing. As you reach Har Ki Dun, the 360-degree scene of snow-capped peaks, including Swargarohini Peak etc, appears in front of you. The valley, rich in mythological importance, is believed to be the path taken by the Pandavas on the path of heaven. After spending some time and capturing the photos, you will return to Basla Khal to stay overnight.</p>

             <p>Day 5: Basla Khal to Pauni Gharat</p>
              <ul>
                 <li><strong> Altitude Pauni Gharat:</strong>  8,200 Ft.</li>
                  <li><strong>Trek Distance:</strong> 8-9 km | 4-5 Hours</li>
               
              
              </ul>
              <p>The lineage from Basla Khal to Pauni Gharat is a comfortable walk through dense forests, rivers and open grasslands yet. The mark follows the Ton River, which has picturesque views of waterfalls and small wooden bridges along the way. You will pass bizarre Himalayan villages, where you can interact with local people and learn about their simple way of life yet. On reaching Pauni Gharat, you will organize camps and enjoy a peaceful evening from the river.</p>
              
              <p>Day 6: Pauni Gharat to Dhatmeer (Trek) & Drive to Sankri</p>
              <ul>
                 <li><strong> Altitude Sankri:</strong>  6,400 Ft.</li>
               <li><strong> Trek Distance:</strong> 7-8 km | 3-4 Hours</li>
               <li><strong> Drive Distance:</strong> 18 km | 1-1.5 Hours</li>
               
              </ul>
              <p>After an early breakfast, you will return the metal, leave your steps behind through the forests and grasslands. The lineage is relatively easy, allowing you to enjoy the surprising surroundings one last time. Once you reach Dhatmeer, a small drive takes you back into the narrow, marking the end of the trekking trip. You can relax in Sankri, find the village, and fellow trekkers can celebrate the completion of the trek.</p>
              
              <p>Day 7: Sankri to Dehradun</p>
              <ul>
               <li><strong> Drive Distance: :</strong> 220 Km</li>
                <li><strong>Drive Duration:</strong> 10 Hours</li>
              
                
                
              </ul>
              <p>The last day includes a beautiful drive from Sankri to Dehradun, leaving behind the beautiful route through the Garhwal Himalayas. When you get down, you will once again pass through forests, valleys and villages, the memories of the trek are still fresh in your mind. This journey ends in Dehradun, where you can either continue your journey or return home, take unforgettable experience from each dun trek.</p>
            </div>
          </div>
          <!-- ITINERARY ENDS -->
          ...
          <div class="scroll-offset " id="SHORT-ITINERARY" role="tabpanel" aria-labelledby="Things-To-Carry-tab">
            ...
            <div class="package-side-box mobile-short-itinerary p-4 mb-4" style="background:#f6f6f6;">
             ...
             <p><b>Day 1:</b> Dehradun to Sankri </p>
              ...
              <p><b>Day 2:</b> Sankri to Dhatmeer and Trek to Osla Village</p>
              

             <p><b>Day 3:</b> Osla Village to Basla Khal </p>
             

              <p><b>Day 4:</b> Basla Khal to Har Ki Dun and Back to Basla Khal </p>
              

              <p><b>Day 5:</b> Basla Khal to Pauni Gharat</p>
             
<p><b>Day 6:</b> Pauni Gharat to Dhatmeer and drive to Sankri </p>
<p><b>Day 7:</b> Sankri To Dehradun</p>
            </div>
          ...
          <div class="scroll-offset " id="BEST-TIME" role="tabpanel" aria-labelledby="Things-To-Carry-tab">
            ...
            <div class="package-side-box mobile-short-itinerary p-4 mb-4" style="background:#f6f6f6;">
              ...
              <p>Timing is crucial for an enjoyable trekking experience. The ideal seasons are:</p>

             <p><b>Mid-April to Mid-June (Spring & Early Summer):</b></p>
              <ul>
                <li>Clear skies, moderate temperatures, and blooming rhododendrons.</li>
                <li>Pleasant weather makes trekking easier and more enjoyable.</li>
                
               
              </ul>

              <p><b>Mid-September to Mid-November (Autumn):</b></p>
              <ul>
                <li>Crisp, clear views of the Himalayas with cooler temperatures.</li>
                <li>Night temperature: 0° C to -5° C (32° F to 23° F) </li>
                <li>Less crowded trails and stable weather conditions.</li>
        ...
        <div>
          ...
          <div class="scroll-offset" id="FAQ" role="tabpanel" aria-labelledby="FAQ-tab">
            ...
            <div class="package-side-box mobile-short-itinerary p-4 mb-4" style="background:#f6f6f6;">
              ...
              <p><b>1. What is the best time to visit Har Ki Dun?</b></p>
<p>The best time to visit is from April to June and September to November when the weather is clear, and the views are stunning.</p>

 

 <p><b>2. What is the highest altitude of this trek?</b></p>
<p>The highest altitude is 11,800 feet at Har Ki Dun.</p>

 <p><b>3. How long is the trek?</b></p>
<p>The trek lasts about seven days and covers approximately 47 kilometers.</p>

 <p><b>4. What kind of accommodation is available?</b></p>
<p>You will stay in guesthouses, homestays, and campsites during the trek.</p>

 <p><b>5. Do I need a guide for the trek?</b></p>
<p>It is recommended to go with a guide or a trekking group for safety and better navigation.</p>

 <p><b>6. What should I pack for the trek?</b></p>
<p>Warm clothes, trekking shoes, a rain jacket, basic medicines, a water bottle, and some energy snacks are essential.</p>

 <p><b>7. Is there mobile network coverage on the trek?</b></p>
<p>Network connectivity is limited, and you may not get a signal after Sankri.</p>

 <p><b>8. What kind of food is provided during the trek?</b></p>
<p>Simple vegetarian meals like rice, chapati, dal, and vegetables are provided.</p>

 <p><b>9. How do I reach the starting point of the trek?</b></p>
<p>You need to reach Dehradun first, then take a taxi or bus to Sankri, the base camp.</p>

 <p><b>10. Is prior trekking experience required?</b></p>
<p>No, but good fitness is important as the trek involves long walking hours and altitude gain.</p>

 <p><b>11. Will there be snowfall during the trek?</b></p>
<p>If you trek in winter (December to February), you will experience heavy snowfall. In other seasons, the trails are mostly clear.</p>

<p><b>12. Is this trek suitable for beginners?</b></p>
<p>Yes, it is a moderately difficult trek, so beginners can do it with some preparation and good fitness.</p>
