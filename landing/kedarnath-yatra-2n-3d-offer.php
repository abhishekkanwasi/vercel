...
<head>
  ...
  <title>2023 Kedarnath Yatra Tour from Haridwar 2N/3D - Trekveda</title>
  <!-- Favicons-->
  <!-- Favicons-->
...
<body>
  <style>
    .from_conatinaer {
      ...
      background-image: url("http://trekveda.com/images/slides/kedarnath-3n-4d-offer-banner.jpg");
      /* The image used */
  ...
  <section class="jumbotron text-center from_conatinaer py-4" id="main-form">
    ...
    <div class="container">
      <h1 class="jumbotron-heading">Kedarnath Yatra Tour from Haridwar 2N/3D</h1>
      ...
      <div class="form-container text-center d-flex justify-content-center">
        ...
        <form method="post" action="form-submission.php" class="landing_page_submit_form col-md-8 p-0 m-0">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="trek_name" value="Kedarnath Yatra Tour from Haridwar 3 Days" />
            <input type="hidden" name="Package_link" value="https://trekveda.com/tour/tour-packages/kedarnath-yatra-2n-3d" />
          </div>
        ...
        <div class="card">
          <div class="card-body" id="pack_detail_card">
            <div class="row">
              ...
              <h4 class="price-field text-left col-9"><small style="color:gray"><s> &#8377; 10400</s></small> &#8377; <b><span id="mainprice" style="color:#f7472e;" onchange="onpricechange()"> 6500</span></b><small id="gst_text"> +5% GST</small></h4>
              <h6 class="card-price col-3 text-right"><mark class="top-mark">38% OFF</mark></b></h6>
            ...
            <ul>
              <li class="flex-container mb-2">
                ...
                <div style="border-right: 2px solid #dadada;"><i class="fa fa-mountain" style="color: #ff6219"></i> 11745 ft.</div>
                <div><i class="fa fa-route" style="color: #ff6219"></i> 32 Km</div>
              </li>
              <hr>

              <li class="flex-container mb-2">
                <div style="border-right: 2px solid #dadada;"><b>Start</b> : Haridwar</div>
                <div style="border-right: 2px solid #dadada;"><b>End</b> : Haridwar</div>
        ...
        <div class="card ellipsis mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <ul class="fa-ul">
              ...
              <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span> 02 Nights Accommodation during the trip will be provided using Standard Category of hotel / Home stay/ Guest House at all location in Base room category on Triple sharing basis.</li>
              ...
              <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span> Local Taxi charges from Sonprayag to Gaurikund and back.</li>
              <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span> Any Meals in Kedarnath.</li>
              <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span> Accommodation and Meals in Haridwar ( Will be subject to additional cost).</li>
              ...
              <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span> Airport pickup and drop services ( Will be subject to additional cost).</li>
                ...
                <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span> Any pony Cost for Kedarnath Trek on direct payment – Subject to additional cost.</li>
        ...
        <div class="card ellipsis mb-5 mb-lg-0">
          <div class="card-body">
                <p class="h4 card-title text-center package-heading-side">Short Itinerary</p>
                    <ul class="timeline">
                        <li>
                            <p>Day 01: Haridwar– Guptkashi / Phata / Sonprayag (1319 Meters) by surface 225 Kms approx 6-7 Hrs.</p>
                         </li>
                        <li>
                            <p>Day 02: Guptkashi / Sonprayag to Kedarnath Temple by surface approx 30 Kms and By Trek 16 Kms.</p>
                        </li>
                        <li>
                            <p>Day 03: Kedarnath – Gaurikund by Trek - Sonprayag – Haridwar.</p>
                        </li>
                          <li>
 ...
 <style>
    ...
    <hr/>
       ...
       <div class="col-md-12 text-center section-title">
        ...
        <h4 style="font-weight: 600">Kedarnath Yatra Tour from Haridwar - Available Fix Departure Dates 2023 - 100% Guaranteed</h4>
       <br/>
        <table style="border: 1px solid black; padding:5px; width: 50%; margin-left: auto; margin-right: auto">
            <tr style="border: 1px solid black; padding:5px">
                <td style="border: 1px solid black; padding:5px; font-weight: 600">Date</td>
                <td style="border: 1px solid black; padding:5px; font-weight: 600">Max Group Size</td>
                <td style="border: 1px solid black; padding:5px; font-weight: 600">Available Slots</td>
                </tr>
            ...
            <tr style="border: 1px solid black; padding:5px">
                <td style="border: 1px solid black; padding:5px">11/Aug/2023</td>
                <td style="border: 1px solid black; padding:5px">12</td>
                <td style="border: 1px solid black; padding:5px">Available</td>
           
           
            </tr>
            
            <tr style="border: 1px solid black; padding:5px">
                <td style="border: 1px solid black; padding:5px">18/Aug/2023</td>
                <td style="border: 1px solid black; padding:5px">12</td>
                <td style="border: 1px solid black; padding:5px">Available</td>
            ...
            <tr style="border: 1px solid black; padding:5px">
                <td style="border: 1px solid black; padding:5px">25/Aug/2023</td>
                <td style="border: 1px solid black; padding:5px">12</td>
                <td style="border: 1px solid black; padding:5px">Available</td>
            ...
            <tr style="border: 1px solid black; padding:5px">
                <td style="border: 1px solid black; padding:5px">1/Sep/2023</td>
                <td style="border: 1px solid black; padding:5px">12</td>
                <td style="border: 1px solid black; padding:5px">Available</td>
            ...
            <tr style="border: 1px solid black; padding:5px">
                <td style="border: 1px solid black; padding:5px">8/Sep/2023</td>
                <td style="border: 1px solid black; padding:5px">12</td>
                <td style="border: 1px solid black; padding:5px">Available</td>
            ...
            <tr style="border: 1px solid black; padding:5px">
                <td style="border: 1px solid black; padding:5px">15/Sep/2023</td>
                <td style="border: 1px solid black; padding:5px">12</td>
                <td style="border: 1px solid black; padding:5px">Available</td>
            ...
            <tr style="border: 1px solid black; padding:5px">
                <td style="border: 1px solid black; padding:5px">22/Sep/2023</td>
                <td style="border: 1px solid black; padding:5px">12</td>
                <td style="border: 1px solid black; padding:5px">Available</td>
            ...
            <tr style="border: 1px solid black; padding:5px">
                <td style="border: 1px solid black; padding:5px">29/Sep/2023</td>
                <td style="border: 1px solid black; padding:5px">12</td>
                <td style="border: 1px solid black; padding:5px">Available</td>
            ...
            <tr style="border: 1px solid black; padding:5px">
                <td style="border: 1px solid black; padding:5px">6/Oct/2023</td>
                <td style="border: 1px solid black; padding:5px">12</td>
                <td style="border: 1px solid black; padding:5px">Available</td>
             ...
             <tr style="border: 1px solid black; padding:5px">
                <td style="border: 1px solid black; padding:5px">13/Oct/2023</td>
                <td style="border: 1px solid black; padding:5px">12</td>
                <td style="border: 1px solid black; padding:5px">Available</td>
             ...
             <tr style="border: 1px solid black; padding:5px">
                <td style="border: 1px solid black; padding:5px">20/Oct/2023</td>
                <td style="border: 1px solid black; padding:5px">12</td>
                <td style="border: 1px solid black; padding:5px">Available</td>
             ...
             <tr style="border: 1px solid black; padding:5px">
                <td style="border: 1px solid black; padding:5px">27/Oct/2023</td>
                <td style="border: 1px solid black; padding:5px">12</td>
                <td style="border: 1px solid black; padding:5px">Available</td>
             ...
             <tr style="border: 1px solid black; padding:5px">
                <td style="border: 1px solid black; padding:5px">3/Nov/2023</td>
                <td style="border: 1px solid black; padding:5px">12</td>
                <td style="border: 1px solid black; padding:5px">Available</td>
             ...
             <tr style="border: 1px solid black; padding:5px">
                <td style="border: 1px solid black; padding:5px">10/Nov/2023</td>
                <td style="border: 1px solid black; padding:5px">12</td>
                <td style="border: 1px solid black; padding:5px">Available</td>
   ...
   <div class="album py-5 bg-light">
      <div class="col-md-12 text-center section-title">
      <h2>Popular Yatra Tour Packages 2023</h2>
...
<div class="col-md-4 col-lg-3">
        ...
        <div class="col-md-4 col-lg-3">
         ...
         <div class="col-md-4 col-lg-3">
          <?php
          $sql = "select * FROM Tour_package_pages  where Title = 'Char Dham Yatra from Haridwar Basic Tour Package' ;";
          $result = $conn->query($sql);
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/tour/tour-packages/char-dham-yatra-haridwar-8-days" target="_Blank">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>POPULAR</span></div>
              <img class="card-img-top" src="<?php echo $root1 ?>/<?php echo $row['card_image']; ?>" alt="<?php echo $row['Title']; ?>">
              <div class="p-2">
    ...
    <div class="row">
        <div class="col-md-4">
            <img src="../img/offer/google-reviews/kedarnath-google-review-1.png" width="100%"/>
        </div>

        <div class="col-md-4">
            <img src="../img/offer/google-reviews/kedarnath-google-review-2.png" width="100%"/>
        </div>

        <div class="col-md-4">
            <img src="../img/offer/google-reviews/kedarnath-google-review-3.png" width="100%"/>
        </div>
        
        <div class="col-md-4">
            <img src="../img/offer/google-reviews/kedarnath-google-review-4.png" width="100%"/>
        </div>
        
        <div class="col-md-4">
            <img src="../img/offer/google-reviews/kedarnath-google-review-5.png" width="100%"/>
        </div>
        
        <div class="col-md-4">
            <img src="../img/offer/google-reviews/kedarnath-google-review-6.png" width="100%"/>
        </div>
 ...
 <div class="container mb-4">
    ...
    <div class="row">
        ...
        <div class="video-testimonial-block">
          ...
          <div class="video">
            <iframe src="https://www.youtube.com/embed/UML2tDyy-yY" allowfullscreen>
            </iframe>
          </div>

        </div>
        <div class="video-testimonial-content">
          <h4 class="mb10">Kedarnath Yatra | Customer Review - 1</h4>
       ...
       <div class="col-md-4">
        <div class="video-testimonial-block">
          <!-- <div class="video-thumbnail"><img src="https://easetemplate.com/free-website-templates/finvisor/images/testi_img_2.jpg" alt="" class="img-fluid"></div> -->
          <div class="video">
            <iframe src="https://www.youtube.com/embed/rXH1TU12KIY" allowfullscreen>
            </iframe>
          </div>

        </div>
        <div class="video-testimonial-content">
          <h4 class="mb10">Kedarnath Yatra | Customer Review - 2</h4>
          <!-- <p>Retirement Planning</p> -->
        </div>
      </div>
        ...
        <div class="video-testimonial-content">
          <h4 class="mb10">Kedarnath Yatra | Customer Review - 3</h4>
          <!-- <p>Retirement Planning</p> -->
        </div>
      </div>
       ...
       <div class="col-md-4">
        ...
        <div class="video-testimonial-content">
          <h4 class="mb10">Kedarnath Yatra | Customer Review - 4</h4>
          <!-- <p>Retirement Planning</p> -->
        </div>
      </div>
        ...
        <div class="video-testimonial-content">
          <h4 class="mb10">Char Dham Yatra | Customer Review - 5</h4>
          <!-- <p>Retirement Planning</p> -->
        </div>
      </div>
