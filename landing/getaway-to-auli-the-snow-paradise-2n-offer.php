...
<head>
  ...
  <title>Getaway to Auli - The Snow Paradise 2N - Trekveda</title>
  <!-- Favicons-->
  <!-- Favicons-->
...
<body>
  <style>
    .from_conatinaer {
      ...
      background-image: url("http://trekveda.com/images/slides/auli-the-snow-paradise-offer-banner.webp");
      /* The image used */
  ...
  <section class="jumbotron text-center from_conatinaer py-4" id="main-form">
    ...
    <div class="container">
      <h1 class="jumbotron-heading">Getaway to Auli - The Snow Paradise 2N</h1>
      ...
      <div class="form-container text-center d-flex justify-content-center">
        ...
        <form method="post" action="form-submission.php" class="landing_page_submit_form col-md-8 p-0 m-0">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="trek_name" value="Getaway to Auli - The Snow Paradise 2N" />
            <input type="hidden" name="Package_link" value="https://trekveda.com/tour/tour-packages/auli-tour-from-rishikesh" />
          </div>
  ...
  <div class="container my-4">
    <div class="row">
      ...
      if (mysqli_connect_error()) {
        ...
        $sql = "select * FROM Tour_package_pages where Title = 'Getaway to Auli - The Snow Paradise 2N' ;";
            ...
            <ul>
              <li class="flex-container mb-2">
                <div style="border-right: 2px solid #dadada;"><i class="fa fa-calendar-alt" style="color: #ff6219"></i> 3 Days</div>
                 <div style="border-right: 2px solid #dadada;"><i class="fa fa-mountain" style="color: #ff6219"></i> N/A</div>
                <div><i class="fa fa-route" style="color: #ff6219"></i> N/A</div>
             </li>
              <hr>

              <li class="flex-container mb-2">
                <div style="border-right: 2px solid #dadada;"><b>Start</b> : Rishikesh</div>
                <div style="border-right: 2px solid #dadada;"><b>End</b> : Rishikesh</div>
          ...
          <div class="card-body">
            ...
            <ul class="fa-ul">
              <li><span class="fa-li"></span><strong>Inclusion in cost during the trek:</strong></li>
                 <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span>02 Nights Accommodation during the trip will be provided using Standard Category of camp in Auli on Triple sharing basis.</li>
                <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span>Meals as specified in the itinerary on MAP basis i.e. Breakfast & Dinner on fixed menu basis at booked accommodation. </li>
                <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span>Transportation using swift Desire car Non-AC in hills (Pick up / drop from Tapovan Rishikesh).</li>
               ...
               <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span>Mandatory GST of 5% on Invoice Amount.</li>
                ...
                <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span>Any entrances fee, monument, temple, museum, wildlife fee etc. </li>
                <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span>Hot traditional lunch at additional cost in Lata village. </li>
                <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span>Cable car Charges in Auli. </li>
              <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span>Trek to Gorson Bugyal at additional cost and prior information required. </li>
              <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span>Accommodation and Meals in Rishikesh (Will be subject to additional cost). </li>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12">
        ...
        <ul class="timeline">
          <li>
            <a href="#">Day 1</a>
            <p>Rishikesh to Auli by surface 260 Kms approx 8-9 Hrs.</p>
          </li>
          <li>
            <a href="#">Day 2</a>
            <p>In Auli – Local Exploration.</p>
          </li>
          <li>
            <a href="#">Day 3</a>
            <p>Auli – Rishikesh by surface 260 Kms approx 8-9 Hrs.</p>
          </li>
        </ul>
    ...
    <div class="container">
      ...
      <!-- <p>Quisque tempus justo molestie lacus blandit</p> -->
        ...
        <div class="col-md-4 col-lg-3">
          <?php
          $sql = "select * FROM Tour_package_pages  where Title = 'Short Break - Auli with Chopta 3N' ;";
          $result = $conn->query($sql);
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/tour/tour-packages/auli-chopta-tour-uttarakhand">
            <div class="box">
        ...
        <div class="col-md-4 col-lg-3">
          <?php
          $sql = "select * FROM Tour_package_pages  where Title = 'Auli with Niti Valley - Spiti of Uttarakhand' ;";
          $result = $conn->query($sql);
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/tour/tour-packages/auli-niti-valley-tour">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>POPULAR</span></div>
              <img class="card-img-top" src="<?php echo $root1 ?>/<?php echo $row['card_image']; ?>" alt="<?php echo $row['Title']; ?>">
              <div class="p-2">
        ...
        <div class="col-md-4 col-lg-3">
          <?php
          $sql = "select * FROM Tour_package_pages  where Title = 'Auli Snow Skiing Tour' ;";
          $result = $conn->query($sql);
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/tour/tour-packages/auli-skiing-tour">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>POPULAR</span></div>
              <img class="card-img-top" src="<?php echo $root1 ?>/<?php echo $row['card_image']; ?>" alt="<?php echo $row['Title']; ?>">
              <div class="p-2">
