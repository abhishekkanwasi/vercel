...
<head>
  ...
  <title>Brahmatal Trek 2023 - Trekveda</title>
  <!-- Favicons-->
  <!-- Favicons-->
...
<body>
  <style>
    .from_conatinaer {
      ...
      background-image: url("http://trekveda.com/images/slides/brahmatal-trek-offer-banner.webp");
      /* The image used */
 ...
 <section class="jumbotron text-center from_conatinaer py-4" id="main-form">
    ...
    <div class="container">
      <h1 class="jumbotron-heading">Brahmatal Trek</h1>
      ...
      <div class="form-container text-center d-flex justify-content-center">
        ...
        <form method="post" action="form-submission.php" class="landing_page_submit_form col-md-8 p-0 m-0">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="trek_name" value="Brahmatal Trek" />
            <input type="hidden" name="Package_link" value="https://trekveda.com/trek/brahmatal-trek.php" />
          </div>
        ...
        <div class="card">
          <div class="card-body" id="pack_detail_card">
            <div class="row">
              ...
              <h6 class="card-price col-3 text-right"><mark class="top-mark">28% OFF</mark></b></h6>
            ...
            <ul>
              <li class="flex-container mb-2">
                ...
                <div style="border-right: 2px solid #dadada;"><i class="fa fa-mountain" style="color: #ff6219"></i> 12,250 ft.</div>
                <div><i class="fa fa-route" style="color: #ff6219"></i> 22 Km</div>
              </li>
              <hr>

              <li class="flex-container mb-2">
                <div style="border-right: 2px solid #dadada;"><b>Start</b> : Lohajung</div>
                <div style="border-right: 2px solid #dadada;"><b>End</b> : Lohajung</div>
        ...
        <div class="card ellipsis mb-5 mb-lg-0">
          <div class="card-body">
           <p class="h4 card-title text-center package-heading-side">Short Itinerary</p>
            <ul class="timeline">
          <li>
            <p>Day 1: Reach Lohajung.</p>
          </li>
          <li>
            <p>Day 2: Lohajung to Bekaltal.</p>
          </li>
          <li>
            <p>Day 3: Bekaltal to Brahmatal.</p>
          </li>
          <li>
            <p>Day 4: Brahmatal to Brahmatal Peak and back.</p>
          </li>
          <li>
            <p>Day 5: Brahmatal to Lohajung via Jhandi Top.</p>
          </li>
          <li>
            <p>Day 6: Departure from Lohajung.</p>
          </li>
        </ul>
          </div>
        </div>
 ...
 <br/>
   ...
   <hr/>
    ...
    <div class="row">
        <div class="col-md-4">
            <img src="../img/offer/google-reviews/brahmatal-review-1.png" width="100%"/>
        </div>

        <div class="col-md-4">
            <img src="../img/offer/google-reviews/brahmatal-review-2.png" width="100%"/>
        </div>

        <div class="col-md-4">
            <img src="../img/offer/google-reviews/brahmatal-review-3.png" width="100%"/>
        </div>
        
        <div class="col-md-4">
            <img src="../img/offer/google-reviews/brahmatal-review-4.png" width="100%"/>
        </div>
        
        <div class="col-md-4">
            <img src="../img/offer/google-reviews/brahmatal-review-5.png" width="100%"/>
        </div>
        
          <div class="col-md-4">
            <img src="../img/offer/google-reviews/brahmatal-review-6.png" width="100%"/>
        </div>
