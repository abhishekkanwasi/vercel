<?php
    ...
    $email_subject = "Form Submission PPC Bagini Glacier";
...
<div class="container">
	<div class="row text-center">
        ...
        <a href="https://trekveda.com/trek/bagini-glacier-and-changabang-base-camp-trek.php" class="btn btn-success">     Read More      </a>
    <br><br>
        </div>
