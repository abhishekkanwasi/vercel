...
<head>
  ...
  <title>Kalindikhal Pass Trek</title>
  <!-- Favicons-->
  <!-- Favicons-->
...
<body>
  <style>
    .from_conatinaer {
      ...
      background-image: url("http://trekveda.com/images/slides/kalindikhal-pass-trek-offer-banner.webp");
      /* The image used */
  ...
  <section class="jumbotron text-center from_conatinaer py-4" id="main-form">
    ...
    <div class="container">
      <h1 class="jumbotron-heading">Kalindikhal Pass Trek</h1>
      ...
      <div class="form-container text-center d-flex justify-content-center">
        ...
        <form method="post" action="form-submission.php" class="landing_page_submit_form col-md-8 p-0 m-0">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="trek_name" value="Kalindikhal Pass Trek" />
            <input type="hidden" name="Package_link" value="https://trekveda.com/trek/kalindikhal-pass-trek.php" />
          </div>
          ...
          <div class="card-body" id="pack_detail_card">
            ...
            <ul>
              <li class="flex-container mb-2">
                <div style="border-right: 2px solid #dadada;"><i class="fa fa-calendar-alt" style="color: #ff6219"></i> 15 Days</div>
                <div style="border-right: 2px solid #dadada;"><i class="fa fa-mountain" style="color: #ff6219"></i> 19,512 ft.</div>
                <div><i class="fa fa-route" style="color: #ff6219"></i> -- Km</div>
              </li>
              <hr>

              <li class="flex-container mb-2">
                <div style="border-right: 2px solid #dadada;"><b>Start</b> : Gangnani</div>
                <div style="border-right: 2px solid #dadada;"><b>End</b> : Badrinath</div>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="card ellipsis mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <?php
            $sql = "SELECT * FROM Treking_date where Trek_name = 'Kalindikhal Pass Trek' ";
            $result = $conn->query($sql);
            while ($row = $result->fetch_assoc())
              for ($i = 1; $i < 367; $i++) {
                $date[$i] = $row['Date_' . $i];
            ...
            $sql1 = "SELECT * FROM Treking_date_Status where Trek_name = 'Kalindikhal Pass Trek' ";
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <ul class="timeline">
          ...
          <li>
            <a href="#">Day 2</a>
            <p>Gangnani to Gangotri (Rest and Acclimatization Day) (3,048 m) - 1.5 h drive.</p>
          </li>
          <li>
            <a href="#">Day 3</a>
            <p>Gangotri to Bhojbasa (3,800 m)- 7-8 h trek.</p>
          </li>
           <li>
            <a href="#">Day 4</a>
            <p>Bhojbasa to Gaumukh (3,900 m) to Tapovan (4,335 m)- 6-7 h trek.</p>
          </li>
           <li>
            <a href="#">Day 5</a>
            <p>Rest and Acclimatization Day at Tapovan (4,335 m).</p>
          </li>
           <li>
            <a href="#">Day 6</a>
            <p>Tapovan to Nandanvan (4,340 m)- 6-7 h trek.</p>
          </li>
           <li>
            <a href="#">Day 7</a>
            <p>Nandanvan to Vasuki Tal (4,463 m)- 6-7 h trek.</p>
          </li>
           <li>
            <a href="#">Day 8</a>
            <p>Vasuki Tal to KharaPathar (SuralyaBamak - 5,450 m) - 7-8 h trek.</p>
          </li>
           <li>
            <a href="#">Day 9</a>
            <p>KharaPathar to Sweta Glacier (5,500 m) - 5-6 h trek.</p>
          </li>
           <li>
            <a href="#">Day 10</a>
            <p>Sweta Glacier to Kalindikhal base (5,600 m) - 6-7 h trek.</p>
          </li>
           <li>
            <a href="#">Day 11</a>
            <p>Kalindikhal Base to Raj Parav (4,910 m) via KalindiKhal (5,947 m) - 10-11 h trek.</p>
          </li>
           <li>
            <a href="#">Day 12</a>
            <p>Raj Parav to Arwatal (3,910 m) - 6-7 h trek.</p>
          </li>
           <li>
            <a href="#">Day 13</a>
            <p>Arwatal to Ghastoli (3,790 m) - 8-9 h trek.</p>
          </li>
           <li>
            <a href="#">Day 14</a>
            <p>Ghastoli to Mana to Badrinath - 6-7 h trek + 20 min drive.</p>
          </li>
           <li>
            <a href="#">Day 15</a>
            <p>Departure from Badrinath - 10 h drive.</p>
          </li>
        </ul>
      </div>
    </div>
