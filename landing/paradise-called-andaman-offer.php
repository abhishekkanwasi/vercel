...
<head>
  ...
  <title>Paradise Called Andaman</title>
  <!-- Favicons-->
  <!-- Favicons-->
...
<body>
  <style>
    .from_conatinaer {
      ...
      background-image: url("http://trekveda.com/images/slides/andaman-nicobar-offer-banner.webp");
      /* The image used */
  ...
  <section class="jumbotron text-center from_conatinaer py-4" id="main-form">
    ...
    <div class="container">
      <h1 class="jumbotron-heading">Paradise Called Andaman</h1>
      ...
      <div class="form-container text-center d-flex justify-content-center">
        ...
        <form method="post" action="form-submission.php" class="landing_page_submit_form col-md-8 p-0 m-0">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="trek_name" value="Paradise Called Andaman" />
            <input type="hidden" name="Package_link" value="https://trekveda.com/tour/beaches/andaman-nicobar" />
          </div>
        ...
        <div class="card">
          <div class="card-body" id="pack_detail_card">
            ...
            <ul>
              ...
              <li class="flex-container mb-2">
                <div style="border-right: 2px solid #dadada;"><b>Start</b> : Andaman</div>
                <div style="border-right: 2px solid #dadada;"><b>End</b> : Port Blair</div>

              </li>
              <hr>
              <li class="flex-container mb-2">
                <div style="border-right: 2px solid #dadada;"><i class="fa fa-level-up-alt" style="color: #ff6219"></i> N/A</div>
                <div><i class="fa fa-map-marker-alt" style="color: #ff6219"> </i> Andaman & Nicobar</div>
              </li>
            </ul>
            <hr>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="card ellipsis mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span> Meet and greet services at the airport and all transfers and ferry tickets as per itinerary.</li>
            <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span> Accommodation on CP basis with daily breakfast (Except breakfast on day of arrival).</li>
            <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span> Any other meals only if booked as per indicated rates in the meal plan.</li>
            <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span> Entry tickets, permits and ferry tickets to all places which are mentioned as included in the itinerary.</li>
              <li>&nbsp;</li>
              <li><span class="fa-li"></span><strong>Exclusion in cost during the Tour:</strong></li>
              <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span> Vehicle at disposal is not provided.</li>
              <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span> Any personal expenses. Room service and special orders Alcoholic and non-alcoholic beverages not included.</li>
              <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span> Any extra excursions or sightseeing apart from the suggested tour itinerary not included. Any excursions mentioned as optional extra are also not included.</li>
              <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span> Camera Tickets, Guide Charges are NOT INCLUDED in the mentioned cost of Sightseeing & Transfers.</li>
              <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span> Any meals not mentioned in the meal plan, laundry, telephone calls, and incidentals.</li>
              <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span> Air tickets are NOT included.</li>
              <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span> GST on the tour package (currently at 5%) is not included.</li>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="card ellipsis mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <?php
            $sql = "SELECT * FROM Treking_date where Trek_name = 'Paradise Called Andaman' ";
            $result = $conn->query($sql);
            while ($row = $result->fetch_assoc())
              for ($i = 1; $i < 367; $i++) {
                $date[$i] = $row['Date_' . $i];
            ...
            $sql1 = "SELECT * FROM Treking_date_Status where Trek_name = 'Paradise Called Andaman' ";
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <ul class="timeline">
          <li>
            <a href="#">Day 1</a>
            <p>Arrive Portbalir - Carbyns Cove visit & Sound & Light show at Cellular Jail.</p>
          </li>
          <li>
            <a href="#">Day 2</a>
            <p>Portbalir- Havelock by Ferry and visit Radhanagar Beach at Havelock.</p>
          </li>
          <li>
            <a href="#">Day 3</a>
            <p>In Havelock: Day at Leisure (Option: Excursion to Elephant Beach).</p>
          </li>
          <li>
            <a href="#">Day 4</a>
            <p>Ferry from Havelock to Neil Island and sightseeing at Neil Island.</p>
          </li>
          <li>
            <a href="#">Day 5</a>
            <p>Ferry from Neil Island to Port Blair.</p>
          </li>
          <li>
            <a href="#">Day 6</a>
            <p>Departure from Portbalir.</p>
          </li>
        </ul>
      </div>
    </div>
  ...
  <div class="album py-5 bg-light">
    ...
    <div class="col-md-4 col-lg-3">
        ...
        <div class="col-md-4 col-lg-3">
          ...
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/landing/kashmir-with-ladakh-via-kargil-offer.php">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>POPULAR</span></div>
              <img class="card-img-top" src="<?php echo $root1 ?>/<?php echo $row['card_image']; ?>" alt="<?php echo $row['Title']; ?>">
              <div class="p-2">
