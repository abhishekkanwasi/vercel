...
<head>
  ...
  <title>Sar Pass Trek 2022 - Trekveda</title>
  <!-- Favicons-->
  <!-- Favicons-->
...
<body>
  <style>
    .from_conatinaer {
      ...
      background-image: url("http://trekveda.com/images/slides/sar-pass-offer-banner.webp");
      /* The image used */
  ...
  <section class="jumbotron text-center from_conatinaer py-4" id="main-form">
    ...
    <div class="container">
      <h1 class="jumbotron-heading">Sar Pass Trek</h1>
      <p class="lead">Special Offer Flat 25% OFF - Limited Period Offer.</p>
      <div class="form-container text-center d-flex justify-content-center">
        ...
        <form method="post" action="form-submission.php" class="landing_page_submit_form col-md-8 p-0 m-0">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="trek_name" value="Sar Pass Trek" />
            <input type="hidden" name="Package_link" value="https://trekveda.com/trek/sar-pass-trek.php" />
          </div>
  ...
  <div class="container my-4">
    <div class="row">
      ...
      if (mysqli_connect_error()) {
        ...
        $sql = "select * FROM Trek_add_ons_detail  where Trek_name = 'Sar Pass Trek' ;";
        ...
        <div class="card">
          <div class="card-body" id="pack_detail_card">
            <div class="row">
              ...
              <h4 class="price-field text-left col-9"><small style="color:gray"><s> &#8377;  7,600</s></small> &#8377; <b><span id="mainprice" style="color:#f7472e;" onchange="onpricechange()">5,700</span></b><small id="gst_text"> +5% GST</small></h4>
            ...
            <ul>
              <li class="flex-container mb-2">
                ...
                <div style="border-right: 2px solid #dadada;"><i class="fa fa-mountain" style="color: #ff6219"></i> 13,845 ft.</div>
                <div><i class="fa fa-route" style="color: #ff6219"></i> 48 Km</div>
              </li>
              <hr>

              <li class="flex-container mb-2">
                <div style="border-right: 2px solid #dadada;"><b>Start</b> : Kasol</div>
                <div style="border-right: 2px solid #dadada;"><b>End</b> : Kasol</div>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="card ellipsis mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <ul class="timeline">
          <li>
            <p>Day 1 : Kasol -Grahan Village.</p>
          </li>
          <li>
            <p>Day 2 : Grahan to Mung Thach.</p>
          </li>
          <li>
            <p>Day 3 : Mung Thach - Nagaru.</p>
          </li>
          <li>
            <p>Day 4 : Nagaru - Biskeri Thach.</p>
          </li>
          <li>
           <p>Day 5 : Biskeri Thatch - Kasol via Barshaini.</p>
          </li>
...
<style>
  ...
  <div class="album py-5 bg-light">
      <div class="col-md-12 text-center section-title">
      <h2>Similar Winter Trek Packages till Mar 2022</h2>
