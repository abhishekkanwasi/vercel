...
<head>
  ...
  <title>Kashmir Tour Packages 2022 - Early Bird Offer Upto 50% OFF - Trekveda</title>
  <!-- Favicons-->
  <!-- Favicons-->
...
<body>
  <style>
    .from_conatinaer {
      ...
      background-image: url("http://trekveda.com/images/slides/kashmir-banner.png");
      /* The image used */
  ...
  <section class="jumbotron text-center from_conatinaer py-4" id="main-form">
    ...
    <div class="container">
      <h1 class="jumbotron-heading">8+ Kashmir Tour Package Tour Packages 2022</h1>
      <p class="lead">Early Bird Sale Uto 50% OFF - Limited Period Offer</p>
      <p class="lead">Starting from <b>INR 12,800/-</b></p>
      <div class="form-container text-center d-flex justify-content-center">
        ...
        <form method="post" action="form-submission.php" class="landing_page_submit_form col-md-8 p-0 m-0">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="trek_name" value="Kashmir Tour Package" />
            <input type="hidden" name="Package_link" value="https://trekveda.com/jammu-kashmir.php" />
          </div>
  ...
  <div class="album py-5 bg-light">
      ...
      <h2>Kashmir Tour Packages 2022 - Best time to visit Jan to Dec</h2>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-4 col-lg-3">
          <?php
          $sql = "select * FROM Tour_package_pages where Title = 'Kashmir Tour Package with Sonmarg & Gulmarg 4 Days' ;";
          $result = $conn->query($sql);
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/tour/tour-packages/kashmir-tour-package-4-days" target="_Blank">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>Round Trip</span></div>
              <img class="card-img-top" src="../<?php echo $row['card_image']; ?>" alt="Kashmir Tour Package with Sonmarg & Gulmarg 4 Days">
              <div class="p-2">
        ...
        <div class="col-md-4 col-lg-3">
          <?php
          $sql = "select * FROM Tour_package_pages where Title = 'Kashmir Tour Package with Gulmarg & Pahalgam 5 Days' ;";
          $result = $conn->query($sql);
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/tour/tour-packages/kashmir-tour-package-5-days" target="_Blank">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>Round Trip</span></div>
              <img class="card-img-top" src="../<?php echo $row['card_image']; ?>" alt="Kashmir Tour Package with Gulmarg & Pahalgam 5 Days">
              <div class="p-2">
                <span class="tour-price"><s><small>&#8377; <?php echo $row['price_without_discount']; ?> </small></s><b> &#8377; <?php echo $row['price_with_discount']; ?></b> </span>
                <span class="badge badge-pill float-right right-gary"><?php echo $row['days']; ?>D/<?php echo $row['days'] - 1; ?>N</span>
                <h5><?php echo $row['Title']; ?></h5>
        ...
        <div class="col-md-4 col-lg-3">
          <?php
          $sql = "select * FROM Tour_package_pages where Title = 'Kashmir - Best Tour Package 6 Days' ;";
          $result = $conn->query($sql);
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/tour/tour-packages/kashmir-tour-package-6-days" target="_Blank">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>Round Trip</span></div>
              <img class="card-img-top" src="../<?php echo $row['card_image']; ?>" alt="Kashmir - Best Tour Package 6 Days">
              <div class="p-2">
                <span class="tour-price"><s><small>&#8377; <?php echo $row['price_without_discount']; ?> </small></s><b> &#8377; <?php echo $row['price_with_discount']; ?></b> </span>
                <span class="badge badge-pill float-right right-gary"><?php echo $row['days']; ?>D/<?php echo $row['days'] - 1; ?>N</span>
                <h5><?php echo $row['Title']; ?></h5>
        ...
        <div class="col-md-4 col-lg-3">
          <?php
          $sql = "select * FROM Tour_package_pages where Title = 'Kashmir - Mesmerizing Tour Package 7 Days' ;";
          $result = $conn->query($sql);
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/tour/tour-packages/kashmir-tour-package-7-days" target="_Blank">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>Bike Trip</span></div>
              <img class="card-img-top" src="../<?php echo $row['card_image']; ?>" alt="Kashmir - Mesmerizing Tour Package 7 Days">
              <div class="p-2">
                <span class="tour-price"><s><small>&#8377; <?php echo $row['price_without_discount']; ?> </small></s><b> &#8377; <?php echo $row['price_with_discount']; ?></b> </span>
                <span class="badge badge-pill float-right right-gary"><?php echo $row['days']; ?>D/<?php echo $row['days'] - 1; ?>N</span>
                <h5><?php echo $row['Title']; ?></h5>
        ...
        <div class="col-md-4 col-lg-3">
          ...
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/tour/tour-packages/kashmir-with-ladakh-via-kargil" target="_Blank">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>Bike Trip</span></div>
              <img class="card-img-top" src="../<?php echo $row['card_image']; ?>" alt="Journey of Kashmir with Ladakh via Kargil">
              <div class="p-2">
                <span class="tour-price"><s><small>&#8377; <?php echo $row['price_without_discount']; ?> </small></s><b> &#8377; <?php echo $row['price_with_discount']; ?></b> </span>
                <span class="badge badge-pill float-right right-gary"><?php echo $row['days']; ?>D/<?php echo $row['days'] - 1; ?>N</span>
                <h5><?php echo $row['Title']; ?></h5>
        ...
        <div class="col-md-4 col-lg-3">
          <?php
          $sql = "select * FROM Tour_package_pages where Title = 'The Beauty of Jammu & Kashmir with Vaishno Devi' ;";
          $result = $conn->query($sql);
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/tour/tour-packages/jammu-kashmir-with-vaishno-devi" target="_Blank">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>Round Trip</span></div>
              <img class="card-img-top" src="../<?php echo $row['card_image']; ?>" alt="The Beauty of Jammu & Kashmir with Vaishno Devi">
              <div class="p-2">
                <span class="tour-price"><s><small>&#8377; <?php echo $row['price_without_discount']; ?> </small></s><b> &#8377; <?php echo $row['price_with_discount']; ?></b> </span>
                <span class="badge badge-pill float-right right-gary"><?php echo $row['days']; ?>D/<?php echo $row['days'] - 1; ?>N</span>
                <h5><?php echo $row['Title']; ?></h5>
