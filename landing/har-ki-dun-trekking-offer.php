...
<head>
  ...
  <title>Har Ki Dun Trek 2023 - Special Offer Flat 39% OFF - Trekveda</title>
  <!-- Favicons-->
  <!-- Favicons-->
...
<body>
  <style>
    .from_conatinaer {
      ...
      background-image: url("http://trekveda.com/images/slides/har-ki-dun-trek-offer-banner.webp");
      /* The image used */
 ...
 <section class="jumbotron text-center from_conatinaer py-4" id="main-form">
    ...
    <div class="container">
      <h1 class="jumbotron-heading">Har ki Dun Trek</h1>
      <p class="lead">Special Offer Flat 39% OFF</p>
      <div class="form-container text-center d-flex justify-content-center">
        <form method="post" action="form-submission.php" class="landing_page_submit_form col-md-8 p-0 m-0">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="trek_name" value="Har ki Dun Trek" />
            <input type="hidden" name="Package_link" value="https://trekveda.com/trek/har-ki-dun-trek.php" />
          </div>
    ...
    <div class="row">
        ...
        <div class="card">
          <div class="card-body" id="pack_detail_card">
            <div class="row">
              ...
              <h6 class="card-price col-3 text-right"><mark class="top-mark">39% OFF</mark></b></h6>
            ...
            <ul>
              <li class="flex-container mb-2">
                <div style="border-right: 2px solid #dadada;"><i class="fa fa-calendar-alt" style="color: #ff6219"></i> 7 Days</div>
                <div style="border-right: 2px solid #dadada;"><i class="fa fa-mountain" style="color: #ff6219"></i>  11,700 ft.</div>
                <div><i class="fa fa-route" style="color: #ff6219"></i> 44 Km</div>
              </li>
              <hr>

              <li class="flex-container mb-2">
                <div style="border-right: 2px solid #dadada;"><b>Start</b> : Sankri</div>
                <div style="border-right: 2px solid #dadada;"><b>End</b> : Sankri</div>

              </li>
              <hr>
              <li class="flex-container mb-2">
                <div style="border-right: 2px solid #dadada;"><i class="fa fa-level-up-alt" style="color: #ff6219"></i> Moderate</div>
          ...
          <div class="card-body">
            ...
            <ul class="fa-ul">
              <li><span class="fa-li"></span><strong>Inclusion in cost during the trek:</strong></li>
                <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span> 02 Nights Accommodation in Sankri will be provided using Guest House / Home Stay or Fixed Camps on triple Sharing basis.</li>
                ...
                <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span>Transportation from Dehradun to Sanakri and Back to Dehradun (subject to add. Cost).</li>
                ...
                <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span>Backpack offloading charges, the backpack should not weigh more than 9 kgs. Suitcases/strollers/duffel bags will not be allowed (Subject to additional cost).</li>
              </ul>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="card ellipsis mb-5 mb-lg-0">
          ...
          <li>
            <p>Day 2: Sankri to Puani Garaat via Taluka.</p>
          </li>
          <li>
            <p>Day 3: Puani Garaat to Kalkatiyadhar.</p>
          </li>
           <li>
            <p>Day 4: Kalkatiyadhaar to Har Ki Dun to Kalkatiyadhaar.</p>
          </li>
           <li>
            <p>Day 5: Kalkatiyadhaar to Puani Garaat.</p>
          </li>
           <li>
            <p>Day 6: Puani Garaat to Taluka and then drive to Sankri.</p>
          </li>
           <li>
...
<style>
   ...
   <br/>
        ...
        <p style="color:black"><b>Note:</b> If you are more than 6 person you can choose any date as per your preference.</p>
            
              <p style="color:black"><b>May:</b> 13, 20, 27.</p>
               <p style="color:black"><b>Jun:</b> 3, 4, 10, 11, 17, 18, 24, 25.</p>
 ...
 <div class="album py-5 bg-light">
      <div class="col-md-12 text-center section-title">
      <h2>Similar Winter Trek Packages till Mar 2023</h2>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-4 col-lg-3">
          <?php
          $sql = "select * FROM Trek_add_ons_detail  where Trek_name = 'Brahmatal Trek' ;";
          $result = $conn->query($sql);
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/landing/brahmatal-offer.php" target="_Blank">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>Upto 50% OFF</span></div>
              <img class="card-img-top" src="../<?php echo $row['card_image']; ?>" alt="Brahmatal Trek">
              <div class="p-2">
        ...
        <div class="col-md-4 col-lg-3">
          <?php
          $sql = "select * FROM Trek_add_ons_detail  where Trek_name = 'Dayara Bugyal Trek' ;";
          $result = $conn->query($sql);
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/landing/dayara-bugyal-offer.php" target="_Blank">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>Upto 50% OFF</span></div>
              <img class="card-img-top" src="../<?php echo $row['card_image']; ?>" alt="Dayara Bugyal Trek">
              <div class="p-2">
                <span class="tour-price"><s><small>&#8377; <?php echo $row['price_without_discount']; ?> </small></s><b> &#8377; <?php echo $row['Price']; ?></b> </span>
                <span class="badge badge-pill float-right right-gary"><?php echo $row['days']; ?>D/<?php echo $row['days'] - 1; ?>N</span>
                <h5><?php echo $row['Trek_name']; ?></h5>
