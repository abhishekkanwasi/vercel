...
<!-- Basic Page Needs -->
<meta charset="utf-8">
<title>Sundardunga Glacier Trek with Trekveda | Best Trekking Company | Offer</title>
<meta name="description" content="">
<meta name="author" content="Amit Kukreti">
<meta name="keywords" content="Nag Tibba">
...
<div id="image">
<img src="/images/slides/sunderdhunga-trek-offer-banner.jpg" class="img-responsive"/>
	...
	<div id="loginForm" class="contactFrm">
                    ...
                    <p class="trek-title">Sundardunga Glacier Trek</p>	
                    ...
                    <div class="panel-body">
                        <fieldset>	
                            ...
                            <input  type="hidden" name="trek_name" value="Sundardunga Glacier Trek"  />
...
<div class="container">
	...
	<div class="row package">
		<div class="col-md-4">
			<div class="package-price-card desktop-short-itinerary">
				<div class="package-price-card-top">
					<span>Rs.</span><strong>12,300</strong><small>per person plus 5% GST</small>
				</div>
				
				<hr/>
				
				<p><img src="/images/package-icon/calendar.png"/><span>9 Days</span><img src="/images/package-icon/mountains.png"/><span>13,448 ft.</span><img src="/images/package-icon/distance.png"/><span style="border:0px">104 Km</span><p>
				
				<hr/>
				
				<p><img src="/images/package-icon/boot.png"/><span>Moderate</span><img src="/images/package-icon/state.png"/><span style="border:0px">Uttarakhand</span><p>
				...
				<a><img src="/images/package-icon/maps-and-flags.png"/><span><b>Start:</b> Bageshwer</span><img src="/images/package-icon/maps-and-flags.png"/><span style="border:0px"><b>End:</b> Bagehwer</span></a>
				<hr/>
					...
					<div class="panel-group" id="accordion">
						...
						<div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#May">May</a>
                                </h4>
                            </div>
                            <div id="May" class="panel-collapse collapse">
                                <div class="panel-body">
									 <small>25 May to 02 Jun 2019 (Available)</small>
								</div>
                            </div>
                        </div>
		...
		<div class="package-side-box mobile-short-itinerary">
				...
				<p><b>Day 1:</b> Kathgodam to Loharkhet through Bageshwar </p>
				<p><b>Day 2:</b> Bageshwar to Kharkiya via Bharai and Loharakhet. Trek to Khati</p>
				<p><b>Day 3:</b> Khati to Jatoli</p>
				<p><b>Day 4:</b> Jatoli to Kathaliya</p>
				<p><b>Day 5:</b> Kathaliya to Kathaliya-Maiktoli Base Camp</p>
				<p><b>Day 6:</b> Kathaliya to Baluni Top</p>
                <p><b>Day 7:</b> Kathliya to Jatoli</p>
                <p><b>Day 8:</b> Jatoli to Kharkiya to Khati to Bageshwar</p>
                <p><b>Day 9:</b> Bageshwar To Kathgodam</p>
                <p><i>You will be staying in a geust house at Lohajung. Accommodation on all other days will be in tents (2-3 per tent).</i></p>
			</div>
...
<div id="popup_main_id" class="popup_main_class">
  ...
  <form class="popup-content" id="popup_form_id">
      ...
      <div class="popup-content-container">
        ...
        <input type="text"  name="trek"  value="Sundardunga Glacier offer" readonly style="display:none">
