...
<head>
  ...
  <title>Phulara Ridge Trek</title>
  <!-- Favicons-->
  <!-- Favicons-->
...
<body>
  <style>
    .from_conatinaer {
      ...
      background-image: url("http://trekveda.com/images/slides/phulara-ridge-trek-offer-banner.webp");
      /* The image used */
  ...
  <section class="jumbotron text-center from_conatinaer py-4" id="main-form">
    ...
    <div class="container">
      <h1 class="jumbotron-heading">Phulara Ridge Trek</h1>
      ...
      <div class="form-container text-center d-flex justify-content-center">
        ...
        <form method="post" action="form-submission.php" class="landing_page_submit_form col-md-8 p-0 m-0">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="trek_name" value="Phulara Ridge Trek" />
            <input type="hidden" name="Package_link" value="https://trekveda.com/trek/phulara-ridge-trek.php" />
          </div>
          ...
          <div class="card-body" id="pack_detail_card">
            ...
            <ul>
              <li class="flex-container mb-2">
                ...
                <div><i class="fa fa-route" style="color: #ff6219"></i> 25 Km</div>
              </li>
              <hr>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="card ellipsis mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <?php
            $sql = "SELECT * FROM Treking_date where Trek_name = 'Phulara Ridge Trek' ";
            $result = $conn->query($sql);
            while ($row = $result->fetch_assoc())
              for ($i = 1; $i < 367; $i++) {
                $date[$i] = $row['Date_' . $i];
            ...
            $sql1 = "SELECT * FROM Treking_date_Status where Trek_name = 'Phulara Ridge Trek' ";
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <ul class="timeline">
          ...
          <li>
            <a href="#">Day 2</a>
            <p>Sankri to Sikolta.</p>
          </li>
          <li>
            <a href="#">Day 3</a>
            <p>Sikolta to Bhoj Gadi via Karsu Thatch.</p>
          </li>
          <li>
            <a href="#">Day 4</a>
            <p>Bhoj Gadi to Pushtara via Phulara ridge.</p>
          </li>
          <li>
            <a href="#">Day 5</a>
            <p>Pushtara to Taluka. Drive to Sankri.</p>
          </li>
          <li>
            <a href="#">Day 6</a>
            <p>Departure from Sankri.</p>
          </li>
        </ul>
      </div>
    </div>
