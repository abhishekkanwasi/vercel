...
<head>
  ...
  <title>Bali Pass Trek 2022 - Early Bird Sale Upto 50% OFF - Trekveda</title>
  <!-- Favicons-->
  <!-- Favicons-->
...
<body>
  <style>
    .from_conatinaer {
      ...
      background-image: url("http://trekveda.com/images/slides/bali-pass-trek-offer-banner.webp");
      /* The image used */
  ...
  <section class="jumbotron text-center from_conatinaer py-4" id="main-form">
    ...
    <div class="container">
      <h1 class="jumbotron-heading">Bali Pass Trek</h1>
      ...
      <div class="form-container text-center d-flex justify-content-center">
        ...
        <form method="post" action="form-submission.php" class="landing_page_submit_form col-md-8 p-0 m-0">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="trek_name" value="Bali Pass Trek" />
            <input type="hidden" name="Package_link" value="https://trekveda.com/trek/bali-pass-trek.php" />
          </div>
          ...
          <div class="card-body" id="pack_detail_card">
            ...
            <ul>
              <li class="flex-container mb-2">
                <div style="border-right: 2px solid #dadada;"><i class="fa fa-calendar-alt" style="color: #ff6219"></i> 9 Days</div>
                <div style="border-right: 2px solid #dadada;"><i class="fa fa-mountain" style="color: #ff6219"></i>  16,207 ft.</div>
                <div><i class="fa fa-route" style="color: #ff6219"></i> 70 Km</div>
              </li>
              <hr>

              <li class="flex-container mb-2">
                <div style="border-right: 2px solid #dadada;"><b>Start</b> : Sankri</div>
                <div style="border-right: 2px solid #dadada;"><b>End</b> : Janki Chatti</div>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="card ellipsis mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <ul class="timeline">
          <li>
            <p>Day 1: Reach Sankri.</p>
          </li>
          <li>
            <p>Day 2: Sankri to Seema via Taluka.</p>
          </li>
          <li>
            <p>Day 3: Seema to Roiltia or Waterfall camp.</p>
          </li>
          <li>
            <p>Day 4: Waterfall to Ruinsara Lake.</p>
          </li>
          <li>
            <p>Day 5: Ruinsara Lake - Rest and Explore.</p>
          </li>
          <li>
            <p>Day 6: Ruinsara Lake to Odari.</p>
          </li>
          <li>
            <p>Day 7: Odari to Upper Dhamni via Bali Pass.</p>
          </li>
          <li>
            <p>Day 8: Upper Dhamni to Yamunotri to JankiChatti.</p>
          </li>
          <li>
            <p>Day 9: Departure from Janki Chatti.</p>
          </li>
        </ul>
          </div>
        </div>
