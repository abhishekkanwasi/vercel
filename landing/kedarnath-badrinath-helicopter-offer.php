...
<head>
  ...
  <title>2023 Kedarnath & Badrinath Yatra Package by Helicopter</title>
  <!-- Favicons-->
  <!-- Favicons-->
...
<body>
  ...
  <section class="jumbotron text-center from_conatinaer py-4" id="main-form">
    ...
    <div class="container">
      <h1 class="jumbotron-heading">Kedarnath & Badrinath Yatra Package by Helicopter</h1>
      ...
      <div class="form-container text-center d-flex justify-content-center">
        ...
        <form method="post" action="form-submission.php" class="landing_page_submit_form col-md-8 p-0 m-0">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="trek_name" value="Kedarnath & Badrinath Yatra Package by Helicopter" />
            <input type="hidden" name="Package_link" value="https://trekveda.com/tour/tour-packages/kedarnath-badrinath-package-by-helicopter" />
          </div>
        ...
        <div class="card">
          <div class="card-body" id="pack_detail_card">
            <div class="row">
              ...
              <h4 class="price-field text-left col-9"><small style="color:gray"><s> &#8377; 129333</s></small> &#8377; <b><span id="mainprice" style="color:#f7472e;" onchange="onpricechange()">97000</span></b><small id="gst_text"> +5% GST</small></h4>
            ...
            <ul>
              <li class="flex-container mb-2">
                <div style="border-right: 2px solid #dadada;"><i class="fa fa-calendar-alt" style="color: #ff6219"></i> 1 Days</div>
        ...
        <div class="card ellipsis mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <ul class="fa-ul">
              ...
              <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span> Cost of helicopter for Dodham Sector.</li>
              <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span> Cost of vehicle at Badrinath.</li>
              <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span> 01 Veg. Meal / Packed Catering at Badrinath.</li>
        ...
        <div class="card ellipsis mb-5 mb-lg-0">
          <div class="card-body">
                <p class="h4 card-title text-center package-heading-side">Short Itinerary</p>
                    <ul class="timeline">
                        <li>
                            <p>Day 1: Dehradun - Kedarnath - Badrinath - Dehradun.</p>
                         </li>
