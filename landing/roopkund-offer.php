...
<body>
  <style>
    .from_conatinaer {
      ...
      background-image: url("http://trekveda.com/images/slides/roopkund-trek-offer-banner.webp");
      /* The image used */
  ...
  <section class="jumbotron text-center from_conatinaer py-4" id="main-form">
    ...
    <div class="container">
      <h1 class="jumbotron-heading">Roopkund Trek</h1>
      ...
      <div class="form-container text-center d-flex justify-content-center">
        ...
        <form method="post" action="form-submission.php" class="landing_page_submit_form col-md-8 p-0 m-0">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="trek_name" value="Roopkund Trek" />
            <input type="hidden" name="Package_link" value="https://trekveda.com/trek/roopkund-trek.php" />
          </div>
  ...
  <div class="container my-4">
    <div class="row">
      ...
      if (mysqli_connect_error()) {
        ...
        $sql = "select * FROM Trek_add_ons_detail  where Trek_name = 'Roopkund Trek' ;";
          ...
          <div class="card-body" id="pack_detail_card">
            ...
            <ul>
              <li class="flex-container mb-2">
                ...
                <div style="border-right: 2px solid #dadada;"><i class="fa fa-mountain" style="color: #ff6219"></i>  16,499 ft.</div>
                <div><i class="fa fa-route" style="color: #ff6219"></i> 52 Km</div>
              </li>
              <hr>

              <li class="flex-container mb-2">
                <div style="border-right: 2px solid #dadada;"><b>Start</b> : Sutol</div>
                <div style="border-right: 2px solid #dadada;"><b>End</b> : Sutol</div>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="card ellipsis mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <?php
            $sql = "SELECT * FROM Treking_date where Trek_name = 'Roopkund Trek' ";
            $result = $conn->query($sql);
            while ($row = $result->fetch_assoc())
              for ($i = 1; $i < 367; $i++) {
                $date[$i] = $row['Date_' . $i];
            ...
            $sql1 = "SELECT * FROM Treking_date_Status where Trek_name = 'Roopkund Trek' ";
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <ul class="timeline">
          ...
          <li>
            <a href="#">Day 2</a>
            <p>Sutol to Talkapad.</p>
          </li>
          <li>
            <a href="#">Day 3</a>
            <p>Talkapad to Ghimtoli/ Bhagwabasa.</p>
          </li>
            <li>
            <a href="#">Day 4</a>
            <p>Ghimtoli/ Bhagwabasa to Roopkund Lake and back to Ghimtoli/ Bhagwabasa.</p>
          </li>
            <li>
            <a href="#">Day 5</a>
            <p>Ghimtoli/ Bhagwabasa to Bedni Bugyal and back to Ghimtoli/ Bhagwabasa.</p>
          </li>
            <li>
            <a href="#">Day 6</a>
            <p>Ghimtoli/ Bhagwabasa to Talkapad.</p>
          </li>
            <li>
            <a href="#">Day 7</a>
            <p>Talkapad to Sutol.</p>
          </li>
            <li>
            <a href="#">Day 8</a>
            <p>Departure from Sutol.</p>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4 col-lg-3">
          ...
          ?>
          <a href="https://trekveda.com/landing/pangarchula-trek-offer.php">
            <div class="box">
        ...
        <div class="col-md-4 col-lg-3">
          ...
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/landing/valley-of-flower-offer.php">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>POPULAR</span></div>
        ...
        <div class="col-md-4 col-lg-3">
          ...
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/landing/har-ki-dun-trek-offer.php">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>POPULAR</span></div>
        ...
        <div class="col-md-4 col-lg-3">
          ...
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/landing/kuari-pass-trek-offer.php">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>POPULAR</span></div>
        ...
        <div class="col-md-4 col-lg-3">
          <?php
          $sql = "select * FROM Trek_add_ons_detail  where Trek_name = 'Pangarchula With kuari Pass Trek' ;";
          $result = $conn->query($sql);
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/landing/pangarchulla-with-kuari-pass-trek-offer.php">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>POPULAR</span></div>
              <img class="card-img-top" src="../<?php echo $row['card_image']; ?>" alt="Pangarchula With Kuari Pass Trek">
              <div class="p-2">
                <span class="tour-price"><s><small>&#8377; <?php echo $row['price_without_discount']; ?> </small></s><b> &#8377; <?php echo $row['Price']; ?></b> </span>
                <span class="badge badge-pill float-right right-gary"><?php echo $row['days']; ?>D/<?php echo $row['days'] - 1; ?>N</span>
                <h5><?php echo $row['Trek_name']; ?></h5>
        ...
        <div class="col-md-4 col-lg-3">
          <?php
          $sql = "select * FROM Trek_add_ons_detail  where Trek_name = 'Hampta Circle Trek' ;";
          $result = $conn->query($sql);
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/landing/hampta-cricle-trek-offer.php">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>POPULAR</span></div>
              <img class="card-img-top" src="../<?php echo $row['card_image']; ?>" alt="Hampta Circle Trek">
              <div class="p-2">
                <span class="tour-price"><s><small>&#8377; <?php echo $row['price_without_discount']; ?> </small></s><b> &#8377; <?php echo $row['Price']; ?></b> </span>
                <span class="badge badge-pill float-right right-gary"><?php echo $row['days']; ?>D/<?php echo $row['days'] - 1; ?>N</span>
                <h5><?php echo $row['Trek_name']; ?></h5>
         ...
         <div class="col-md-4 col-lg-3">
          ...
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/landing/sandakphu-phalut-trek-offer.php">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>POPULAR</span></div>
