...
<body>
  <style>
    .from_conatinaer {
      ...
      background-image: url("http://trekveda.com/images/slides/chadar-trek-offer-banner.webp");
      /* The image used */
 ...
 <section class="jumbotron text-center from_conatinaer py-4" id="main-form">
    ...
    <div class="container">
      <h1 class="jumbotron-heading">Chadar Trek</h1>
      ...
      <div class="form-container text-center d-flex justify-content-center">
        ...
        <form method="post" action="form-submission.php" class="landing_page_submit_form col-md-8 p-0 m-0">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="trek_name" value="Chadar Trek" />
            <input type="hidden" name="Package_link" value="https://trekveda.com/trek/chadar-trek.php" />
          </div>
          ...
          <div class="card-body" id="pack_detail_card">
            ...
            <ul>
              <li class="flex-container mb-2">
                ...
                <div style="border-right: 2px solid #dadada;"><i class="fa fa-mountain" style="color: #ff6219"></i>  11,123 ft.</div>
                <div><i class="fa fa-route" style="color: #ff6219"></i> 62 Km</div>
              </li>
              <hr>

              <li class="flex-container mb-2">
                <div style="border-right: 2px solid #dadada;"><b>Start</b> : Leh</div>
              ...
              <li class="flex-container mb-2">
                ...
                <div><i class="fa fa-map-marker-alt" style="color: #ff6219"> </i> Ladakh</div>
              </li>
            </ul>
            <hr>
        ...
        <div class="card ellipsis mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <ul class="fa-ul">
             ...
             <li><span class="fa-li"></span><strong>Inclusion in cost during the trek:</strong></li>
                <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span>Accommodation in Leh (Guest House) for 04 Nights on Triple Sharing and room only basis (EP)</li>
                <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span>Accommodation during the trek using trekking tents on sharing basis with heater facility.</li>
                <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span>All meals during trek.</li>
                <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span>Trekking Permits and Forest Camping Charges.</li>
                <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span>Transportation on sharing basis to / from Base Camp.</li>
                <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span> Services of Expert trek leader.</li>
                <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span> Service of Expert Trekking Team (Guide / Cook and Helpers.)</li>
                <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span> Oxygen Cylinders.</li>
              <li>&nbsp;</li>
              <li><span class="fa-li"></span><strong>Exclusion in cost during the trek:</strong></li>
              <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span>Any Meals /Snacks / Beverages in Leh.</li>
                <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span>Cost for Airfare, Train fare.</li>
                <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span>Travel / Health Insurance (Trekveda strictly recommend each traveller to please carry your own travel / health insurance.)</li>
                <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span>Any kind of medical expens.</li>
                <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span>Any monuments / monasteries entrance fee in Ladakh.</li>
                ...
                <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span>Airport pickup and drop services.</li>
                <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span>Wild Life Fee, ALTOA Fee, Department Medical Insurance; Health Check up at Leh ( Any such fee, if charged, will have to be directly or additionally borne by the trekkers to the Government & ALTOA authorities at Leh on Arrival.)</li>
                <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span>The proposed Wildlife Fees, Environmental Fees and other fees as being put forward by LAHDC and ALTOA or any other organization.</li>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="card ellipsis mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <?php
            $sql = "SELECT * FROM Treking_date where Trek_name = 'Chadar Trek' ";
            $result = $conn->query($sql);
            while ($row = $result->fetch_assoc())
              for ($i = 1; $i < 367; $i++) {
                $date[$i] = $row['Date_' . $i];
            ...
            $sql1 = "SELECT * FROM Treking_date_Status where Trek_name = 'Chadar Trek' ";
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <ul class="timeline">
          ...
          <li>
            <a href="#">Day 2</a>
            <p>Acclimatization in Leh (Rest/ Mild walk).</p>
          </li>
          <li>
            <a href="#">Day 3</a>
            <p>In Leh (Get Medical, Insurance, Wildlife Permit and ALTOA NOC).</p>
          </li>
          <li>
            <a href="#">Day 4</a>
            <p>Drive to Shingra Koma.</p>
          </li>
          <li>
            <a href="#">Day 5</a>
            <p>Shingra Koma to Tibb Cave.</p>
          </li>
          <li>
            <a href="#">Day 6</a>
            <p>Tibb cave to Naerak camp.</p>
          </li>
          <li>
            <a href="#">Day 7</a>
            <p>Naerak to Tibb Cave.</p>
          </li>
          <li>
            <a href="#">Day 8</a>
            <p>Tibb Cave to Shingra Koma and drive back to Leh.</p>
          </li>
          <li>
            <a href="#">Day 9</a>
            <p>Return from Leh.</p>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4 col-lg-3">
          ...
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/landing/lamkhaga-pass-trek-offer.php">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>POPULAR</span></div>
              <img class="card-img-top" src="../<?php echo $row['card_image']; ?>" alt="Lamkhaga Pass Trek">
              <div class="p-2">
                <span class="tour-price"><s><small>&#8377; <?php echo $row['price_without_discount']; ?> </small></s><b> &#8377; <?php echo $row['Price']; ?></b> </span>
                <span class="badge badge-pill float-right right-gary"><?php echo $row['days']; ?>D/<?php echo $row['days'] - 1; ?>N</span>
                <h5><?php echo $row['Trek_name']; ?></h5>
