...
<head>
  ...
  <title>Chaainsheel Bugyal Trek</title>
  <!-- Favicons-->
  <!-- Favicons-->
...
<body>
  <style>
    .from_conatinaer {
      ...
      background-image: url("http://trekveda.com/images/slides/chaainsheel-bugyal-trek-offer-banner.webp");
      /* The image used */
  ...
  <section class="jumbotron text-center from_conatinaer py-4" id="main-form">
    ...
    <div class="container">
      <h1 class="jumbotron-heading">Chaainsheel Bugyal Trek</h1>
      ...
      <div class="form-container text-center d-flex justify-content-center">
        ...
        <form method="post" action="form-submission.php" class="landing_page_submit_form col-md-8 p-0 m-0">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="trek_name" value="Chaainsheel Bugyal Trek" />
            <input type="hidden" name="Package_link" value="https://trekveda.com/trek/chaainsheel-bugyal-trek.php" />
          </div>
          ...
          <div class="card-body" id="pack_detail_card">
            ...
            <ul>
              <li class="flex-container mb-2">
                ...
                <div style="border-right: 2px solid #dadada;"><i class="fa fa-mountain" style="color: #ff6219"></i> 12,127 ft.</div>
                <div><i class="fa fa-route" style="color: #ff6219"></i> 30 Km</div>
              </li>
              <hr>

              <li class="flex-container mb-2">
                <div style="border-right: 2px solid #dadada;"><b>Start</b> : Balawat</div>
                <div style="border-right: 2px solid #dadada;"><b>End</b> : Chinwa</div>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="card ellipsis mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <?php
            $sql = "SELECT * FROM Treking_date where Trek_name = 'Chaainsheel Bugyal Trek' ";
            $result = $conn->query($sql);
            while ($row = $result->fetch_assoc())
              for ($i = 1; $i < 367; $i++) {
                $date[$i] = $row['Date_' . $i];
            ...
            $sql1 = "SELECT * FROM Treking_date_Status where Trek_name = 'Chaainsheel Bugyal Trek' ";
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <ul class="timeline">
          <li>
            <a href="#">Day 1</a>
            <p>Dehradun to Balawat, 215 Km Drive.</p>
          </li>
          <li>
            <a href="#">Day 2</a>
            <p>Balawat (6,283 ft) to Sunaooti Thach (10,400 ft.).</p>
          </li>
          <li>
            <a href="#">Day 3</a>
            <p>Sunaooti Thach (10,400 ft) to Samta Thach (11,647 ft); 7-8 hours, 14 km.</p>
          </li>
          <li>
            <a href="#">Day 4</a>
            <p>Rest and investigation day.</p>
          </li>
          <li>
            <a href="#">Day 5</a>
            <p>Samta Thach (11,647 ft) to Tikula Thach (10,203 ft) through Sarutal; 5-6 hours, 8 km.</p>
          </li>
          <li>
            <a href="#">Day 6</a>
            <p>Tikula Thach (10,203 ft) to DagaanMoriyaach (9,416 ft); 4-5 hours.</p>
          </li>
          <li>
            <a href="#">Day 7</a>
            <p>Dagaan Moriyaach to Chinwa then to Dehradun.</p>
          </li>
        </ul>
      </div>
    </div>
