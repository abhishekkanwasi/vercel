...
<head>
  ...
  <title>Kedarkantha Trek 2023 - Flat 36% OFF - Limited Peiod Offer - Trekveda</title>
  <!-- Favicons-->
  <!-- Favicons-->
...
<body>
  <style>
    .from_conatinaer {
      ...
      background-image: url("http://trekveda.com/images/slides/kedarkantha-offer-banner.webp");
      /* The image used */
  ...
  <section class="jumbotron text-center from_conatinaer py-4" id="main-form">
    ...
    <div class="container">
      <h1 class="jumbotron-heading">Kedarkantha Trek - Diwali Offer</h1>
      <p class="lead">Book Now & Get Flat 36% OFF</p>
      <div class="form-container text-center d-flex justify-content-center">
        ...
        <form method="post" action="form-submission.php" class="landing_page_submit_form col-md-8 p-0 m-0">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="trek_name" value="Kedarkantha Trek" />
            <input type="hidden" name="Package_link" value="https://trekveda.com/trek/kedarkantha-trek.php" />
          </div>
  ...
  <section class="inclusion_detail_big_cards">
    ...
    <div class="col-md-12 text-center">
       <img src="../img/offer/offer-free-page.png" width="100%" height="auto"/>
        <hr/>
  ...
  <div class="container my-4">
    <div class="row">
      ...
      if (mysqli_connect_error()) {
        ...
        $sql = "select * FROM Trek_add_ons_detail  where Trek_name = 'Kedarkantha Trek' ;";
        ...
        <div class="card">
          <div class="card-body" id="pack_detail_card">
            <div class="row">
              ...
              <h4 class="price-field text-left col-9"><small style="color:gray"><s> &#8377;  9,300</s></small> &#8377; <b><span id="mainprice" style="color:#f7472e;" onchange="onpricechange()">6000</span></b><small id="gst_text"> +5% GST</small></h4>
              <h6 class="card-price col-3 text-right"><mark class="top-mark">36% OFF</mark></b></h6>
            ...
            <ul>
              <li class="flex-container mb-2">
                ...
                <div style="border-right: 2px solid #dadada;"><i class="fa fa-mountain" style="color: #ff6219"></i> 12,500 ft.</div>
                <div><i class="fa fa-route" style="color: #ff6219"></i> 20 Km</div>
              </li>
              <hr>
          ...
          <div class="card-body">
            ...
            <ul class="fa-ul">
              <li><span class="fa-li"></span><strong>Inclusion in cost during the trek:</strong></li>
                ...
                <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span>Trekking Jacket.</li>
                <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span>Microspikes and Gaiters.</li>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="card ellipsis mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <ul class="timeline">
          <li>
            <p>Day 1 : Reporting At Sankri.</p>
          </li>
          <li>
            <p>Day 2 : Sankri To Juda Ka Taal.</p>
          </li>
          <li>
            <p>Day 3 : Juda Ka Taal To Kedarkantha Base Camp.</p>
          </li>
          <li>
            <p>Day 4 : Kedarkantha Base to Kedarkantha to Back to Kedarkantha Base Camp.</p>
          </li>
          <li>
           <p>Day 5 : Kedarkantha Base Camp to Sankri and drive back to Dehradun.</p>
          </li>
...
<style>
   ...
   <br/>
        ...
        <p style="color:black"> If you are more than 6 person you can ask for your preferred dates.</p>
    ...
    <div class="row">
        <div class="col-md-4">
            <img src="../img/offer/google-reviews/kedarkantha-review-1.png" width="100%"/>
        </div>

        <div class="col-md-4">
            <img src="../img/offer/google-reviews/kedarkantha-review-2.png" width="100%"/>
        </div>

        <div class="col-md-4">
            <img src="../img/offer/google-reviews/kedarkantha-review-3.png" width="100%"/>
        </div>
        
        <div class="col-md-4">
            <img src="../img/offer/google-reviews/kedarkantha-review-4.png" width="100%"/>
        </div>
        
        <div class="col-md-4">
            <img src="../img/offer/google-reviews/kedarkantha-review-5.png" width="100%"/>
        </div>
        
         <div class="col-md-4">
            <img src="../img/offer/google-reviews/kedarkantha-review-6.png" width="100%"/>
        </div>
    ...
    <br/>
     <div class="col-md-12 text-center section-title">
                    ...
                    <div class="details">
                      ...
                      <p style="color:black; font-Size: 40px; font-weight: 600">8534094170</p>
                    </div>
...
<div class="container mb-4">
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        <div class="video-testimonial-content">
          <h4 class="mb10">Kedarkantha Trek | Customer Review - 2</h4>
        </div>
      </div>
      ...
      <div class="col-md-4">
        ...
        <div class="video-testimonial-content">
          <h4 class="mb10">Kedarkantha Trek | Customer Review - 3</h4>
        </div>
      </div>
      ...
      <div class="col-md-4">
        ...
        <div class="video-testimonial-content">
          <h4 class="mb10">Kedarkantha Trek | Customer Review - 4</h4>
        </div>
      </div>
