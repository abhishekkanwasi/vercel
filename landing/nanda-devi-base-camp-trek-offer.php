...
<head>
  ...
  <title>Nanda Devi Base Camp Trek</title>
  <!-- Favicons-->
  <!-- Favicons-->
...
<body>
  <style>
    .from_conatinaer {
      ...
      background-image: url("http://trekveda.com/images/slides/nanda-devi-base-camp-trek-offer-banner.webp");
      /* The image used */
 ...
 <section class="jumbotron text-center from_conatinaer py-4" id="main-form">
    ...
    <div class="container">
      <h1 class="jumbotron-heading">Nanda Devi Base Camp Trek</h1>
      ...
      <div class="form-container text-center d-flex justify-content-center">
        ...
        <form method="post" action="form-submission.php" class="landing_page_submit_form col-md-8 p-0 m-0">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="trek_name" value="Nanda Devi Base Camp Trek" />
            <input type="hidden" name="Package_link" value="https://trekveda.com/trek/nanda-devi-base-camp-trek.php" />
          </div>
          ...
          <div class="card-body" id="pack_detail_card">
            ...
            <ul>
              <li class="flex-container mb-2">
                ...
                <div style="border-right: 2px solid #dadada;"><i class="fa fa-mountain" style="color: #ff6219"></i> 15,750 ft.</div>
                <div><i class="fa fa-route" style="color: #ff6219"></i> 50 Km</div>
              </li>
              <hr>

              <li class="flex-container mb-2">
                <div style="border-right: 2px solid #dadada;"><b>Start</b> : Munsiyari</div>
                <div style="border-right: 2px solid #dadada;"><b>End</b> : Munsiyari</div>
          ...
          <div class="card-body">
            ...
            <ul class="fa-ul">
               <li><span class="fa-li"></span><strong>Inclusion in cost during the trek:</strong></li>
                <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span>02 Nights Accommodation in Munsayri will be provided using Guest House / Hotels on triple / quad sharing basis.</li>
                <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span>06 Nights Accommodation during the trek will be provided using Dome / Alpine trekking tents on triple sharing basis.</li>
                ...
                <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span>Experienced Trekking Guide for 08 Days i.e. Munsyari to Munsyari.</li>
                ...
                <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span>Drop and pick up to / from trekking point in Munsyari by local public transportation in sharing basis.</li>
                ...
                <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span>Any transport facility to / from Munsyari</li>
              </ul>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="card ellipsis mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <?php
            $sql = "SELECT * FROM Treking_date where Trek_name = 'Nanda Devi Base Camp Trek' ";
            $result = $conn->query($sql);
            while ($row = $result->fetch_assoc())
              for ($i = 1; $i < 367; $i++) {
                $date[$i] = $row['Date_' . $i];
            ...
            $sql1 = "SELECT * FROM Treking_date_Status where Trek_name = 'Nanda Devi Base Camp Trek' ";
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <ul class="timeline">
          <li>
            <a href="#">Day 1</a>
            <p>Arrival in Munsyari (2290 Meters) by surface 165 Kms approx 4-5 Hrs.</p>
          </li>
          <li>
            <a href="#">Day 2</a>
            <p>Munsyari - Lilam: (1940 Meters) – 40 Minutes drive and approx 2 Hrs Trek –Bogdiyar (2450 Meters) by Trek 16 kms approx 7-8 Hrs.</p>
          </li>
          <li>
            <a href="#">Day 3</a>
            <p>Bogdiyar-Rilkote (3200 Meters) by Trek 16 Kms approx 6 Hrs.</p>
          </li>
           <li>
            <a href="#">Day 4</a>
            <p>Rilkote- Ganghar (3300 Meters) by trek 13 Kms approx 6-7 Hrs.</p>
          </li>
           <li>
            <a href="#">Day 5</a>
            <p>Ghanghar- Excursion to Nanda Devi Camp (3900 Meters) approx 3 Hrs.</p>
          </li>
           <li>
            <a href="#">Day 6</a>
            <p>Nanda Devi Base Camp – Martoli (3350 Meters) by trek 12 Kms approx 5 Hrs.</p>
          </li>
           <li>
            <a href="#">Day 7</a>
            <p>Martoli – Bogdiyar (2450 Meters) by trek 18 Kms approx 9-10 Hrs.</p>
          </li>
           <li>
            <a href="#">Day 8</a>
            <p>Bogdiyar – Lilam (1850 Meters) by trek 16 Kms approx 7-8 Hrs - Munsyari (2290 Meters) by Trek 5 Kms approx 3 Hrs.</p>
          </li>
           <li>
            <a href="#">Day 9</a>
            <p>Departure from Munsyari.</p>
          </li>
        </ul>
      </div>
    </div>
