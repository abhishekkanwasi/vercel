...
<head>
  ...
  <title>Himachal Tour Packages 2022 - Early Bird Offer Upto 50% OFF - Trekveda</title>
  <!-- Favicons-->
  <!-- Favicons-->
...
<body>
  <style>
    .from_conatinaer {
      ...
      background-image: url("http://trekveda.com/images/slides/himachal-landing.png");
      /* The image used */
  ...
  <section class="jumbotron text-center from_conatinaer py-4" id="main-form">
    ...
    <div class="container">
      <h1 class="jumbotron-heading">11+ Ladakh Tour Packages 2022</h1>
      <p class="lead">Early Bird Sale Upto 50% OFF - Limited Period Offer</p>
      <p class="lead">Starting from <b>INR 7,809/-</b></p>
      <div class="form-container text-center d-flex justify-content-center">
        ...
        <form method="post" action="form-submission.php" class="landing_page_submit_form col-md-8 p-0 m-0">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="trek_name" value="Ladakh Tour Package" />
            <input type="hidden" name="Package_link" value="https://trekveda.com/himachal.php" />
          </div>
...
<div class="album py-5 bg-light">
      ...
      <h2>Himachal Tour Packages 2022 - Best time to visit Dec to Nov</h2>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4 col-lg-3">
          <?php
          $sql = "select * FROM Tour_package_pages where Title = 'Romantic Manali Honeymoon Package' ;";
          $result = $conn->query($sql);
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/tour/tour-packages/manali-honeymoon-package" target="_Blank">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>Round Trip</span></div>
              <img class="card-img-top" src="../<?php echo $row['card_image']; ?>" alt="Romantic Manali Honeymoon Package">
              <div class="p-2">
        ...
        <div class="col-md-4 col-lg-3">
          <?php
          $sql = "select * FROM Tour_package_pages where Title = 'Manali 4 Days - The Foothills of Himalayas' ;";
          $result = $conn->query($sql);
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/tour/tour-packages/manali-tour-package-4-days" target="_Blank">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>Round Trip</span></div>
              <img class="card-img-top" src="../<?php echo $row['card_image']; ?>" alt="Manali 4 Days - The Foothills of Himalayas">
              <div class="p-2">
                <span class="tour-price"><s><small>&#8377; <?php echo $row['price_without_discount']; ?> </small></s><b> &#8377; <?php echo $row['price_with_discount']; ?></b> </span>
                <span class="badge badge-pill float-right right-gary"><?php echo $row['days']; ?>D/<?php echo $row['days'] - 1; ?>N</span>
                <h5><?php echo $row['Title']; ?></h5>
        ...
        <div class="col-md-4 col-lg-3">
          <?php
          $sql = "select * FROM Tour_package_pages where Title = 'Getaway to Shimla and Manali Package 5 Days' ;";
          $result = $conn->query($sql);
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/tour/tour-packages/shimla-manali-tour-package" target="_Blank">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>Round Trip</span></div>
              <img class="card-img-top" src="../<?php echo $row['card_image']; ?>" alt="Getaway to Shimla and Manali Package 5 Days">
              <div class="p-2">
                <span class="tour-price"><s><small>&#8377; <?php echo $row['price_without_discount']; ?> </small></s><b> &#8377; <?php echo $row['price_with_discount']; ?></b> </span>
                <span class="badge badge-pill float-right right-gary"><?php echo $row['days']; ?>D/<?php echo $row['days'] - 1; ?>N</span>
                <h5><?php echo $row['Title']; ?></h5>
        ...
        <div class="col-md-4 col-lg-3">
          <?php
          $sql = "select * FROM Tour_package_pages where Title = 'Manali Tour Package 3 Days' ;";
          $result = $conn->query($sql);
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/tour/tour-packages/manali-tour-package" target="_Blank">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>Round Trip</span></div>
              <img class="card-img-top" src="../<?php echo $row['card_image']; ?>" alt="Manali Tour Package 3 Days">
              <div class="p-2">
                <span class="tour-price"><s><small>&#8377; <?php echo $row['price_without_discount']; ?> </small></s><b> &#8377; <?php echo $row['price_with_discount']; ?></b> </span>
                <span class="badge badge-pill float-right right-gary"><?php echo $row['days']; ?>D/<?php echo $row['days'] - 1; ?>N</span>
                <h5><?php echo $row['Title']; ?></h5>
        ...
        <div class="col-md-4 col-lg-3">
          <?php
          $sql = "select * FROM Tour_package_pages where Title = 'Getaway - Manali with Kasol Tour Package' ;";
          $result = $conn->query($sql);
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/tour/tour-packages/manali-kasol-tour-package" target="_Blank">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>Round Trip</span></div>
              <img class="card-img-top" src="../<?php echo $row['card_image']; ?>" alt="Getaway - Manali with Kasol Tour Package">
              <div class="p-2">
                <span class="tour-price"><s><small>&#8377; <?php echo $row['price_without_discount']; ?> </small></s><b> &#8377; <?php echo $row['price_with_discount']; ?></b> </span>
                <span class="badge badge-pill float-right right-gary"><?php echo $row['days']; ?>D/<?php echo $row['days'] - 1; ?>N</span>
                <h5><?php echo $row['Title']; ?></h5>
        ...
        <div class="col-md-4 col-lg-3">
          <?php
          $sql = "select * FROM Tour_package_pages where Title = 'Manali Getaway with Kasol & Kheerganga 6 Days' ;";
          $result = $conn->query($sql);
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/tour/tour-packages/manali-kasol-kheerganga-package" target="_Blank">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>Round Trip</span></div>
              <img class="card-img-top" src="../<?php echo $row['card_image']; ?>" alt="Manali Getaway with Kasol & Kheerganga 6 Days">
              <div class="p-2">
                <span class="tour-price"><s><small>&#8377; <?php echo $row['price_without_discount']; ?> </small></s><b> &#8377; <?php echo $row['price_with_discount']; ?></b> </span>
                <span class="badge badge-pill float-right right-gary"><?php echo $row['days']; ?>D/<?php echo $row['days'] - 1; ?>N</span>
                <h5><?php echo $row['Title']; ?></h5>
        ...
        <div class="col-md-4 col-lg-3">
          <?php
          $sql = "select * FROM Tour_package_pages where Title = 'Indo Tibet Boarder Road Enfield Bike Tour' ;";
          $result = $conn->query($sql);
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/tour/tour-packages/indo-tibet-boarder-road-bike-tour" target="_Blank">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>Bike Trip</span></div>
              <img class="card-img-top" src="../<?php echo $row['card_image']; ?>" alt="Indo Tibet Boarder Road Enfield Bike Tour">
              <div class="p-2">
                <span class="tour-price"><s><small>&#8377; <?php echo $row['price_without_discount']; ?> </small></s><b> &#8377; <?php echo $row['price_with_discount']; ?></b> </span>
                <span class="badge badge-pill float-right right-gary"><?php echo $row['days']; ?>D/<?php echo $row['days'] - 1; ?>N</span>
                <h5><?php echo $row['Title']; ?></h5>
...
<div class="col-md-4 col-lg-3">
          <?php
          $sql = "select * FROM Tour_package_pages where Title = 'Himalayan Motor Bike Journey - Once a Life Time Experience' ;";
          $result = $conn->query($sql);
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/tour/tour-packages/himalayan-motor-bike-journey" target="_Blank">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>Bike Trip</span></div>
              <img class="card-img-top" src="../<?php echo $row['card_image']; ?>" alt="Himalayan Motor Bike Journey - Once a Life Time Experience">
              <div class="p-2">
                <span class="tour-price"><s><small>&#8377; <?php echo $row['price_without_discount']; ?> </small></s><b> &#8377; <?php echo $row['price_with_discount']; ?></b> </span>
                <span class="badge badge-pill float-right right-gary"><?php echo $row['days']; ?>D/<?php echo $row['days'] - 1; ?>N</span>
                <h5><?php echo $row['Title']; ?></h5>
        ...
        <div class="col-md-4 col-lg-3">
          <?php
          $sql = "select * FROM Tour_package_pages where Title = 'Lahaul Spiti Valley the Trans Himalayan Journey' ;";
          $result = $conn->query($sql);
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/tour/tour-packages/lahaul-spiti-valley-the-trans-himalayan" target="_Blank">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>Road Trip</span></div>
              <img class="card-img-top" src="../<?php echo $row['card_image']; ?>" alt="Lahaul Spiti Valley the Trans Himalayan Journey">
              <div class="p-2">
                <span class="tour-price"><s><small>&#8377; <?php echo $row['price_without_discount']; ?> </small></s><b> &#8377; <?php echo $row['price_with_discount']; ?></b> </span>
                <span class="badge badge-pill float-right right-gary"><?php echo $row['days']; ?>D/<?php echo $row['days'] - 1; ?>N</span>
                <h5><?php echo $row['Title']; ?></h5>
        ...
        <div class="col-md-4 col-lg-3">
          <?php
          $sql = "select * FROM Tour_package_pages where Title = 'Trans Himalayan overland drive to Ladakh' ;";
          $result = $conn->query($sql);
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/tour/tour-packages/drive-to-ladakh" target="_Blank">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>Road Trip</span></div>
              <img class="card-img-top" src="../<?php echo $row['card_image']; ?>" alt="Trans Himalayan overland drive to Ladakh">
              <div class="p-2">
                <span class="tour-price"><s><small>&#8377; <?php echo $row['price_without_discount']; ?> </small></s><b> &#8377; <?php echo $row['price_with_discount']; ?></b> </span>
                <span class="badge badge-pill float-right right-gary"><?php echo $row['days']; ?>D/<?php echo $row['days'] - 1; ?>N</span>
                <h5><?php echo $row['Title']; ?></h5>
