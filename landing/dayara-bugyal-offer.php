...
<head>
  ...
  <title>Dayara Bugyal Trek 2023 - Trekveda</title>
  <!-- Favicons-->
  <!-- Favicons-->
...
<body>
  <style>
    .from_conatinaer {
      ...
      background-image: url("http://trekveda.com/images/slides/dayara-bugyal-trek-offer-banner.webp");
      /* The image used */
  ...
  <section class="jumbotron text-center from_conatinaer py-4" id="main-form">
    ...
    <div class="container">
      <h1 class="jumbotron-heading">Dayara Bugyal Trek</h1>
      ...
      <div class="form-container text-center d-flex justify-content-center">
        ...
        <form method="post" action="form-submission.php" class="landing_page_submit_form col-md-8 p-0 m-0">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="trek_name" value="Dayara Bugyal Trek" />
            <input type="hidden" name="Package_link" value="https://trekveda.com/trek/dayara-bugyal-trek.php" />
          </div>
        ...
        <div class="card">
          <div class="card-body" id="pack_detail_card">
            <div class="row">
              ...
              <h6 class="card-price col-3 text-right"><mark class="top-mark">23% OFF</mark></b></h6>
            ...
            <ul>
              <li class="flex-container mb-2">
                <div style="border-right: 2px solid #dadada;"><i class="fa fa-calendar-alt" style="color: #ff6219"></i> 4 Days</div>
                <div style="border-right: 2px solid #dadada;"><i class="fa fa-mountain" style="color: #ff6219"></i> 12,000 ft.</div>
                <div><i class="fa fa-route" style="color: #ff6219"></i> 29 Km</div>
              </li>
              <hr>

              <li class="flex-container mb-2">
                <div style="border-right: 2px solid #dadada;"><b>Start</b> : Raithal</div>
                <div style="border-right: 2px solid #dadada;"><b>End</b> : Raithal</div>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="card ellipsis mb-5 mb-lg-0">
          ...
          <li>
            ...
            <p>Day 01: Dehradun – Raithal by surface 235 Kms approx 6-7 Hrs.</p>
          </li>
          <li>
            
            <p>Day 02: Raithal – Gui by Trek 5 Kms approx 4-5 Hrs.</p>
          </li>
          <li>
            
            <p>Day 03: Gui – Dayara top – Gui by Trek 7 Kms.</p>
          </li>
          <li>
            
            <p>Day 04: Gui - Raithal by trek – Drive to Dehradun approx 6-7 Hrs.</p>
          </li>
        </ul>
          </div>
        </div>
...
<style>
  ...
  <hr/>
    ...
    <div class="row">
        <div class="col-md-4">
            <img src="../img/offer/google-reviews/dayaral-bugyal-review-1.png" width="100%"/>
        </div>

        <div class="col-md-4">
            <img src="../img/offer/google-reviews/dayaral-bugyal-review-2.png" width="100%"/>
        </div>

        <div class="col-md-4">
            <img src="../img/offer/google-reviews/dayaral-bugyal-review-3.png" width="100%"/>
        </div>
        
        <div class="col-md-4">
            <img src="../img/offer/google-reviews/dayaral-bugyal-review-4.png" width="100%"/>
        </div>
        
        <div class="col-md-4">
            <img src="../img/offer/google-reviews/dayaral-bugyal-review-5.png" width="100%"/>
        </div>
...
<div class="container mb-4">
    ...
    <div class="row">
        ...
        <div class="video-testimonial-content">
          <h4 class="mb10">Dayara Bugyal Trek | Customer Review - 1</h4>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4 col-lg-3">
          ...
          ?>
          <a href="https://trekveda.com/landing/pangarchulla-trek-offer.php" target="_Blank">
            <div class="box">
       ...
       <div class="col-md-4 col-lg-3">
        ...
        <div class="col-md-4 col-lg-3">
          ...
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/landing/har-ki-dun-trek-offer.php" target="_Blank">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>Upto 50% OFF</span></div>
