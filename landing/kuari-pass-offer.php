...
<head>
  ...
  <title>Kuari Pass Trek 2023 - Early Bird Sale FLAT 33% OFF - Trekveda</title>
  <!-- Favicons-->
  <!-- Favicons-->
...
<body>
  <style>
    .from_conatinaer {
      ...
      background-image: url("http://trekveda.com/images/slides/kuari-pass-trek-offer-banner.webp");
      /* The image used */
  ...
  <section class="jumbotron text-center from_conatinaer py-4" id="main-form">
    ...
    <div class="container">
      <h1 class="jumbotron-heading">Kuari Pass Trek</h1>
      <p class="lead">Early Bird Sale FLAT 27% OFF - Limited Period Offer.</p>
      <div class="form-container text-center d-flex justify-content-center">
        ...
        <form method="post" action="form-submission.php" class="landing_page_submit_form col-md-8 p-0 m-0">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="trek_name" value="Kuari Pass Trek" />
            <input type="hidden" name="Package_link" value="https://trekveda.com/trek/kuari-pass-trek.php" />
          </div>
        ...
        <div class="card">
          <div class="card-body" id="pack_detail_card">
            <div class="row">
              ...
              <h6 class="card-price col-3 text-right"><mark class="top-mark">27% OFF</mark></b></h6>
            ...
            <ul>
              <li class="flex-container mb-2">
                ...
                <div style="border-right: 2px solid #dadada;"><i class="fa fa-mountain" style="color: #ff6219"></i>  12,516 ft.</div>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="card ellipsis mb-5 mb-lg-0">
          ...
          <li>
            ...
            <p>Day 2 : Joshimath - Dhak - Tali.</p>
          </li>
          <li>
            
            <p>Day 3 : Tali to Kuari Pass and back to Tali.</p>
          </li>
          <li>
            
            <p>Day 4 : Tali - Joshimath via Auli.</p>
          </li>
          <li>
            
            <p>Day 5 : Departure from Joshimath.</p>
          </li>
...
<style>
  ...
  <br/>
   ...
   <br/>
        ...
        <h4 style="font-weight: 600">Available Fix Departure Dates 2023 | 100% Guaranteed</h4>
         ...
         <p style="color:black"><b>May:</b> 13, 14, 20, 21, 27, 28.</p>
  ...
  <hr/>
    ...
    <div class="row">
        <div class="col-md-4">
            <img src="../img/offer/google-reviews/Kuari-pass-review-1.png" width="100%"/>
        </div>

        <div class="col-md-4">
            <img src="../img/offer/google-reviews/Kuari-pass-review-2.png" width="100%"/>
        </div>

        <div class="col-md-4">
            <img src="../img/offer/google-reviews/Kuari-pass-review-3.png" width="100%"/>
        </div>
        
        <div class="col-md-4">
            <img src="../img/offer/google-reviews/Kuari-pass-review-4.png" width="100%"/>
        </div>
        
        <div class="col-md-4">
            <img src="../img/offer/google-reviews/Kuari-pass-review-5.png" width="100%"/>
        </div>
        
        <div class="col-md-4">
            <img src="../img/offer/google-reviews/Kuari-pass-review-6.png" width="100%"/>
        </div>
...
<div class="container mb-4">
    ...
    <div class="col-md-12">
          <div class="video">
            <iframe height="500" width="100%" src="https://www.youtube.com/embed/9P2Lih3Njow">
            </iframe>
          </div>
        </div>
  ...
  <div class="album py-5 bg-light">
      <div class="col-md-12 text-center section-title">
        <h2>Popular Trek Packages - Summer and Monsoon Season 2023</h2>
      </div>
    <div class="container">
      <div class="row">
