...
<head>
  ...
  <title>2023 Char Dham Yatra with Rishikesh Haridwar 11 Days - Trekveda</title>
  <!-- Favicons-->
  <!-- Favicons-->
...
<body>
  ...
  <section class="jumbotron text-center from_conatinaer py-4" id="main-form">
    ...
    <div class="container">
      <h1 class="jumbotron-heading">Char Dham Yatra with Rishikesh Haridwar 11 Days</h1>
      ...
      <div class="form-container text-center d-flex justify-content-center">
        ...
        <form method="post" action="form-submission.php" class="landing_page_submit_form col-md-8 p-0 m-0">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="trek_name" value="Char Dham Yatra with Rishikesh Haridwar 11 Days" />
            <input type="hidden" name="Package_link" value="https://trekveda.com/tour/tour-packages/char-dham-package-from-delhi" />
          </div>
        ...
        <div class="card">
          <div class="card-body" id="pack_detail_card">
            <div class="row">
              ...
              <h4 class="price-field text-left col-9"><small style="color:gray"><s> &#8377; 35333</s></small> &#8377; <b><span id="mainprice" style="color:#f7472e;" onchange="onpricechange()">26500</span></b><small id="gst_text"> +5% GST</small></h4>
            ...
            <ul>
              <li class="flex-container mb-2">
                <div style="border-right: 2px solid #dadada;"><i class="fa fa-calendar-alt" style="color: #ff6219"></i> 11 Days</div>
              ...
              <li class="flex-container mb-2">
                <div style="border-right: 2px solid #dadada;"><b>Start</b> : Delhi</div>
                <div style="border-right: 2px solid #dadada;"><b>End</b> : Delhi</div>
        ...
        <div class="card ellipsis mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <ul class="fa-ul">
              ...
              <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span> 10 Nights Accommodation during the trip will be provided using Standard Category of hotel / Home stay/ Guest House at all location in Base room category on Triple sharing basis.</li>
        ...
        <div class="card ellipsis mb-5 mb-lg-0">
          <div class="card-body">
                <p class="h4 card-title text-center package-heading-side">Short Itinerary</p>
                    <ul class="timeline">
                        <li>
                            <p>Day 1: Delhi - Haridwar by surface 225 Kms approx 5-6 Hrs. </p>
                         </li>
                        <li>
                            <p>Day 2: Haridwar to Barkot (1352 Meters) by surface 135 Kms approx 6 Hrs. </p>
                        </li>
                        <li>
                            <p>Day 3: Day Excursion to Yamunotri (3535 Meters) by surface 36 Kms and by Trek 6 Kms (One Way).</p>
                        </li>
                         <li>
                            <p>Day 4: Barkot to Uttarkashi (1352 Meters) by surface 90 Kms approx 5-6 Hrs.</p>
                        </li>
                         <li>
                            <p>Day 5: Uttarkashi Excursion to Gangotri (3048 Meters) by surface 110 Kms approx 3-4 Hrs One way.</p>
                        </li>
                         <li>
                            <p>Day 6: Uttarkashi – Guptkashi (1319 Meters) by surface 225 Kms approx 5-6 Hrs.</p>
                        </li>
                        <li>
                            <p>Day 7: Guptkashi / Sonprayag to Kedarnath Temple by surface approx 30 Kms and By Trek 16 Kms.</p>
                        </li>
                         <li>
                            <p>Day 8: Kedarnath – Gaurikund by trek - Sonprayag – Guptkashi by surface 23.5 Kms.</p>
                        </li>
                         <li>
                            <p>Day 9: Guptkashi to Badrinath (3133 Meters) by surface 160 Kms approx 6-7 Hrs.</p>
                        </li>
                         <li>
                            <p>Day 10: Badrinath to Rishikesh.</p>
                        </li>
                         <li>
                            <p>Day 11: Rishikesh to Delhi.</p>
                        </li>
                    </ul>
       ...
       <br/>
        <table style="border: 1px solid black; padding:5px; width: 50%; margin-left: auto; margin-right: auto">
            <tr style="border: 1px solid black; padding:5px">
             ...
             <tr style="border: 1px solid black; padding:5px">
                <td style="border: 1px solid black; padding:5px">07/Oct/2022</td>
             ...
             <tr style="border: 1px solid black; padding:5px">
                <td style="border: 1px solid black; padding:5px">15/Oct/2022</td>
                <td style="border: 1px solid black; padding:5px">12</td>
                <td style="border: 1px solid black; padding:5px">12</td>
  ...
  <div class="album py-5 bg-light">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4 col-lg-3">
          <?php
          $sql = "select * FROM Tour_package_pages  where Title = 'Kedarnath Yatra Tour from Haridwar 3 Days' ;";
          $result = $conn->query($sql);
          $row = $result->fetch_assoc();
          ?>
