...
<head>
  ...
  <title>Best of Havelock and Port Blair</title>
  <!-- Favicons-->
  <!-- Favicons-->
...
<body>
  <style>
    .from_conatinaer {
      ...
      background-image: url("http://trekveda.com/images/slides/havelock-and-port-blair-offer-banner.webp");
      /* The image used */
 ...
 <section class="jumbotron text-center from_conatinaer py-4" id="main-form">
    ...
    <div class="container">
      <h1 class="jumbotron-heading">Best of Havelock and Port Blair</h1>
      ...
      <div class="form-container text-center d-flex justify-content-center">
        ...
        <form method="post" action="form-submission.php" class="landing_page_submit_form col-md-8 p-0 m-0">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="trek_name" value="Best of Havelock and Port Blair" />
            <input type="hidden" name="Package_link" value="https://trekveda.com/tour/beaches/havelock-and-port-blair" />
          </div>
...
<section class="inclusion_detail_big_cards">
  <div class="container my-4 inclusion_detail_big_cards">
    <div class="row">
          ...
          <div class="card-body" id="pack_detail_card">
            ...
            <ul>
              ...
              <li class="flex-container mb-2">
                ...
                <div style="border-right: 2px solid #dadada;"><b>End</b> : Kalapathar Beach</div>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="card ellipsis mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <?php
            $sql = "SELECT * FROM Treking_date where Trek_name = 'Best of Havelock and Port Blair' ";
            $result = $conn->query($sql);
            while ($row = $result->fetch_assoc())
              for ($i = 1; $i < 367; $i++) {
                $date[$i] = $row['Date_' . $i];
            ...
            $sql1 = "SELECT * FROM Treking_date_Status where Trek_name = 'Best of Havelock and Port Blair' ";
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <ul class="timeline">
          ...
          <li>
            <a href="#">Day 4</a>
            <p>Havelock Island – Portbalir by Ferry.</p>
          </li>
          <li>
            <a href="#">Day 5</a>
