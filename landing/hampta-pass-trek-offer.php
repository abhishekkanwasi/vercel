...
<head>
  ...
  <title>Hampta Pass Trek 2023 - Flat 44% OFF | Trekveda</title>
  <!-- Favicons-->
  <!-- Favicons-->
...
<body>
  <style>
    .from_conatinaer {
      ...
      background-image: url("http://trekveda.com/images/slides/hampta-pass-trek-offer-banner.webp");
      /* The image used */
  ...
  <section class="jumbotron text-center from_conatinaer py-4" id="main-form">
    ...
    <div class="container">
      <h1 class="jumbotron-heading">Hampta Pass with Chandratal Trek</h1>
      ...
      <div class="form-container text-center d-flex justify-content-center">
        ...
        <form method="post" action="form-submission.php" class="landing_page_submit_form col-md-8 p-0 m-0">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="trek_name" value="Hampta Pass Trek" />
            <input type="hidden" name="Package_link" value="https://trekveda.com/trek/hampta-pass-trek.php" />
          </div>
          ...
          <p class="t-c">By clicking the button, you agree to our <a href="term-and-condition.php" target="_Blank"><u>Terms of Services</u></a></p>
        </form>
...
<section class="inclusion_detail_big_cards">
    <div class="col-md-12 text-center">
       <!--<img src="../img/offer/offer-landing-page.png" width="100%" height="auto"/>
        <hr/>-->
      
        <img src="https://trekveda.com/img/offer/book-now-page.png" width="100%" height="auto"/>
    </div>
    </div>
  ...
  <div class="container my-4">
    <div class="row">
        ...
        <div class="card">
          <div class="card-body" id="pack_detail_card">
            <div class="row">
              ...
              <h6 class="card-price col-3 text-right"><mark class="top-mark">44% OFF</mark></b></h6>
            ...
            <ul>
              <li class="flex-container mb-2">
                ...
                <div style="border-right: 2px solid #dadada;"><i class="fa fa-mountain" style="color: #ff6219"></i> 14,100 ft.</div>
                <div><i class="fa fa-route" style="color: #ff6219"></i> 35 Km</div>
              </li>
              <hr>

              <li class="flex-container mb-2">
                <div style="border-right: 2px solid #dadada;"><b>Start</b> : Manali</div>
                <div style="border-right: 2px solid #dadada;"><b>End</b> : Manali</div>

              </li>
              <hr>
              <li class="flex-container mb-2">
                <div style="border-right: 2px solid #dadada;"><i class="fa fa-level-up-alt" style="color: #ff6219"></i> Easy to Moderate</div>
                <div><i class="fa fa-map-marker-alt" style="color: #ff6219"> </i> Himachal</div>
              </li>
            </ul>
            <hr>
        ...
        <div class="card ellipsis mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <ul class="fa-ul">
               ...
               <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span> 04 Nights Accommodation during the trek will be provided using Dome / Alpine trekking tents on triple sharing basis.</li>
                ...
                <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span> Any Personal trekking Gears.</li>
                <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span> Any transport facility to Rumsu and from Manali.</li>
              </ul>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="card ellipsis mb-5 mb-lg-0">
          <div class="card-body">
            <p class="h4 card-title text-center package-heading-side">Short Itinerary</a>
           <ul class="timeline">
          <li>
            <p>Day 1: Manali drive to Jobara and trek to Chikka | 10,100 Ft| trek 30 Kms approx 2.5 Hrs.</p>
          </li>
          <li>
            <p>Day 2: Chikka to Balu ka Ghera | 11,900 feet | by trek 7 Kms approx 5 Hrs.</p>
          </li>
          <li>
            <p>Day 3: Balu ka Ghera - Sheagoru (12,900ft) via Hampta Pass (14,100ft) (7kms/ 8hrs).</p>
          </li>
          <li>
            <p>Day 4: Sheagoru to Chatru and Drive to Chandratal and back to Chatru.</p>
          </li>
          <li>
            <p>Day 5: Jeep Ride Chatru to Manali.</p>
          </li>
...
<style>
   ...
   <br/>
        ...
        <p style="color:black"><b>Jun:</b> 9, 10, 11, 17, 18, 24, 25.</p>
          <p style="color:black"><b>Jul:</b> 1, 2, 8, 9, 15, 16, 22, 23, 29, 30.</p>
          <p style="color:black"><b>Aug:</b> 5, 6, 12, 13, 19, 20, 26, 27.</p>
          <p style="color:black"><b>Sep:</b> 2, 3, 9, 10, 16, 17, 23, 24, 30.</p>
 ...
 <hr/>
    ...
    <div class="row">
        <div class="col-md-4">
            <img src="../img/offer/google-reviews/hpt-review-1.png" width="100%"/>
        </div>

        <div class="col-md-4">
            <img src="../img/offer/google-reviews/hpt-review-2.png" width="100%"/>
        </div>

        <div class="col-md-4">
            <img src="../img/offer/google-reviews/hpt-review-3.png" width="100%"/>
        </div>
        
        <div class="col-md-4">
            <img src="../img/offer/google-reviews/hpt-review-4.png" width="100%"/>
        </div>
        
        <div class="col-md-4">
            <img src="../img/offer/google-reviews/hpt-review-5.png" width="100%"/>
        </div>
        
        <div class="col-md-4">
            <img src="../img/offer/google-reviews/hpt-review-6.png" width="100%"/>
        </div>
    ...
    <br/>
     ...
     <div class="col-md-12 text-center section-title">
        ...
        <div class="container mb-4">
    <div class="col-md-12 text-center section-title">
      <h2>Video Review 5/5 Ratings</h2>
      <!-- <p>Quisque tempus justo molestie lacus blandit</p> -->
    </div>
    <div class="row">
       ...
       <div class="col-md-4">
        ...
        <div class="video-testimonial-content">
          <h4 class="mb10">Kashmir Great Lakes Trek | Customer Review</h4>
          <!-- <p>Retirement Planning</p> -->
        </div>
      </div>
       ...
       <div class="col-md-4">
        ...
        <div class="video-testimonial-content">
          <h4 class="mb10">Pangarchulla Trek | Customer Review</h4>
          <!-- <p>Retirement Planning</p> -->
        </div>
      </div>
      ...
      <div class="col-md-4">
        ...
        <div class="video-testimonial-content">
          <h4 class="mb10">Dayara Bugyal Trek | Customer Review - 8</h4>
          <!-- <p>Retirement Planning</p> -->
        </div>
      </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4 col-lg-3">
          ...
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/landing/chopta-chandrashila-deoriatal-trek-offer.php" target="_Blank">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>Upto 50% OFF</span></div>
              <img class="card-img-top" src="../<?php echo $row['card_image']; ?>" alt="Chopta Chandrashila Deoria Tal Trek">
              <div class="p-2">
                <span class="tour-price"><s><small>&#8377; <?php echo $row['price_without_discount']; ?> </small></s><b> &#8377; <?php echo $row['Price']; ?></b> </span>
                <span class="badge badge-pill float-right right-gary"><?php echo $row['days']; ?>D/<?php echo $row['days'] - 1; ?>N</span>
                <h5><?php echo $row['Trek_name']; ?></h5>
