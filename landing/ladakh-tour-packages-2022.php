...
<head>
  ...
  <title>Ladakh Tour Packages 2022 - Early Bird Offer Upto 50% OFF - Trekveda</title>
  <!-- Favicons-->
  <!-- Favicons-->
...
<body>
  <style>
    .from_conatinaer {
      ...
      background-image: url("http://trekveda.com/images/slides/ladakh-banner.png");
      /* The image used */
  ...
  <section class="jumbotron text-center from_conatinaer py-4" id="main-form">
    ...
    <div class="container">
      <h1 class="jumbotron-heading">Ladakh Tour Packages</h1>
       <h2 class="jumbotron-heading">Starting From INR. 10,900/-</h2>
      
      <p class="lead">Early Bird Offer Upto 50% OFF</p>
      <div class="form-container text-center d-flex justify-content-center">
        ...
        <form method="post" action="form-submission.php" class="landing_page_submit_form col-md-8 p-0 m-0">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="trek_name" value="Ladakh with Nubra Valley & Pangong Lake Tour Package" />
            <input type="hidden" name="Package_link" value="https://trekveda.com/ladakh.php" />
          </div>
  ...
  <div class="container my-4">
    <div class="row">
      ...
      if (mysqli_connect_error()) {
        ...
        $sql = "select * FROM Trek_add_ons_detail  where Trek_name = 'Ladakh with Nubra Valley & Pangong Lake Tour Package' ;";
          ...
          <div class="card-body">
            ...
            <ul class="fa-ul">
              <li><span class="fa-li"></span><strong>Inclusion in cost during the trek:</strong></li>
                <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span> 03  Nights Accommodation during the trip will be provided using Standard Category of hotel at all location in Base room category on Twin sharing basis.</li>
            <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span> Meals as specified in the itinerary on MAP basis (Breakfast and Dinner on buffet basis).</li>
            <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span> Transportation for all arrivals, departures, sightseeing and Excursions as per the itinerary.</li>
            <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span> All toll tax, parking, fuel and driver allowances.</li>
             ...
             <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span> Mandatory GST of 5% on Invoice Amount.</li>
              <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span> Airfare to and from Leh/Leh.</li>
...
<style>
 ...
 <hr/>
    ...
    <div class="row">
        <div class="col-md-4">
            <img src="../img/offer/google-reviews/ladakh-review-1.png" width="100%"/>
        </div>

        <div class="col-md-4">
            <img src="../img/offer/google-reviews/ladakh-review-2.png" width="100%"/>
        </div>

        <div class="col-md-4">
            <img src="../img/offer/google-reviews/ladakh-review-3.png" width="100%"/>
        </div>
        
        <div class="col-md-4">
            <img src="../img/offer/google-reviews/ladakh-review-4.png" width="100%"/>
        </div>
    ...
    <div class="container">
      <div class="row">
          ...
          <?php
          $sql = "select * FROM Tour_package_pages where Title = 'Beautiful Leh Ladakh Tour with Pangong Lake' ;";
          $result = $conn->query($sql);
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/tour/tour-packages/leh-ladakh-tour-pangong-lake" target="_Blank">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>Road Trip</span></div>
              <img class="card-img-top" src="../<?php echo $row['card_image']; ?>" alt="Beautiful Leh Ladakh Tour with Pangong Lake">
              <div class="p-2">
         ...
         <div class="col-md-4 col-lg-3">
          <?php
          $sql = "select * FROM Tour_package_pages where Title = 'Leh Ladakh Bike Trip with Nubra and pangong lake' ;";
          $result = $conn->query($sql);
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/tour/tour-packages/leh-ladakh-bike-trip" target="_Blank">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>Bike Trip</span></div>
              <img class="card-img-top" src="../<?php echo $row['card_image']; ?>" alt="Leh Ladakh Bike Trip with Nubra and pangong lake">
              <div class="p-2">
                <span class="tour-price"><s><small>&#8377; <?php echo $row['price_without_discount']; ?> </small></s><b> &#8377; <?php echo $row['price_with_discount']; ?></b> </span>
                <span class="badge badge-pill float-right right-gary"><?php echo $row['days']; ?>D/<?php echo $row['days'] - 1; ?>N</span>
                <h5><?php echo $row['Title']; ?></h5>
          ...
          <div class="col-md-4 col-lg-3">
          <?php
          $sql = "select * FROM Tour_package_pages where Title = 'Leh Ladakh Adventure Bike Tour' ;";
          $result = $conn->query($sql);
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/tour/tour-packages/ladakh-bike-tour" target="_Blank">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>Bike Trip</span></div>
              <img class="card-img-top" src="../<?php echo $row['card_image']; ?>" alt="Leh Ladakh Adventure Bike Tour">
              <div class="p-2">
                <span class="tour-price"><s><small>&#8377; <?php echo $row['price_without_discount']; ?> </small></s><b> &#8377; <?php echo $row['price_with_discount']; ?></b> </span>
                <span class="badge badge-pill float-right right-gary"><?php echo $row['days']; ?>D/<?php echo $row['days'] - 1; ?>N</span>
                <h5><?php echo $row['Title']; ?></h5>
          ...
          <div class="col-md-4 col-lg-3">
          <?php
          $sql = "select * FROM Tour_package_pages where Title = 'Ladakh with Nubra Valley & Pangong Lake Tour Package' ;";
          $result = $conn->query($sql);
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/landing/ladakh-tour-packages-2022.php" target="_Blank">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>Road Trip</span></div>
              <img class="card-img-top" src="../<?php echo $row['card_image']; ?>" alt="Ladakh with Nubra Valley & Pangong Lake Tour Package">
              <div class="p-2">
                <span class="tour-price"><s><small>&#8377; <?php echo $row['price_without_discount']; ?> </small></s><b> &#8377; <?php echo $row['price_with_discount']; ?></b> </span>
                <span class="badge badge-pill float-right right-gary"><?php echo $row['days']; ?>D/<?php echo $row['days'] - 1; ?>N</span>
                <h5><?php echo $row['Title']; ?></h5>
        ...
        <div class="col-md-4 col-lg-3">
          <?php
          $sql = "select * FROM Tour_package_pages where Title = 'Visit Little Tibet Ladakh with Nubra Valley and Zhanskar' ;";
          $result = $conn->query($sql);
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/tour/tour-packages/tibet-ladakh-with-nubra-valley-and-zhanskar" target="_Blank">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>Road Trip</span></div>
              <img class="card-img-top" src="../<?php echo $row['card_image']; ?>" alt="Visit Little Tibet Ladakh with Nubra Valley and Zhanskar">
              <div class="p-2">
                <span class="tour-price"><s><small>&#8377; <?php echo $row['price_without_discount']; ?> </small></s><b> &#8377; <?php echo $row['price_with_discount']; ?></b> </span>
                <span class="badge badge-pill float-right right-gary"><?php echo $row['days']; ?>D/<?php echo $row['days'] - 1; ?>N</span>
                <h5><?php echo $row['Title']; ?></h5>
    ...
    <div class="col-md-4 col-lg-3">
          <?php
          $sql = "select * FROM Tour_package_pages where Title = 'Ladakh the Little Tibet Tour Package' ;";
          $result = $conn->query($sql);
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/tour/tour-packages/ladakh-the-little-tibet" target="_Blank">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>Road Trip</span></div>
              <img class="card-img-top" src="../<?php echo $row['card_image']; ?>" alt="Ladakh the Little Tibet Tour Package">
              <div class="p-2">
                <span class="tour-price"><s><small>&#8377; <?php echo $row['price_without_discount']; ?> </small></s><b> &#8377; <?php echo $row['price_with_discount']; ?></b> </span>
                <span class="badge badge-pill float-right right-gary"><?php echo $row['days']; ?>D/<?php echo $row['days'] - 1; ?>N</span>
                <h5><?php echo $row['Title']; ?></h5>
         ...
         <div class="col-md-4 col-lg-3">
          <?php
          $sql = "select * FROM Tour_package_pages where Title = 'Ladakh the Land of Lama’s Tour Package' ;";
          $result = $conn->query($sql);
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/tour/tour-packages/ladakh-tour-package" target="_Blank">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>Road Trip</span></div>
              <img class="card-img-top" src="../<?php echo $row['card_image']; ?>" alt="Ladakh the Land of Lama’s Tour Package">
              <div class="p-2">
                <span class="tour-price"><s><small>&#8377; <?php echo $row['price_without_discount']; ?> </small></s><b> &#8377; <?php echo $row['price_with_discount']; ?></b> </span>
                <span class="badge badge-pill float-right right-gary"><?php echo $row['days']; ?>D/<?php echo $row['days'] - 1; ?>N</span>
                <h5><?php echo $row['Title']; ?></h5>
       ...
       <div class="col-md-4 col-lg-3">
          <?php
          $sql = "select * FROM Tour_package_pages where Title = 'Ladakh and Kargil Tour Package' ;";
          $result = $conn->query($sql);
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/tour/tour-packages/ladakh-kargil-tour-package" target="_Blank">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>Road Trip</span></div>
              <img class="card-img-top" src="../<?php echo $row['card_image']; ?>" alt="Ladakh and Kargil Tour Package">
              <div class="p-2">
                <span class="tour-price"><s><small>&#8377; <?php echo $row['price_without_discount']; ?> </small></s><b> &#8377; <?php echo $row['price_with_discount']; ?></b> </span>
                <span class="badge badge-pill float-right right-gary"><?php echo $row['days']; ?>D/<?php echo $row['days'] - 1; ?>N</span>
                <h5><?php echo $row['Title']; ?></h5>
...
<center>
           <iframe width="95%" height="345"  src="https://www.youtube.com/embed/QSOBzFPKf-g?autoplay=1">
            </iframe>
            </center>
      <hr/>
              <center>
           <iframe width="95%" height="345"  src="https://www.youtube.com/embed/Zvuiqn-iRxs?autoplay=1">
            </iframe>
            </center>  
