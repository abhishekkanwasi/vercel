...
<head>
  ...
  <title>2023 Kedarnath with Tungnath Tour from Haridwar 5 Days - Trekveda</title>
  <!-- Favicons-->
  <!-- Favicons-->
...
<body>
  ...
  <section class="jumbotron text-center from_conatinaer py-4" id="main-form">
    ...
    <div class="container">
      <h1 class="jumbotron-heading">Kedarnath with Tungnath Tour from Haridwar 5 Days</h1>
      ...
      <div class="form-container text-center d-flex justify-content-center">
        ...
        <form method="post" action="form-submission.php" class="landing_page_submit_form col-md-8 p-0 m-0">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="trek_name" value="Kedarnath with Tungnath Tour from Haridwar 5 Days" />
            <input type="hidden" name="Package_link" value="https://trekveda.com/tour/tour-packages/kedarnath-package-from-delhi" />
          </div>
        ...
        <div class="card">
          <div class="card-body" id="pack_detail_card">
            <div class="row">
              ...
              <h4 class="price-field text-left col-9"><small style="color:gray"><s> &#8377; 15333</s></small> &#8377; <b><span id="mainprice" style="color:#f7472e;" onchange="onpricechange()">11500</span></b><small id="gst_text"> +5% GST</small></h4>
              ...
              <div class="ratings py-0 my-0 text-right col-4">
                <span class="badge badge-pill right-green"> 5.0</span>
              </div>
        ...
        <div class="card ellipsis mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <ul class="fa-ul">
              ...
              <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span> Transportation using private vehicle on sharing basis from Delhi till Delhi as per the itinerary and given routine.</li>
          ...
          <div class="card-body">
                <p class="h4 card-title text-center package-heading-side">Short Itinerary</p>
                    <ul class="timeline">
                        ...
                        <li>
                            <p>Day 2: Haridwar to Guptkashi.</p>
                        </li>
                        <li>
                            <p>Day 3: Guptkashi / Sonprayag to Kedarnath Temple.</p>
                        </li>
                        <li>
                            <p>Day 4: Kedarnath to Rishikesh.</p>
                        </li>
                        <li>
                            <p>Day 5: Rishikesh to Delhi.</p>
                        </li>
                    </ul>
            </div>
        </div>
