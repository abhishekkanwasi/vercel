...
<head>
  ...
  <title>2022 Vaishno Devi Package from Delhi with Flight - Trekveda</title>
  <!-- Favicons-->
  <!-- Favicons-->
...
<body>
  ...
  <section class="jumbotron text-center from_conatinaer py-4" id="main-form">
    ...
    <div class="container">
      <h1 class="jumbotron-heading">Vaishno Devi Package from Delhi with Flight</h1>
      ...
      <div class="form-container text-center d-flex justify-content-center">
        ...
        <form method="post" action="form-submission.php" class="landing_page_submit_form col-md-8 p-0 m-0">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="trek_name" value="Vaishno Devi Package from Delhi with Flight" />
            <input type="hidden" name="Package_link" value="https://trekveda.com/tour/tour-packages/vaishno-devi-package" />
          </div>
        ...
        <div class="card">
          <div class="card-body" id="pack_detail_card">
            <div class="row">
              ...
              <h4 class="price-field text-left col-9"><small style="color:gray"><s> &#8377; 15733</s></small> &#8377; <b><span id="mainprice" style="color:#f7472e;" onchange="onpricechange()">11800</span></b><small id="gst_text"> +5% GST</small></h4>
        ...
        <div class="card ellipsis mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <ul class="fa-ul">
              ...
              <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span> Flight New Delhi to Jammu and Jammu to New Delhi.</li>
        ...
        <div class="card ellipsis mb-5 mb-lg-0">
          <div class="card-body">
                <p class="h4 card-title text-center package-heading-side">Short Itinerary</p>
                    <ul class="timeline">
                        <li>
                            <p>Day 1: New Delhi to Katra. </p>
                         </li>
                        <li>
                            <p>Day 2: Departure from Katra.</p>
                        </li>
                        </ul>
