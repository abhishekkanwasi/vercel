      ...
      <div class="form-container text-center d-flex justify-content-center">
        ...
        <form method="post" action="form-submission.php" class="landing_page_submit_form col-md-8 p-0 m-0">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="Package_link" value="https://trekveda.com/tour/tour-packages/kedarnath-tungnath-tour-package" />
          </div>
          ...
          <div class="card-body">
                <p class="h4 card-title text-center package-heading-side">Short Itinerary</p>
                    <ul class="timeline">
                        ...
                        <li>
                            <p>Day 3: Kedarnath - Gaurikund - Chopta.</p>
                        </li>
                         <li>
                            <p>Day 4: Chopta to Tungnath and Drive to Sari.</p>
                        </li>
                         <li>
                            <p>Day 5: Sari to Deoriatal, back to Sari and Drive to Haridwar.</p>
                        </li>
                    </ul>
