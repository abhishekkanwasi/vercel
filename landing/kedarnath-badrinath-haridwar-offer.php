...
<head>
  ...
  <title>2023 Kedarnath with Badrinath from Haridwar - Trekveda</title>
  <!-- Favicons-->
  <!-- Favicons-->
...
<body>
  <style>
    .from_conatinaer {
      ...
      background-image: url("http://trekveda.com/images/slides/kedarnath-with-badrinath-offer-banner.webp");
      /* The image used */
  ...
  <section class="jumbotron text-center from_conatinaer py-4" id="main-form">
    ...
    <div class="container">
      <h1 class="jumbotron-heading">Kedarnath with Badrinath from Haridwar</h1>
      ...
      <div class="form-container text-center d-flex justify-content-center">
        ...
        <form method="post" action="form-submission.php" class="landing_page_submit_form col-md-8 p-0 m-0">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="trek_name" value="Kedarnath with Badrinath from Haridwar with Deluxe Stay" />
            <input type="hidden" name="Package_link" value="https://trekveda.com/tour/tour-packages/kedarnath-with-badrinath" />
          </div>
        ...
        <div class="card">
          <div class="card-body" id="pack_detail_card">
            <div class="row">
              ...
              <h4 class="price-field text-left col-9"><small style="color:gray"><s> &#8377; 17866</s></small> &#8377; <b><span id="mainprice" style="color:#f7472e;" onchange="onpricechange()">13400</span></b><small id="gst_text"> +5% GST</small></h4>
        ...
        <div class="card ellipsis mb-5 mb-lg-0">
          <div class="card-body">
                <p class="h4 card-title text-center package-heading-side">Short Itinerary</p>
                    <ul class="timeline">
                        <li>
                            <p>Day 1: Haridwar– Guptkashi by surface 225 Kms approx 5-6 Hrs.</p>
                         </li>
                        <li>
                            <p>Day 2: Guptkashi / Sonprayag to Kedarnath Temple by surface approx 30 Kms and By Trek 20 Kms.</p>
                        </li>
                        <li>
                            <p>Day 3: Kedarnath – Gaurikund by trek - Sonprayag - Guptkashi by surface 23.5 Kms.</p>
                        </li>
                         <li>
                            <p>Day 4: Guptkashi to Badrinath (3133 Meters) by surface 160 Kms approx 6-7 Hrs.</p>
                        </li>
                         <li>
                            <p>Day 5: Badrinath to Haridwar.</p>
                        </li>
                    </ul>
 ...
 <div class="album py-5 bg-light">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4 col-lg-3">
          <?php
          $sql = "select * FROM Tour_package_pages  where Title = 'Char Dham Yatra Tour from Haridwar 9 Days with Deluxe Stay' ;";
          $result = $conn->query($sql);
          $row = $result->fetch_assoc();
          ?>
