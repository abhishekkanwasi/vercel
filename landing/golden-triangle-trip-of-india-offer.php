...
<head>
  ...
  <title>Golden Triangle Trip of India</title>
  <!-- Favicons-->
  <!-- Favicons-->
...
<body>
  <style>
    .from_conatinaer {
      ...
      background-image: url("http://trekveda.com/images/slides/golden-triangle-trip-of-india-offer-banner.webp");
      /* The image used */
 ...
 <section class="jumbotron text-center from_conatinaer py-4" id="main-form">
    ...
    <div class="container">
      <h1 class="jumbotron-heading">Golden Triangle Trip of India</h1>
      ...
      <div class="form-container text-center d-flex justify-content-center">
        ...
        <form method="post" action="form-submission.php" class="landing_page_submit_form col-md-8 p-0 m-0">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="trek_name" value="Golden Triangle Trip of India" />
            <input type="hidden" name="Package_link" value="https://trekveda.com/tour/cultural-heritage/golden-triangle-trip-of-india" />
          </div>
  ...
  <div class="container my-4">
    <div class="row">
      ...
      if (mysqli_connect_error()) {
        ...
        $sql = "select * FROM Tour_package_pages where Title = 'Golden Triangle Trip of India' ;";
        ...
        <div class="card">
          <div class="card-body" id="pack_detail_card">
            <div class="row">
              ...
              <h4 class="price-field text-left col-9"><small style="color:gray"><s> &#36; 158</s></small> &#36; <b><span id="mainprice" style="color:#f7472e;" onchange="onpricechange()">225</span></b><small id="gst_text"> +5% GST</small></h4>
              <h6 class="card-price col-3 text-right"><mark class="top-mark">30% OFF</mark></b></h6>
            ...
            <ul>
              ...
              <li class="flex-container mb-2">
                ...
                <div><i class="fa fa-map-marker-alt" style="color: #ff6219"> </i> India</div>
              </li>
            </ul>
            <hr>
        ...
        <div class="card ellipsis mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <ul class="fa-ul">
              ...
              <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span> Hotel accommodation using 3* hotel / Boutique guest houses on twin sharing basis.</li>
              <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span>Meals as per the itinerary i.e. on Breakfast basis only (Buffet).</li>
              <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span>Transportation for Sightseeing and sectors as per the itinerary using AC mode of transportation (Airport Pickup / Drop will be at additional cost and on request).</li>
              ...
              <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span> Airport pickup and drop services ( Will be subject to additional cost).</li>
                ...
                <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span> Any entrance fee of ASI Monuments / Museum / Temples / Heritage sites etc. clients will have to pay all entrance fee on the spot as per actual cost.</li>
            </ul>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="card ellipsis mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <?php
            $sql = "SELECT * FROM Treking_date where Trek_name = 'Golden Triangle Trip of India' ";
            $result = $conn->query($sql);
            while ($row = $result->fetch_assoc())
              for ($i = 1; $i < 367; $i++) {
                $date[$i] = $row['Date_' . $i];
            ...
            $sql1 = "SELECT * FROM Treking_date_Status where Trek_name = 'Golden Triangle Trip of India' ";
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <ul class="timeline">
          <li>
            <a href="#">Day 1</a>
            <p>in Delhi (Explore the Capital City).</p>
          </li>
          <li>
            <a href="#">Day 2</a>
            <p>Delhi – Agra by surface 215 kms approx 4-5 Hrs.</p>
          </li>
          <li>
            <a href="#">Day 3</a>
            <p>Agra – Jaipur by surface 240 Kms approx 5-6 Hrs.</p>
          </li>
          <li>
            <a href="#">Day 4</a>
            <p>In Jaipur (Explore the pink City).</p>
          </li>
          <li>
            <a href="#">Day 5</a>
            <p>Jaipur – Delhi by surface 280 Kms approx 7-8 Hrs.</p>
          </li>
        </ul>
      </div>
    </div>
