...
<body>
  <style>
    .from_conatinaer {
      ...
      background-image: url("http://trekveda.com/images/slides/goechala-trek-offer-banner.webp");
      /* The image used */
 ...
 <section class="jumbotron text-center from_conatinaer py-4" id="main-form">
    ...
    <div class="container">
      <h1 class="jumbotron-heading">Goechala Trek</h1>
      ...
      <div class="form-container text-center d-flex justify-content-center">
        ...
        <form method="post" action="form-submission.php" class="landing_page_submit_form col-md-8 p-0 m-0">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="trek_name" value="Goechala Trek" />
            <input type="hidden" name="Package_link" value="https://trekveda.com/trek/goechala-trek.php" />
          </div>
          ...
          <div class="card-body" id="pack_detail_card">
            ...
            <ul>
              <li class="flex-container mb-2">
                <div style="border-right: 2px solid #dadada;"><i class="fa fa-calendar-alt" style="color: #ff6219"></i> 10 Days</div>
                <div style="border-right: 2px solid #dadada;"><i class="fa fa-mountain" style="color: #ff6219"></i> 15,100 ft.</div>
                <div><i class="fa fa-route" style="color: #ff6219"></i> 90 Km</div>
              </li>
              <hr>

              <li class="flex-container mb-2">
                <div style="border-right: 2px solid #dadada;"><b>Start</b> : Yuksom</div>
                <div style="border-right: 2px solid #dadada;"><b>End</b> : Yuksom</div>

              </li>
              <hr>
              <li class="flex-container mb-2">
                <div style="border-right: 2px solid #dadada;"><i class="fa fa-level-up-alt" style="color: #ff6219"></i> Difficult</div>
                <div><i class="fa fa-map-marker-alt" style="color: #ff6219"> </i> Sikkim</div>
              </li>
            </ul>
            <hr>
          ...
          <div class="card-body">
            ...
            <ul class="fa-ul">
              <li><span class="fa-li"></span><strong>Inclusion in cost during the trek:</strong></li>
                 <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span>01 Nights Accommodation in Yuksom will be provided using Guest House / Home Stay or triple Sharing basis.</li>
                <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span>08 Nights Accommodation during the trek will be provided using Dome / Alpine trekking tents on triple sharing basis.</li>
                ...
                <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span>Experienced Trekking Guide for 9 Days i.e. Yuksom to Yuksom.</li>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="card ellipsis mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <?php
            $sql = "SELECT * FROM Treking_date where Trek_name = 'Goechala Trek' ";
            $result = $conn->query($sql);
            while ($row = $result->fetch_assoc())
              for ($i = 1; $i < 367; $i++) {
                $date[$i] = $row['Date_' . $i];
            ...
            $sql1 = "SELECT * FROM Treking_date_Status where Trek_name = 'Goechala Trek' ";
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <ul class="timeline">
          <li>
            <a href="#">Day 1</a>
            <p>Yuksom - Tshoka (3050 Mtrs) by Trek 13 Kms approx 6-7 Hrs.</p>
          </li>
          <li>
            <a href="#">Day 2</a>
            <p>Tshoka - Phedang (3750 Mtrs) by Trek 7 Kms 3-4 Kms.</p>
          </li>
          <li>
            <a href="#">Day 3</a>
            <p>Phedang - Dzongri (4030 Mtrs) by Trek 5 Kms approx 2-3 Hrs.</p>
          </li>
          <li>
            <a href="#">Day 4</a>
            <p>Dzongri – Acclimatization / Dzongrila (4300 Mtrs) by Trek approx 40 Minutes.</p>
          </li>
          <li>
            <a href="#">Day 5</a>
            <p>Dzongri - Thangsing (3930 Mtrs) by Trek 6 Kms approx 5-6 hrs).</p>
          </li>
          <li>
            <a href="#">Day 6</a>
            <p>Thangsing - Lamune (4130 Mtrs) 6 Kms approx 4-5 Hrs.</p>
          </li>
          <li>
            <a href="#">Day 7</a>
            <p>Lamune to Goechala (4940 Mtrs) by Trek 14km approx 5 Hrs Thangsing by trek approx 2 hrs.</p>
          </li>
          <li>
            <a href="#">Day 8</a>
            <p>Thangsing - Tsokha (3050 Mtrs) by Trek 12 Kms approx 5-7 Hrs.</p>
          </li>
          <li>
            <a href="#">Day 9</a>
            <p>Tsokha to Yuksom 2250 Mtrs.</p>
          </li>
          <li>
            <a href="#">Day 10</a>
            <p>Departure from Yuksom.</p>
          </li>
        </ul>
      </div>
    </div>
