<?php
    ...
    $email_subject = "Form Submission PPC Pangarchula With Kuari Pass";
...
<div class="container">
	<div class="row text-center">
        ...
        <a href="https://trekveda.com/trek/pangarchulla-with-kuari-pass-trek.php" class="btn btn-success">     Read More      </a>
    <br><br>
        </div>
