...
<head>
  ...
  <title>Valley of Flowers Trek 2023 Flat 45% OFF | Trekveda</title>
  <!-- Favicons-->
  <!-- Favicons-->
...
<body>
  <style>
    .from_conatinaer {
      ...
      background-image: url("http://trekveda.com/images/slides/valley-of-flowers-trek-offer-banner.webp");
      /* The image used */
  ...
  <section class="jumbotron text-center from_conatinaer py-4" id="main-form">
    ...
    <div class="container">
      <h1 class="jumbotron-heading">Valley Of Flowers Trek</h1>
      ...
      <div class="form-container text-center d-flex justify-content-center">
        ...
        <form method="post" action="form-submission.php" class="landing_page_submit_form col-md-8 p-0 m-0">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="trek_name" value="Valley Of Flowers Trek" />
            <input type="hidden" name="Package_link" value="https://trekveda.com/trek/valley-of-flowers-trek.php" />
          </div>
        ...
        <div class="card">
          <div class="card-body" id="pack_detail_card">
            <div class="row">
              ...
              <h6 class="card-price col-3 text-right"><mark class="top-mark">50% OFF</mark></b></h6>
            ...
            <ul>
              <li class="flex-container mb-2">
                ...
                <div style="border-right: 2px solid #dadada;"><i class="fa fa-mountain" style="color: #ff6219"></i> 12,100 ft.</div>
                <div><i class="fa fa-route" style="color: #ff6219"></i> 35 Km</div>
              </li>
              <hr>

              <li class="flex-container mb-2">
                <div style="border-right: 2px solid #dadada;"><b>Start</b> : Joshimath</div>
                <div style="border-right: 2px solid #dadada;"><b>End</b> : Joshimath</div>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="card ellipsis mb-5 mb-lg-0">
          <div class="card-body">
           ...
           <ul class="timeline">
          <li>
            <p>Day 1: Reach Joshimath.</p>
          </li>
          <li>
            <p>Day 2: oshimath - Poolna by drive and trek to Ghangaria 10 Kms.</p>
          </li>
          <li>
            <p>Day 3: Ghangaria - Hemkund Sahib Trek.</p>
          </li>
           <li>
            <p>Day 4: Ghangaria - Valley of Flowers Trek.</p>
          </li>
           <li>
            <p>Day 5: Ghangaria - Poolna Trek 10 Kms drive to Joshimath.</p>
          </li>
           <li>
            <p>Day 6: Departure from Joshimath.</p>
          </li>
...
<style>
   ...
   <br/>
        ...
        <h4 style="font-weight: 600">Available Fix Departure Dates 2023 - 100% Guaranteed</h4>
          ...
          <p style="color:black"><b>Aug:</b> 12, 13, 19, 20, 26, 27.</p>
          <p style="color:black"><b>Sep:</b> 2, 3, 9, 10.</p>
 ...
 <hr/>
    ...
    <div class="row">
        <div class="col-md-4">
            <img src="../img/offer/google-reviews/vof-google-review-1.png" width="100%"/>
        </div>

        <div class="col-md-4">
            <img src="../img/offer/google-reviews/vof-google-review-2.png" width="100%"/>
        </div>

        <div class="col-md-4">
            <img src="../img/offer/google-reviews/vof-google-review-3.png" width="100%"/>
        </div>
        
        <div class="col-md-4">
            <img src="../img/offer/google-reviews/vof-google-review-4.png" width="100%"/>
        </div>
        
        <div class="col-md-4">
            <img src="../img/offer/google-reviews/vof-google-review-5.png" width="100%"/>
        </div>
        
        <div class="col-md-4">
            <img src="../img/offer/google-reviews/vof-google-review-6.png" width="100%"/>
        </div>
...
<div class="container mb-4">
    ...
    <div class="row">
        <div class="col-md-12">
          <div class="video">
            <iframe height="500" width="100%" src="https://www.youtube.com/embed/7ZYxTkTLYT0">
            </iframe>
          </div>
        </div>
    </div>
