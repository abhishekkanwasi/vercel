<?php
    ...
    $email_subject = "Form Submission PPC Panchachuli Base Camp";
...
<div class="container">
	<div class="row text-center">
        ...
        <a href="https://trekveda.com/trek/panchachuli-base-camp-trek.php" class="btn btn-success">     Read More      </a>
    <br><br>
        </div>
