...
<head>
  ...
  <title>2023 Char Dham Yatra Tour from Haridwar - Trekveda</title>
  <!-- Favicons-->
  <!-- Favicons-->
...
<body>
  <style>
    .from_conatinaer {
      ...
      background-image: url("http://trekveda.com/images/slides/char-dham-yatra-offer-banner.webp");
      /* The image used */
  ...
  <section class="jumbotron text-center from_conatinaer py-4" id="main-form">
    ...
    <div class="container">
      <h1 class="jumbotron-heading">Char Dham Yatra Tour from Haridwar</h1>
      ...
      <div class="form-container text-center d-flex justify-content-center">
        ...
        <form method="post" action="form-submission.php" class="landing_page_submit_form col-md-8 p-0 m-0">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="trek_name" value="Char Dham Yatra from Haridwar Basic Tour Package" />
            <input type="hidden" name="Package_link" value="https://trekveda.com/tour/tour-packages/char-dham-yatra-haridwar-8-days" />
          </div>
        ...
        <div class="card">
          <div class="card-body" id="pack_detail_card">
            <div class="row">
              ...
              <h4 class="price-field text-left col-9"><small style="color:gray"><s> &#8377; 23333</s></small> &#8377; <b><span id="mainprice" style="color:#f7472e;" onchange="onpricechange()">17500 </span></b><small id="gst_text"> +5% GST</small></h4>
        ...
        <div class="card ellipsis mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <ul class="fa-ul">
              ...
              <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span> 07 Nights Accommodation during the trip will be provided using Standard Category of hotel / Home stay/ Guest House at all location in Base room category on Triple/Quard sharing basis.</li>
        ...
        <div class="card ellipsis mb-5 mb-lg-0">
          <div class="card-body">
                <p class="h4 card-title text-center package-heading-side">Short Itinerary</p>
                    <ul class="timeline">
                        <li>
                            <p>Day 01: Haridwar to Janki Chatti by surface 224 Kms approx 8 Hrs. </p>
                         </li>
                        <li>
                            <p>Day 02: Janki Chatti to Yamunotri and by Trek 6 Kms to Uttarkashi 123 Kms approx 5 Hrs.</p>
                        </li>
                        <li>
                            <p>Day 03: Uttarkashi Excursion to Gangotri by surface 110 Kms approx 3-4 Hrs One way.</p>
                        </li>
                         <li>
                            <p>Day 04: Uttarkashi – Guptkashi/Phata/Sitapur/sonprayag by surface 225 Kms approx 6-7 Hrs.</p>
                        </li>
                         <li>
                            <p>Day 05: Guptkashi/Phata/Sitapur/sonprayag to Kedarnath Temple. and By Trek 19 Kms.</p>
                        </li>
                         <li>
                            <p>Day 06: Kedarnath – Gaurikund by trek - Sonprayag - Pipalkoti by surface approx 4-5 Hrs.</p>
                        </li>
                        <li>
                            <p>Day 07: Pipalkoti to Badrinath to Pipalkoti by surface 75 Kms approx 2-3 Hrs.</p>
                        </li>
                         <li>
                            <p>Day 08: Pipalkoti - Haridwar by surface 235 Kms approx 6-7 Hrs.</p>
                        </li>
 ...
 <style>
    ...
    <hr/>
       ...
       <!-- <div class="col-md-12 text-center section-title">
        ...
        <h4 style="font-weight: 600">Kedarnath Yatra Tour from Haridwar - Available Fix Departure Dates 2022 - 100% Guaranteed</h4>
       <br/>
        <table style="border: 1px solid black; padding:5px; width: 50%; margin-left: auto; margin-right: auto">
            ...
            <tr style="border: 1px solid black; padding:5px">
                <td style="border: 1px solid black; padding:5px">08/Oct/2022</td>
             ...
             <tr style="border: 1px solid black; padding:5px">
                <td style="border: 1px solid black; padding:5px">09/Oct/2022</td>
                <td style="border: 1px solid black; padding:5px">12</td>
                <td style="border: 1px solid black; padding:5px">12</td>
             ...
             <tr style="border: 1px solid black; padding:5px">
                <td style="border: 1px solid black; padding:5px">16/Oct/2022</td>
                <td style="border: 1px solid black; padding:5px">12</td>
                <td style="border: 1px solid black; padding:5px">12</td>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4 col-lg-3">
          <?php
          $sql = "select * FROM Tour_package_pages  where Title = 'Kedarnath Yatra Tour from Haridwar 3 Days with Deluxe Stay' ;";
          $result = $conn->query($sql);
          $row = $result->fetch_assoc();
          ?>
        ...
        <div class="col-md-4 col-lg-3">
          <?php
          $sql = "select * FROM Tour_package_pages  where Title = 'Char Dham Yatra with Rishikesh Haridwar 11 Days' ;";
          $result = $conn->query($sql);
          $row = $result->fetch_assoc();
          ?>
        ...
        <div class="col-md-4 col-lg-3">
          <?php
          $sql = "select * FROM Tour_package_pages  where Title = 'Kedarnath Yatra with Rishikesh Haridwar from Delhi 5 Days' ;";
          $result = $conn->query($sql);
          $row = $result->fetch_assoc();
          ?>
        ...
        <div class="col-md-4 col-lg-3">
          <?php
          $sql = "select * FROM Tour_package_pages  where Title = 'Kedarnath with Badrinath from Haridwar with Deluxe Stay' ;";
          $result = $conn->query($sql);
          $row = $result->fetch_assoc();
          ?>
        ...
        <div class="col-md-4 col-lg-3">
          ...
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/landing/gangotri-yumnotri-offer.php" target="_Blank">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>POPULAR</span></div>
              <img class="card-img-top" src="<?php echo $root1 ?>/<?php echo $row['card_image']; ?>" alt="<?php echo $row['Title']; ?>">
              <div class="p-2">
