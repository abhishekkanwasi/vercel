...
<head>
  ...
  <title>Upcoming Trek Packages 2022 - Early Bird Sale Upto 50% OFF in Trek Booking - Trekveda</title>
...
<body>
  ...
  <section class="jumbotron text-center from_conatinaer py-4" id="main-form">
    ...
    <div class="container">
      <h1 class="jumbotron-heading">Early Bird Sale Get Upto 50% OFF</h1>
      ...
      <div class="form-container text-center d-flex justify-content-center">
        ...
        <form method="post" action="form-submission.php" class="landing_page_submit_form col-md-8 p-0 m-0">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="trek_name" value="Upcoming-Trek-Packages-Offer" />
            <input type="hidden" name="Package_link" value="https://trekveda.com/trekking.php" />
          </div>
...
<style>
    ...
    <div class="container mt-4">
        <img src="<?php echo $root1 ?>/img/early-bird-sale-banner.png" data-sizes="100%">
    </div>

  <div class="album py-5 bg-light">
      
      <div class="col-md-12 text-center section-title">
      <h2>Popular Trek Packages - Mar to Nov 2022</h2>
      
      <p style="color:black">Choose any of them and send your enquiry, our experts will reach you and clear all the doubts and help you with further process for your better travel experience. </p>
        <br/>
      </div>
