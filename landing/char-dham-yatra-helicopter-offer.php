...
<head>
  ...
  <title>2023 Char Dham Yatra by Helicopter Package 6 Days - Trekveda</title>
  <!-- Favicons-->
  <!-- Favicons-->
...
<body>
  ...
  <section class="jumbotron text-center from_conatinaer py-4" id="main-form">
    ...
    <div class="container">
      <h1 class="jumbotron-heading">Char Dham Yatra by Helicopter Package 6 Days</h1>
      ...
      <div class="form-container text-center d-flex justify-content-center">
        ...
        <form method="post" action="form-submission.php" class="landing_page_submit_form col-md-8 p-0 m-0">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="trek_name" value="Char Dham Yatra by Helicopter Package 6 Days" />
            <input type="hidden" name="Package_link" value="https://trekveda.com/tour/tour-packages/char-dham-yatra-by-helicopter" />
          </div>
        ...
        <div class="card">
          <div class="card-body" id="pack_detail_card">
            <div class="row">
              ...
              <h4 class="price-field text-left col-9"><small style="color:gray"><s> &#8377; 236000</s></small> &#8377; <b><span id="mainprice" style="color:#f7472e;" onchange="onpricechange()">177000</span></b><small id="gst_text"> +5% GST</small></h4>
        ...
        <div class="card ellipsis mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <ul class="fa-ul">
              ...
              <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span> Helicopter flying charges ex-Dehradun.</li>
              <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span> Complimentary stay on your arrival at Dehradun on CP Plan (Breakfasts included). This additional night makes our package a 5N/6D tour.</li>
              <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span> Airport, Helipad and hotel transfers. Local transport at each dham.</li>
              <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span> Hotel accommodation for 4 nights at APAI plan (all meals included) at each Dham.</li>
             <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span>  Shri Kedarnath ji shuttle tickets.</li>
              <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span> VIP Darshan at all four temples.</li>
              <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span> Airport, Helipad and hotel transfers. Local transport at each dham.</li>
              <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span> Royalty, landing and parking charges applicable in Uttarakhand.</li>
              <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span> Helicopter handling charges.</li>
              <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span> Company Escort at all the destinations.</li>
              <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span> We shall pick up the guests from Dehradun airport as per their scheduled arrivals, or from railway station, and drop them to hotel. Airport to Dehradun hotel will be an approx. 01- and-a-half-hour journey by road.</li>
            <li>&nbsp;</li>
            ...
            <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span> Any special puja charges, tips, porter charges & any services of personal nature.</li>
            </ul>
        ...
        <div class="card ellipsis mb-5 mb-lg-0">
          <div class="card-body">
                <p class="h4 card-title text-center package-heading-side">Short Itinerary</p>
                    <ul class="timeline">
                        <li>
                            <p>Day 1: Reach Dehradun. </p>
                         </li>
                        <li>
                            <p>Day 2: Dehradun-Yamunotri.</p>
                        </li>
                        <li>
                            <p>Day 3: Yamunotri-Gangotri.</p>
                        </li>
                         <li>
                            <p>Day 4: Gangotri-Kedarnath-Sersi/Phata.</p>
                        </li>
                         <li>
                            <p>Day 5: Sersi/Phata-Badrinath.</p>
                        </li>
                         <li>
                            <p>Day 6: Badrinath-Dehradun.</p>
                        </li>
                       </ul>
