...
<head>
  ...
  <title>2022 Vaishno Devi Darshan Package from Delhi 2 Nights - Trekveda</title>
  <!-- Favicons-->
  <!-- Favicons-->
...
<body>
  <style>
    .from_conatinaer {
      ...
      background-image: url("http://trekveda.com/images/slides/vaishno-devi-package-flight.jpg");
      /* The image used */
  ...
  <section class="jumbotron text-center from_conatinaer py-4" id="main-form">
    ...
    <div class="container">
      <h1 class="jumbotron-heading">Vaishno Devi Darshan Package from Delhi 2 Nights</h1>
      ...
      <div class="form-container text-center d-flex justify-content-center">
        ...
        <form method="post" action="form-submission.php" class="landing_page_submit_form col-md-8 p-0 m-0">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="trek_name" value="Vaishno Devi Darshan Package from Delhi 2 Nights" />
            <input type="hidden" name="Package_link" value="https://trekveda.com/tour/tour-packages/vaishno-devi" />
          </div>
        ...
        <div class="card">
          <div class="card-body" id="pack_detail_card">
            <div class="row">
              ...
              <h4 class="price-field text-left col-9"><small style="color:gray"><s> &#8377; 10533</s></small> &#8377; <b><span id="mainprice" style="color:#f7472e;" onchange="onpricechange()">7900</span></b><small id="gst_text"> +5% GST</small></h4>
            ...
            <ul>
              ...
              <li class="flex-container mb-2">
                ...
                <div><i class="fa fa-map-marker-alt" style="color: #ff6219"> </i> Jammu</div>
              </li>
            </ul>
            <hr>
        ...
        <div class="card ellipsis mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <ul class="fa-ul">
              ...
              <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span> Train to / from NDLS - Katra on 3rd AC.</li>
              <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span> 01 Nigh Stay in Katra Standard Hotel on CP Basis (Breakfast Only).</li>
              <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span> 02 Transfer by Taxi (Jammu to Katra and Katra to Jammu) only transfers no sightseeing.</li>
            ...
            <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span> Any services in Vashno Devi Mandir.</li>
            </ul>
        ...
        <div class="card ellipsis mb-5 mb-lg-0">
          <div class="card-body">
                <p class="h4 card-title text-center package-heading-side">Short Itinerary</p>
                    <ul class="timeline">
                        <li>
                            <p>Day 1: New Delhi to Jammu by train.</p>
                         </li>
                        <li>
                            <p>Day 2: Jammu - Katra - Vashno Devi and return same day to Katra.</p>
                        </li>
                        <li>
                            <p>Day 3: Katra - Jammu by Taxi and Train to Delhi.</p>
                        </li>
                        </ul>
