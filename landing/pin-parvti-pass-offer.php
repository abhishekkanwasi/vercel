...
<head>
  ...
  <title>Pin Parvati Pass Trek</title>
  <!-- Favicons-->
  <!-- Favicons-->
...
<body>
  <style>
    .from_conatinaer {
      ...
      background-image: url("http://trekveda.com/images/slides/pin-parvati-pass-trek-offer-banner.webp");
      /* The image used */
   ...
   <section class="jumbotron text-center from_conatinaer py-4" id="main-form">
    ...
    <div class="container">
      <h1 class="jumbotron-heading">Pin Parvati Pass Trek</h1>
      ...
      <div class="form-container text-center d-flex justify-content-center">
        ...
        <form method="post" action="form-submission.php" class="landing_page_submit_form col-md-8 p-0 m-0">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="trek_name" value="Pin Parvati Pass Trek" />
            <input type="hidden" name="Package_link" value="https://trekveda.com/trek/pin-parvati-pass-trek.php" />
          </div>
          ...
          <div class="card-body" id="pack_detail_card">
            ...
            <ul>
              <li class="flex-container mb-2">
                ...
                <div style="border-right: 2px solid #dadada;"><i class="fa fa-mountain" style="color: #ff6219"></i> 17,500 ft.</div>
                <div><i class="fa fa-route" style="color: #ff6219"></i> 110 Km</div>
              </li>
              <hr>

              <li class="flex-container mb-2">
                <div style="border-right: 2px solid #dadada;"><b>Start</b> : Barshaini</div>
                <div style="border-right: 2px solid #dadada;"><b>End</b> : Kaza</div>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="card ellipsis mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <?php
            $sql = "SELECT * FROM Treking_date where Trek_name = 'Pin Parvati Pass Trek' ";
            $result = $conn->query($sql);
            while ($row = $result->fetch_assoc())
              for ($i = 1; $i < 367; $i++) {
                $date[$i] = $row['Date_' . $i];
            ...
            $sql1 = "SELECT * FROM Treking_date_Status where Trek_name = 'Pin Parvati Pass Trek' ";
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <ul class="timeline">
          <li>
            <a href="#">Day 1</a>
            <p>Manali to Barshaini and trek to Kalga.</p>
          </li>
          <li>
            <a href="#">Day 2</a>
            <p>Kalga to Kheerganga.</p>
          </li>
          <li>
            <a href="#">Day 3</a>
            <p>Kheerganga to Tunda Bhuj.</p>
          </li>
          <li>
            <a href="#">Day 4</a>
            <p>Tunda Bhuj to Thakur Kuan.</p>
          </li>
          <li>
            <a href="#">Day 5</a>
            <p>Thakur Kuan to Odi Thach.</p>
          </li>
          <li>
            <a href="#">Day 6</a>
            <p>Odi Thach to Mantalai Lake.</p>
          </li>
          <li>
            <a href="#">Day 7</a>
            <p>Mantali Lake to Summit Camp.</p>
          </li>
          <li>
            <a href="#">Day 8</a>
            <p>Summit Camp - Summit to Pin base/Bedu Thatch.</p>
          </li>
          <li>
            <a href="#">Day 9</a>
            <p>Pin Base to Tiya.</p>
          </li>
          <li>
            <a href="#">Day 10</a>
            <p>Tiya to Mud Drive to Kaza.</p>
          </li>
          <li>
            <a href="#">Day 11</a>
            <p>Kaza to Manali.</p>
