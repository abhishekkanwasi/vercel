...
<head>
  ...
  <title>Gaumukh Tapovan Trek</title>
  <!-- Favicons-->
  <!-- Favicons-->
...
<body>
  <style>
    .from_conatinaer {
      ...
      background-image: url("http://trekveda.com/images/slides/gaumukh-tapovan-trek-offer-banner.webp");
      /* The image used */
 ...
 <section class="jumbotron text-center from_conatinaer py-4" id="main-form">
    ...
    <div class="container">
      <h1 class="jumbotron-heading">Gaumukh Tapovan Trek</h1>
      ...
      <div class="form-container text-center d-flex justify-content-center">
        ...
        <form method="post" action="form-submission.php" class="landing_page_submit_form col-md-8 p-0 m-0">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="trek_name" value="Gaumukh Tapovan Trek" />
            <input type="hidden" name="Package_link" value="https://trekveda.com/trek/gaumukh-tapovan-trek.php" />
          </div>
  ...
  <div class="container my-4">
    <div class="row">
      ...
      if (mysqli_connect_error()) {
        ...
        $sql = "select * FROM Trek_add_ons_detail  where Trek_name = 'Gaumukh Tapovan Trek' ;";
          ...
          <div class="card-body" id="pack_detail_card">
            ...
            <ul>
              <li class="flex-container mb-2">
                ...
                <div style="border-right: 2px solid #dadada;"><i class="fa fa-mountain" style="color: #ff6219"></i>  14,600 ft.</div>
                <div><i class="fa fa-route" style="color: #ff6219"></i> 46 Km</div>
              </li>
              <hr>

              <li class="flex-container mb-2">
                <div style="border-right: 2px solid #dadada;"><b>Start</b> : Gangotri</div>
                <div style="border-right: 2px solid #dadada;"><b>End</b> : Gangotri</div>
          ...
          <div class="card-body">
            ...
            <ul class="fa-ul">
              <li><span class="fa-li"></span><strong>Inclusion in cost during the trek:</strong></li>
                <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span> 02 Nights Accommodation in Gangotri in Standard Hotel on triple sharing room </li>
                <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span> 03 Nights Accommodation in trekking Tents on triple sharing basis </li>
                <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span> 01 Certified Trekking Guide during trek</li>
                <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span> Trekking Crew (Cooks & Helpers)</li>
                <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span> All Trekking and Camping Permits and Permission</li>
                <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span> Basic Indian Vegetarian Meals starting with Dinner on Day 01 and Ending with Breakfast on Day</li>
                <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span> 06 and will be as follows (03 meals a Day)</li>
                ...
                <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span>Transportation from Dehradun to Gangotri and Back to Dehradun (subject to add. Cost) </li>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="card ellipsis mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <?php
            $sql = "SELECT * FROM Treking_date where Trek_name = 'Gaumukh Tapovan Trek' ";
            $result = $conn->query($sql);
            while ($row = $result->fetch_assoc())
              for ($i = 1; $i < 367; $i++) {
                $date[$i] = $row['Date_' . $i];
            ...
            $sql1 = "SELECT * FROM Treking_date_Status where Trek_name = 'Gaumukh Tapovan Trek' ";
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <ul class="timeline">
          <li>
            <a href="#">Day 1</a>
            <p>Dehradun- Gangotri, Altitude: 10,170 Ft. by surface 241 Kms approx 8 Hrs.</p>
          </li>
          <li>
            <a href="#">Day 2</a>
            <p>Gangotri to Chirbasa, Altitude: 11,680 Ft, by trek 9 Kms approx 5-6 Hrs.</p>
          </li>
          <li>
            <a href="#">Day 3</a>
            <p>Chirbasa to Bhojbasa, Altitude: 12,435 Ft, by trek 5 Km approx 2-3 hrs trek.</p>
          </li>
          <li>
            <a href="#">Day 4</a>
            <p>Bhojwasa to Tapovan via Gaumukh and Back to Bhojwasa.</p>
          </li>
          <li>
            <a href="#">Day 5</a>
            <p>Bhojwasa to Gangotri.</p>
          </li>
          <li>
            <a href="#">Day 6</a>
            <p> Gangotri to Dehradun.</p>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4 col-lg-3">
          <?php
          $sql = "select * FROM Trek_add_ons_detail  where Trek_name = 'Bagini Glacier And Changabang Base Camp Trek' ;";
          $result = $conn->query($sql);
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/landing/bagini-trek-offer.php">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>POPULAR</span></div>
              <img class="card-img-top" src="../<?php echo $row['card_image']; ?>" alt="Bagini Glacier And Changabang Base Camp Trek">
              <div class="p-2">
        ...
        <div class="col-md-4 col-lg-3">
          ...
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/landing/bali-pass-trek-offer.php">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>POPULAR</span></div>
        ...
        <div class="col-md-4 col-lg-3">
          <?php
          $sql = "select * FROM Trek_add_ons_detail  where Trek_name = 'Dodital Darwa Pass Trek' ;";
          $result = $conn->query($sql);
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/landing/dodital-darwa-pass-trek-offer.php">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>POPULAR</span></div>
              <img class="card-img-top" src="../<?php echo $row['card_image']; ?>" alt="Dodital Darwa Pass Trek">
              <div class="p-2">
                <span class="tour-price"><s><small>&#8377; <?php echo $row['price_without_discount']; ?> </small></s><b> &#8377; <?php echo $row['Price']; ?></b> </span>
                <span class="badge badge-pill float-right right-gary"><?php echo $row['days']; ?>D/<?php echo $row['days'] - 1; ?>N</span>
                <h5><?php echo $row['Trek_name']; ?></h5>
        ...
        <div class="col-md-4 col-lg-3">
          ...
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/landing/rupin-pass-trek-offer.php">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>POPULAR</span></div>
        ...
        <div class="col-md-4 col-lg-3">
          ...
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/landing/buran-ghati-offer.php">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>POPULAR</span></div>
        ...
        <div class="col-md-4 col-lg-3">
          ...
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/landing/pin-bhaba-pass-trek-offer.php">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>POPULAR</span></div>
