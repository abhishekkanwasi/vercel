<?php
    ...
    $email_subject = "Form Submission PPC Nandi Kund Ghiya Vinayak Pass";
...
<div class="container">
	<div class="row text-center">
        ...
        <a href="https://trekveda.com/trek/nandi-kund-ghiya-vinayak-pass-trek.php" class="btn btn-success">     Read More      </a>
    <br><br>
        </div>
