...
<head>
  ...
  <title>2023 Kedarnath & Badrinath with Rishikesh Haridwar from Delhi - Trekveda</title>
  <!-- Favicons-->
  <!-- Favicons-->
...
<body>
  ...
  <section class="jumbotron text-center from_conatinaer py-4" id="main-form">
    ...
    <div class="container">
      <h1 class="jumbotron-heading">Kedarnath & Badrinath with Rishikesh Haridwar from Delhi</h1>
      ...
      <div class="form-container text-center d-flex justify-content-center">
        ...
        <form method="post" action="form-submission.php" class="landing_page_submit_form col-md-8 p-0 m-0">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="trek_name" value="Kedarnath & Badrinath with Rishikesh Haridwar from Delhi" />
            <input type="hidden" name="Package_link" value="https://trekveda.com/tour/tour-packages/kedarnath-badrinath-from-delhi-package" />
          </div>
        ...
        <div class="card">
          <div class="card-body" id="pack_detail_card">
            <div class="row">
              ...
              <h4 class="price-field text-left col-9"><small style="color:gray"><s> &#8377; 24533</s></small> &#8377; <b><span id="mainprice" style="color:#f7472e;" onchange="onpricechange()">18400</span></b><small id="gst_text"> +5% GST</small></h4>
        ...
        <div class="card ellipsis mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <ul class="fa-ul">
              ...
              <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span> 06 Nights Accommodation during the trip will be provided using Standard Category of hotel / Home stay/ Guest House at all location in Base room category on Triple sharing basis.</li>
          ...
          <div class="card-body">
                <p class="h4 card-title text-center package-heading-side">Short Itinerary</p>
                    <ul class="timeline">
                        ...
                        <li>
                            <p>Day 2: Haridwar - Guptkashi by surface 225 Kms approx 5-6 Hrs.</p>
                        </li>
                        <li>
                            <p>Day 3: Guptkashi / Sonprayag to Kedarnath Temple by surface approx 30 Kms and By Trek 20 Kms.</p>
                        </li>
                         <li>
                            <p>Day 4: Kedarnath – Gaurikund by trek - Sonprayag - Guptkashi by surface 23.5 Kms.</p>
                        </li>
                         <li>
                            <p>Day 5: Guptkashi to Badrinath (3133 Meters) by surface 160 Kms approx 6-7 Hrs.</p>
                        </li>
                         <li>
                            <p>Day 6: Badrinath to Rishikesh.</p>
                        </li>
                         <li>
                            <p>Day 7: Rishikesh to Delhi.</p>
                        </li>
                    </ul>
