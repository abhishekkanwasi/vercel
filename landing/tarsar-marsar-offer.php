...
<!-- Basic Page Needs -->
<meta charset="utf-8">
<title>Tarsar Marsar Lake Trek with Trekveda | Best Trekking Company | Offer</title>
<meta name="description" content="">
<meta name="author" content="Amit Kukreti">
<meta name="keywords" content="Tarsar Marsar Lake Trek">
...
<div id="image">
<img src="/images/slides/tarsar-marsar-lake-trek-offer-banner.jpg" class="img-responsive"/>
	...
	<div id="loginForm" class="contactFrm">
                    ...
                    <p class="trek-title">Tarsar Marsar Trek</p>	
                    ...
                    <div class="panel-body">
                        <fieldset>	
                            ...
                            <input  type="hidden" name="trek_name" value="Tarsar Marsar Trek"  />
...
<div class="container">
		...
		<div class="col-md-4">
			<div class="package-price-card desktop-short-itinerary">
				<div class="package-price-card-top">
					<span>Rs.</span><strong>12,250</strong><small>per person plus 5% GST</small>
				</div>
				
				<hr/>
				
				<p><img src="/images/package-icon/calendar.png"/><span>7 Days</span><img src="/images/package-icon/mountains.png"/><span>13,500 ft.</span><img src="/images/package-icon/distance.png"/><span style="border:0px">33 Km</span><p>
				
				<hr/>
				
				<p><img src="/images/package-icon/boot.png"/><span>Easy to Moderate</span><img src="/images/package-icon/state.png"/><span style="border:0px">J & K</span><p>
				...
				<a><img src="/images/package-icon/maps-and-flags.png"/><span><b>Start</b> : Aru</span><img src="/images/package-icon/maps-and-flags.png"/><span style="border:0px"><b>End</b> : Sumbal</span></a>
				<hr/>
	...
	<div class="package-side-box mobile-short-itinerary">
				...
				<p><b>Day 1:</b> Arrive at Srinagar. Depart Srinagar by 2 pm and drive to Aru base camp</p>
				<p><b>Day 2:</b> Aru to Lidderwat (9.5 km, 6 hours)</p>
				<p><b>Day 3:</b> Lidderwat to Shekwas (5.6 km, 5 hours)</p>
				<p><b>Day 4:</b> Shekwas to Tarsar and explore Tarsar (5 km, 4 hours)</p>
				<p><b>Day 5:</b> Tarsar to Sundarsar (5 km, 5 hours)</p>
				<p><b>Day 6:</b> Sundarsar to Marsar and back and then Sonmasti (7.5 km, 6 hours)</p>
				<p><b>Day 7:</b> Sonmasti to Sumbal. Drive to Srinagar and reach by 5 pm.</p>
				
				<p>The prepaid mobile network do not work in Kashmir.</p>
				<p>You have to carry ID proof in original and 2 photo copies.</p>
				<p><i>At Day 7, you will reach Srinagar between 7:30 pm to 8:00 pm. You may book your trasportation anytime after 8:30 pm.</i></p>
		</div>
...
<div id="popup_main_id" class="popup_main_class">
  ...
  <form class="popup-content" id="popup_form_id">
      ...
      <div class="popup-content-container">
        ...
        <input type="text"  name="trek"  value="Tarsar Marsar Lake offer" readonly style="display:none">
