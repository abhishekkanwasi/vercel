<?php
    ...
    $email_subject = "Form Submission PPC Chopta Chandrashila Deoria Tal";
...
<div class="container">
	<div class="row text-center">
        ...
        <a href="https://trekveda.com/trek/chopta-chandrashila-deoria-tal-trek.php" class="btn btn-success">     Read More      </a>
    <br><br>
        </div>
