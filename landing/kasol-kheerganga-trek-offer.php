...
<body>
  <style>
    .from_conatinaer {
      ...
      background-image: url("http://trekveda.com/images/slides/kheerganga-trek-offer-banner.webp");
      /* The image used */
  ...
  <section class="jumbotron text-center from_conatinaer py-4" id="main-form">
    ...
    <div class="container">
      <h1 class="jumbotron-heading">Kheerganga Trek</h1>
      ...
      <div class="form-container text-center d-flex justify-content-center">
        ...
        <form method="post" action="form-submission.php" class="landing_page_submit_form col-md-8 p-0 m-0">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="trek_name" value="Kasol Kheerganga trek" />
            <input type="hidden" name="Package_link" value="https://trekveda.com/trek/kheerganga-trek.php" />
          </div>
...
<?php
      if (mysqli_connect_error()) {
        ...
        $sql = "select * FROM Trek_add_ons_detail  where Trek_name = 'Kasol Kheerganga trek' ;";
          ...
          <div class="card-body" id="pack_detail_card">
            ...
            <ul>
              <li class="flex-container mb-2">
                <div style="border-right: 2px solid #dadada;"><i class="fa fa-calendar-alt" style="color: #ff6219"></i> 2 Days</div>
                <div style="border-right: 2px solid #dadada;"><i class="fa fa-mountain" style="color: #ff6219"></i> 13,051 ft.</div>
                <div><i class="fa fa-route" style="color: #ff6219"></i> 20 Km</div>
              </li>
              <hr>

              <li class="flex-container mb-2">
                <div style="border-right: 2px solid #dadada;"><b>Start</b> : Basyani</div>
                <div style="border-right: 2px solid #dadada;"><b>End</b> : Basyani</div>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="card ellipsis mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <?php
            $sql = "SELECT * FROM Treking_date where Trek_name = 'Kasol Kheerganga trek' ";
            $result = $conn->query($sql);
            while ($row = $result->fetch_assoc())
              for ($i = 1; $i < 367; $i++) {
                $date[$i] = $row['Date_' . $i];
            ...
            $sql1 = "SELECT * FROM Treking_date_Status where Trek_name = 'Kasol Kheerganga trek' ";
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <ul class="timeline">
          <li>
            <a href="#">Day 1</a>
            <p>Reach Basyani Village and Trek to Kheerganga.</p>
          </li>
          <li>
            <a href="#">Day 2</a>
            <p>Kheerganga to Basyani Village Trek and Departure.</p>
          </li>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4 col-lg-3">
          <?php
          $sql = "select * FROM Trek_add_ons_detail  where Trek_name = 'Nag Tibba Trek' ;";
          $result = $conn->query($sql);
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/landing/nag-tibba-trek-offer.php">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>POPULAR</span></div>
              <img class="card-img-top" src="../<?php echo $row['card_image']; ?>" alt="Nag Tibba Trek">
              <div class="p-2">
