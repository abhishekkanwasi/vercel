...
<body>
  <style>
    .from_conatinaer {
      ...
      background-image: url("http://trekveda.com/images/slides/borasu-pass-trek-offer-banner.webp");
      /* The image used */
  ...
  <section class="jumbotron text-center from_conatinaer py-4" id="main-form">
    ...
    <div class="container">
      <h1 class="jumbotron-heading">Borasu Pass Trek</h1>
      ...
      <div class="form-container text-center d-flex justify-content-center">
        ...
        <form method="post" action="form-submission.php" class="landing_page_submit_form col-md-8 p-0 m-0">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="trek_name" value="Borasu Pass Trek" />
            <input type="hidden" name="Package_link" value="https://trekveda.com/trek/borasu-pass-trek.php" />
          </div>
        ...
        <div class="card">
          <div class="card-body" id="pack_detail_card">
            ...
            <ul>
              ...
              <li class="flex-container mb-2">
                <div style="border-right: 2px solid #dadada;"><b>Start</b> : Gulaba</div>
                <div style="border-right: 2px solid #dadada;"><b>End</b> : Gulaba</div>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="card ellipsis mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <?php
            $sql = "SELECT * FROM Treking_date where Trek_name = 'Borasu Pass Trek' ";
            $result = $conn->query($sql);
            while ($row = $result->fetch_assoc())
              for ($i = 1; $i < 367; $i++) {
                $date[$i] = $row['Date_' . $i];
            ...
            $sql1 = "SELECT * FROM Treking_date_Status where Trek_name = 'Borasu Pass Trek' ";
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <ul class="timeline">
          ...
          <li>
            <a href="#">Day 2</a>
            <p>Sankri (1,920 m) to Seema/Osla (2,200 m) - 1 h drive + 5-6 h trek.</p>
          </li>
          <li>
            <a href="#">Day 3</a>
            <p>Seema/Osla to Har ki Dun (3,510 m) - 4-5 hr.</p>
          </li>
          <li>
            <a href="#">Day 4</a>
            <p>Har ki Dun to RathaTho (4,200 m)- 4-5 hr.</p>
          </li>
          <li>
            <a href="#">Day 5</a>
            <p>RathaTho to Borasu pass base camp (Upper Lamjung) (4,900 m) - 3-4 hr.</p>
          </li>
          <li>
            <a href="#">Day 6</a>
            <p>Borasu pass base camp (Upper Lamjung) to Bonga (4,000 m) via Borasu pass (5,360 m) - 7-8 hr.</p>
          </li>
          <li>
            <a href="#">Day 7</a>
            <p>Bonga to Chitkul (3,430 m)- 7-8 hr.</p>
          </li>
          <li>
            <a href="#">Day 8</a>
            <p>Departure from Chitkul.</p>
          </li>
        </ul>
      </div>
    </div>
