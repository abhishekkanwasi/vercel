...
<head>
  ...
  <title>2023 Kedarnath with Tungnath from Delhi - Trekveda</title>
  <!-- Favicons-->
  <!-- Favicons-->
...
<body>
  <style>
    .from_conatinaer {
      ...
      background-image: url("http://trekveda.com/images/slides/kedarnath-tungnath.jpg");
      /* The image used */
  ...
  <section class="jumbotron text-center from_conatinaer py-4" id="main-form">
    ...
    <div class="container">
      <h1 class="jumbotron-heading">Kedarnath with Tungnath from Delhi</h1>
      ...
      <div class="form-container text-center d-flex justify-content-center">
        ...
        <form method="post" action="form-submission.php" class="landing_page_submit_form col-md-8 p-0 m-0">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="trek_name" value="Kedarnath with Tungnath from Delhi" />
            <input type="hidden" name="Package_link" value="https://trekveda.com/tour/tour-packages/kedarnath-tungnath-from-delhi" />
          </div>
        ...
        <div class="card">
          <div class="card-body" id="pack_detail_card">
            <div class="row">
              ...
              <h4 class="price-field text-left col-9"><small style="color:gray"><s> &#8377; 18533</s></small> &#8377; <b><span id="mainprice" style="color:#f7472e;" onchange="onpricechange()">13900</span></b><small id="gst_text"> +5% GST</small></h4>
                ...
                <p class="h4 card-title text-center package-heading-side">Short Itinerary</p>
                    <ul class="timeline">
                        ...
                        <li>
                         ...
                         <li>
                            <p>Day 4: Kedarnath - Gaurikund - Chopta.</p>
                        </li>
                         <li>
                            <p>Day 5: Chopta to Tungnath and Drive to Sari.</p>
                        </li>
                         <li>
                            <p>Day 6: Sari to Deoriatal, back to Sari and Drive to Rishikesh.</p>
                        </li>
                         <li>
