...
<head>
  ...
  <title>Sandakphu Trek 2022 - Early Bird Sale Upto 50% OFF - Trekveda</title>
  <!-- Favicons-->
  <!-- Favicons-->
...
<body>
  <style>
    .from_conatinaer {
      ...
      background-image: url("http://trekveda.com/images/slides/sandakphu-phalut-trek-offer-banner.webp");
      /* The image used */
   ...
   <section class="jumbotron text-center from_conatinaer py-4" id="main-form">
    ...
    <div class="container">
      <h1 class="jumbotron-heading">Sandakphu Trek</h1>
      ...
      <div class="form-container text-center d-flex justify-content-center">
        ...
        <form method="post" action="form-submission.php" class="landing_page_submit_form col-md-8 p-0 m-0">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="trek_name" value="Sandakphu Phalut Trek" />
            <input type="hidden" name="Package_link" value="https://trekveda.com/trek/sandakphu-phalut-trek.php" />
          </div>
  ...
  <div class="container my-4">
    <div class="row">
          ...
          <div class="card-body" id="pack_detail_card">
            ...
            <ul>
              <li class="flex-container mb-2">
                <div style="border-right: 2px solid #dadada;"><i class="fa fa-calendar-alt" style="color: #ff6219"></i> 6 Days</div>
                <div style="border-right: 2px solid #dadada;"><i class="fa fa-mountain" style="color: #ff6219"></i> 11,929 ft.</div>
                <div><i class="fa fa-route" style="color: #ff6219"></i> 46 Km</div>
              </li>
              <hr>

              <li class="flex-container mb-2">
                <div style="border-right: 2px solid #dadada;"><b>Start</b> : Jaubari</div>
                <div style="border-right: 2px solid #dadada;"><b>End</b> : Srikhola</div>

              </li>
              <hr>
              <li class="flex-container mb-2">
                <div style="border-right: 2px solid #dadada;"><i class="fa fa-level-up-alt" style="color: #ff6219"></i> Moderate</div>
                <div><i class="fa fa-map-marker-alt" style="color: #ff6219"> </i> West Bengal</div>
              </li>
            </ul>
            <hr>
          ...
          <div class="card-body">
            ...
            <ul class="fa-ul">
              <li><span class="fa-li"></span><strong>Inclusion in cost during the trek:</strong></li>
                <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span> Accommodation during the trek on trekking (tea lodges) on triple / quad sharing basis.</li>
                <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span>Meals as per the itinerary (Indian vegetarian Meals), starting with Dinner and Ending with Breakfast. </li>
                <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span>Local trekking guide for the trek.</li>
                <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span> All Permits and trekking permission. </li>
                <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span>Experience Trek Leader/Team.</li>

                <li><span class="fa-li"></span><strong>Exclusion in cost during the trek:</strong></li>
                <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span>Any health or travel insurance of the clients, all the clients are requested to carry their own personal insurances.</li>
                <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span>Any Lunch, Dinner, Snacks, Mineral Water etc. unless mentioned in the Cost Included Section.</li>
                <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span>Any Tips, Gratuities, Portage, Laundry, Telephone Calls, Table Drinks or any other expenses of personal nature.</li>
              </ul>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12">
        ...
        <ul class="timeline">
          <li>
            <p>Day 1: Arrive Jaubari.</p>
          </li>
          <li>
            <p>Day 2: Jaubhari to Tumling.</p>
          </li>
          <li>
            <p>Day 3: Tumling to Kalipokhri.</p>
          </li>
          <li>
            <p>Day 4: Kalipokhri to Sandakphu.</p>
          </li>
          <li>
            <p>Day 5: Sandakphu to Srikhola.</p>
          </li>
          <li>
            <p>Day 6: Departure from Srikhola.</p>
          </div>
        </div>
      </div>
...
<hr/>
  ...
  <div class="album py-5 bg-light">
      <div class="col-md-12 text-center section-title">
        <h2>Popular Trek Packages - Summer and Monsoon Season 2022</h2>
      </div>
