...
<head>
  ...
  <title>Uttarakhand Tour Packages 2022 - Early Bird Offer Upto 50% OFF - Trekveda</title>
  <!-- Favicons-->
  <!-- Favicons-->
...
<body>
  <style>
    .from_conatinaer {
      ...
      background-image: url("http://trekveda.com/images/slides/uttarakhand-banner.png");
      /* The image used */
  ...
  <section class="jumbotron text-center from_conatinaer py-4" id="main-form">
    ...
    <div class="container">
      <h1 class="jumbotron-heading">52+ Uttarakhand Tour Package Tour Packages 2022</h1>
      <p class="lead">Early Bird Sale Uto 50% OFF - Limited Period Offer</p>
      <p class="lead">Starting from <b>INR 1,380/-</b></p>
      <div class="form-container text-center d-flex justify-content-center">
        ...
        <form method="post" action="form-submission.php" class="landing_page_submit_form col-md-8 p-0 m-0">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="trek_name" value="Uttarakhand Tour Package" />
            <input type="hidden" name="Package_link" value="https://trekveda.com/uttarakhand.php" />
          </div>
  ...
  <div class="album py-5 bg-light">
      ...
      <h2>Uttarakhand Tour Packages 2022 - Best time to visit Jan to Dec</h2>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-4 col-lg-3">
          ...
          ?>
          <a href="https://trekveda.com/tour/tour-packages/auli-tour-from-rishikesh" target="_Blank">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>Round Trip</span></div>
              <img class="card-img-top" src="../<?php echo $row['card_image']; ?>" alt="Getaway to Auli - The Snow Paradise 2N">
              <div class="p-2">
        ...
        <div class="col-md-4 col-lg-3">
          <?php
          $sql = "select * FROM Tour_package_pages where Title = 'Round Trip - Auli with Mussoorie and Tehri 4 Nights' ;";
          $result = $conn->query($sql);
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/tour/tour-packages/auli-mussoorie-tehri-tour-package" target="_Blank">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>Round Trip</span></div>
              <img class="card-img-top" src="https://trekveda.com/img/Tour-card-images/auli-mussoorie-tehri-tour-package.jpg" alt="Round Trip - Auli with Mussoorie and Tehri 4 Nights">
              <div class="p-2">
                <span class="tour-price"><s><small>&#8377; <?php echo $row['price_without_discount']; ?> </small></s><b> &#8377; <?php echo $row['price_with_discount']; ?></b> </span>
                <span class="badge badge-pill float-right right-gary"><?php echo $row['days']; ?>D/<?php echo $row['days'] - 1; ?>N</span>
                <h5><?php echo $row['Title']; ?></h5>
        ...
        <div class="col-md-4 col-lg-3">
          <?php
          $sql = "select * FROM Tour_package_pages where Title = 'Auli with Rishikesh Tour Package' ;";
          $result = $conn->query($sql);
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/tour/tour-packages/auli-rishikesh-package" target="_Blank">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>Round Trip</span></div>
              <img class="card-img-top" src="../<?php echo $row['card_image']; ?>" alt="Auli with Rishikesh Tour Package">
              <div class="p-2">
                <span class="tour-price"><s><small>&#8377; <?php echo $row['price_without_discount']; ?> </small></s><b> &#8377; <?php echo $row['price_with_discount']; ?></b> </span>
                <span class="badge badge-pill float-right right-gary"><?php echo $row['days']; ?>D/<?php echo $row['days'] - 1; ?>N</span>
                <h5><?php echo $row['Title']; ?></h5>
        ...
        <div class="col-md-4 col-lg-3">
          ...
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/tour/tour-packages/auli-chopta-tour-uttarakhand" target="_Blank">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>Bike Trip</span></div>
              <img class="card-img-top" src="../<?php echo $row['card_image']; ?>" alt="Short Break - Auli with Chopta 3N">
              <div class="p-2">
                <span class="tour-price"><s><small>&#8377; <?php echo $row['price_without_discount']; ?> </small></s><b> &#8377; <?php echo $row['price_with_discount']; ?></b> </span>
                <span class="badge badge-pill float-right right-gary"><?php echo $row['days']; ?>D/<?php echo $row['days'] - 1; ?>N</span>
                <h5><?php echo $row['Title']; ?></h5>
        ...
        <div class="col-md-4 col-lg-3">
          ...
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/tour/tour-packages/auli-skiing-tour" target="_Blank">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>Bike Trip</span></div>
              <img class="card-img-top" src="../<?php echo $row['card_image']; ?>" alt="Auli Snow Skiing Tour">
              <div class="p-2">
                <span class="tour-price"><s><small>&#8377; <?php echo $row['price_without_discount']; ?> </small></s><b> &#8377; <?php echo $row['price_with_discount']; ?></b> </span>
                <span class="badge badge-pill float-right right-gary"><?php echo $row['days']; ?>D/<?php echo $row['days'] - 1; ?>N</span>
                <h5><?php echo $row['Title']; ?></h5>
        ...
        <div class="col-md-4 col-lg-3">
          ...
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/tour/tour-packages/auli-niti-valley-tour" target="_Blank">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>Round Trip</span></div>
              <img class="card-img-top" src="../<?php echo $row['card_image']; ?>" alt="Auli with Niti Valley - Spiti of Uttarakhand">
              <div class="p-2">
                <span class="tour-price"><s><small>&#8377; <?php echo $row['price_without_discount']; ?> </small></s><b> &#8377; <?php echo $row['price_with_discount']; ?></b> </span>
                <span class="badge badge-pill float-right right-gary"><?php echo $row['days']; ?>D/<?php echo $row['days'] - 1; ?>N</span>
                <h5><?php echo $row['Title']; ?></h5>
        ...
        <div class="col-md-4 col-lg-3">
          <?php
          $sql = "select * FROM Tour_package_pages where Title = 'Auli with Rishikesh and Chopta - Beauty of Uttarakhand' ;";
          $result = $conn->query($sql);
          $row = $result->fetch_assoc();
          ?>
          <a href="https://trekveda.com/tour/tour-packages/auli-rishikesh-chopta-package" target="_Blank">
            <div class="box">
              <div class="ribbon ribbon-top-left"><span>Round Trip</span></div>
              <img class="card-img-top" src="../<?php echo $row['card_image']; ?>" alt="Auli with Rishikesh and Chopta - Beauty of Uttarakhand">
              <div class="p-2">
                <span class="tour-price"><s><small>&#8377; <?php echo $row['price_without_discount']; ?> </small></s><b> &#8377; <?php echo $row['price_with_discount']; ?></b> </span>
                <span class="badge badge-pill float-right right-gary"><?php echo $row['days']; ?>D/<?php echo $row['days'] - 1; ?>N</span>
                <h5><?php echo $row['Title']; ?></h5>
