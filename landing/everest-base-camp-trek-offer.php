...
<body>
  <style>
    .from_conatinaer {
      ...
      background-image: url("http://trekveda.com/images/slides/everest-base-camp-trek-offer-banner.webp");
      /* The image used */
 ...
 <section class="jumbotron text-center from_conatinaer py-4" id="main-form">
    ...
    <div class="container">
      <h1 class="jumbotron-heading">Everest Base Camp Trek</h1>
      ...
      <div class="form-container text-center d-flex justify-content-center">
        ...
        <form method="post" action="form-submission.php" class="landing_page_submit_form col-md-8 p-0 m-0">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="trek_name" value="Everest Base Camp Trek" />
            <input type="hidden" name="Package_link" value="https://trekveda.com/tour/trekking/everest-base-camp-trek" />
          </div>
          ...
          <div class="card-body" id="pack_detail_card">
            ...
            <ul>
              <li class="flex-container mb-2">
                <div style="border-right: 2px solid #dadada;"><i class="fa fa-calendar-alt" style="color: #ff6219"></i> 14 Days</div>
                <div style="border-right: 2px solid #dadada;"><i class="fa fa-mountain" style="color: #ff6219"></i>  18,192 ft.</div>
                <div><i class="fa fa-route" style="color: #ff6219"></i> 130 Km</div>
              </li>
              <hr>

              <li class="flex-container mb-2">
                <div style="border-right: 2px solid #dadada;"><b>Start</b> : Kathmandu</div>
                <div style="border-right: 2px solid #dadada;"><b>End</b> : Kathmandu</div>

              </li>
              <hr>
              <li class="flex-container mb-2">
                <div style="border-right: 2px solid #dadada;"><i class="fa fa-level-up-alt" style="color: #ff6219"></i> Difficult</div>
                <div><i class="fa fa-map-marker-alt" style="color: #ff6219"> </i> Nepal</div>
              </li>
            </ul>
            <hr>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="card ellipsis mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <?php
            $sql = "SELECT * FROM Treking_date where Trek_name = 'Everest Base Camp Trek' ";
            $result = $conn->query($sql);
            while ($row = $result->fetch_assoc())
              for ($i = 1; $i < 367; $i++) {
                $date[$i] = $row['Date_' . $i];
            ...
            $sql1 = "SELECT * FROM Treking_date_Status where Trek_name = 'Everest Base Camp Trek' ";
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <ul class="timeline">
          <li>
            <a href="#">Day 1</a>
            <p>Arrival at Kathmandu.</p>
          </li>
          <li>
            <a href="#">Day 2</a>
            <p>Kathmandu- Lukla- Phakding (2652 m).</p>
          </li>
          <li>
            <a href="#">Day 3</a>
            <p>Phakding - Namche Bazaar (3440 m).</p>
          </li>
          <li>
            <a href="#">Day 4</a>
            <p>Acclimating to Namche (Short Hiking).</p>
          </li>
          <li>
            <a href="#">Day 5</a>
            <p>Namche - Tengboche (3860 m).</p>
          </li>
          <li>
            <a href="#">Day 6</a>
            <p>Tengboche - Dingboche (4360 m).</p>
          </li>
          <li>
            <a href="#">Day 7</a>
            <p>Acclimatization at Dingboche.</p>
          </li>
          <li>
            <a href="#">Day 8</a>
            <p>Dingboche - Lobuche (4940 m).</p>
          </li>
          <li>
            <a href="#">Day 9</a>
            <p>Lobuche - Gorakshep (5170 m) - Everest base camp (5364 m).</p>
          </li>
          <li>
            <a href="#">Day 10</a>
            <p>Hiking to Kala Patthar (5645 m).</p>
          </li>
          <li>
            <a href="#">Day 11</a>
            <p>Pheriche - Namche.</p>
