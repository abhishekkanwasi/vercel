...
<body>
  <style>
    .from_conatinaer {
      ...
      background-image: url("http://trekveda.com/images/slides/triund-trek-offer-banner.webp");
      /* The image used */
   ...
   <section class="jumbotron text-center from_conatinaer py-4" id="main-form">
    ...
    <div class="container">
      <h1 class="jumbotron-heading">Triund Trek</h1>
      ...
      <div class="form-container text-center d-flex justify-content-center">
        ...
        <form method="post" action="form-submission.php" class="landing_page_submit_form col-md-8 p-0 m-0">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="trek_name" value="Triund Trek" />
            <input type="hidden" name="Package_link" value="https://trekveda.com/tour/trekking/triund-trek" />
          </div>
  ...
  <div class="container my-4">
    <div class="row">
      ...
      if (mysqli_connect_error()) {
        ...
        $sql = "select * FROM Tour_package_pages where Title = 'Triund Trek' ;";
          ...
          <div class="card-body" id="pack_detail_card">
            ...
            <ul>
              <li class="flex-container mb-2">
                ...
                <div style="border-right: 2px solid #dadada;"><i class="fa fa-mountain" style="color: #ff6219"></i> 9,350 ft.</div>
                <div><i class="fa fa-route" style="color: #ff6219"></i> 47 Km</div>
              </li>
              <hr>

              <li class="flex-container mb-2">
                <div style="border-right: 2px solid #dadada;"><b>Start</b> : Dharamshala</div>
                <div style="border-right: 2px solid #dadada;"><b>End</b> : Dharamshala</div>
        ...
        <div class="card ellipsis mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <ul class="fa-ul">
              ...
              <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span> All the trekking arrangements and equipment as per below:-</li>
              <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span>Sleeping Dome / Alpine tents during trek on triple sharing basis.</li>
              <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span>Dinning and Kitchen Tents.</li>
              <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span>sleeping mattress.</li>
               <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span>Sleeping Bags with liners.</li>
                <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span>Meals as mentioned in the itinerary (All meal serving during the trek will be vegetarian).</li>
                 <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span>All trekking fees and Permits.</li>
                  <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span>Experienced trekking Guide.</li>
                  <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span>Experienced mountain cook and Helpers.</li>
                  <li><span class="fa-li"><i class="fas fa-check" style="color: green;"></i></span>Potters for carrying the trekking equipment.</li>
              <li>&nbsp;</li>
              ...
              <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span> Any kind of Travel / Health Insurance (Trekveda strictly recommend each traveller to please carry your own travel / health insurance).</li>
                <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span> Any Meals / Accommodation in Dharamshala ( It can be very much arranged by Trekveda at additional cost).</li>
            <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span> Any kind of medical expenses.</li>
            <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span> Any transportation used during the trek (It can be very much arranged by Trekveda at additional cost).</li>
            <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span> Any monuments / monasteries entrance fee in Himachal Pradesh.</li>
                <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span> Any tips, laundry, Phone call, liquors, mineral water, camera fee or any other personal nature expenses.</li>
                    <li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red;"></i></span> Any pickup and drop transportation services.</li>
...
<div class="col-lg-4 col-md-6 col-sm-12">
        <div class="card ellipsis mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <ul class="timeline">
          <li>
            <p>Day 1: Dharamshala (McLeodganj) - Guna Devi (2310 Mtrs) by trek 08 Kms approx. 3-4 Hrs.</p>
          </li>
          <li>
            <p>Day 2: Guna Devi - Jari Gote via Kanjrala (3000 Mtrs) by trek 12 Kms approx 4-5 Hrs.</p>
          </li>
          <li>
            <p>Day 3: Jari Gote - Illaqa Gote (3150 Mtrs) by trek 08 Kms approx 4 Hrs.</p>
          </li>
           <li>
            <p>Day 4: Illaqa Gote - Triund (2975M) 10 Km.</p>
          </li>
           <li>
            <p>Day 5: Triund – McLeodganj (Dharamshala) by Trek approx 9 Kms approx 4-5 Hrs.</p>
          </li>
...
<style>
   ...
   <br/>
        ...
        <h4 style="font-weight: 600">Available Fix Departure Dates 2022 - 100% Guaranteed</h4>
        <p style="color:black"><b> Jun:</b> 04 (Full), 05, 11, 12 (Few Seats Left), 18, 19, 25, 26 (Few Seats Left)</p>
    ...
    <div class="album py-5 bg-light">
      <div class="col-md-12 text-center section-title">
      <h2>Popular Trek Packages - Mar to Dec 2022</h2>
