...
<head>
  ...
  <title>Buran Ghati Trek 2023 - Early Bird Sale Upto 50% OFF - Trekveda</title>
  <!-- Favicons-->
  <!-- Favicons-->
...
<body>
  <style>
    .from_conatinaer {
      ...
      background-image: url("http://trekveda.com/images/slides/buran-ghati-trek-offer-banner.webp");
      /* The image used */
  ...
  <section class="jumbotron text-center from_conatinaer py-4" id="main-form">
    <div class="container-fluid">
      <div class="row">
        <h1 class="col-6 h4 text-left">
          <a class="" href="https://trekveda.com/"><img height="45px" src="https://trekveda.com/img/trekveda-logo-update-white-version.png" id="main_logo"> </a>
        </h1>
    ...
    <div class="container">
      <h1 class="jumbotron-heading">Buran Ghati Trek</h1>
      ...
      <div class="form-container text-center d-flex justify-content-center">
        ...
        <form method="post" action="form-submission.php" class="landing_page_submit_form col-md-8 p-0 m-0">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="trek_name" value="Buran Ghati Trek" />
            <input type="hidden" name="Package_link" value="https://trekveda.com/trek/buran-ghati-trek.php" />
          </div>
  ...
  <div class="container my-4">
    <div class="row">
          ...
          <div class="card-body" id="pack_detail_card">
            ...
            <ul>
              <li class="flex-container mb-2">
                ...
                <div style="border-right: 2px solid #dadada;"><i class="fa fa-mountain" style="color: #ff6219"></i>  15,000 ft.</div>
                <div><i class="fa fa-route" style="color: #ff6219"></i> 26 Km</div>
              </li>
              <hr>

              <li class="flex-container mb-2">
                <div style="border-right: 2px solid #dadada;"><b>Start</b> : Janglik</div>
                <div style="border-right: 2px solid #dadada;"><b>End</b> : Barua village</div>

              </li>
              <hr>
              <li class="flex-container mb-2">
                <div style="border-right: 2px solid #dadada;"><i class="fa fa-level-up-alt" style="color: #ff6219"></i> Moderate to Difficult</div>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12">
        ...
        <ul class="timeline">
          <li>
            <p>Day 1: Reach Janglik.</p>
          </li>
          <li>
            <p>Day 2: Janglik to Dayara Thatch.</p>
          </li>
          <li>
            <p>Day 3: Dayara Thatch to Litham.</p>
          </li>
           <li>
            <p>Day 4: Acclimatization day, visit to Chandranahan Lake.</p>
          </li>
           <li>
            <p>Day 5: Litham to Dhunda.</p>
          </li>
           <li>
            <p>Day 6: Dhunda to Munirang via Buran Ghati.</p>
          </li>
          <li>
            <p>Day 7: Barua village and Departure from Barua village.</p>
          </li>
        </ul>
        <div class="see_more_btn">
                <a>Read more </a>
  ...
  <br/>
   ...
   <br/>
        ...
        <p style="color:black"><b>May:</b> 14, 15, 22, 27.</p>
          <p style="color:black"><b>Jun:</b> 6.</p>
