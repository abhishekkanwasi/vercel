...
<head>
  ...
  <title>Pangarchulla Trek 2023 - Special Offer Flat 38% OFF - Trekveda</title>
  <!-- Favicons-->
  <!-- Favicons-->
...
<body>
  <style>
    .from_conatinaer {
      ...
      background-image: url("http://trekveda.com/images/slides/pangarchulla-trek-offer-banner.webp");
      /* The image used */
  ...
  <section class="jumbotron text-center from_conatinaer py-4" id="main-form">
    ...
    <div class="container">
      <h1 class="jumbotron-heading">Pangarchulla Trek</h1>
      <p class="lead">Get Special Offer Flat 38% OFF</p>
      <div class="form-container text-center d-flex justify-content-center">
        ...
        <form method="post" action="form-submission.php" class="landing_page_submit_form col-md-8 p-0 m-0">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="trek_name" value="Pangarchula Trek" />
            <input type="hidden" name="Package_link" value="https://trekveda.com/trek/pangarchulla-trek.php" />
          </div>
          ...
          <div class="card-body" id="pack_detail_card">
            ...
            <ul>
              <li class="flex-container mb-2">
                ...
                <div style="border-right: 2px solid #dadada;"><i class="fa fa-mountain" style="color: #ff6219"></i> 15,069 ft.</div>
                <div><i class="fa fa-route" style="color: #ff6219"></i> 36 Km</div>
              </li>
              <hr>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="card ellipsis mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <ul class="timeline">
            <li>
            <p>Day 1: Arrive In Joshimath.</p>
          </li>
          <li>
            <p>Day 2: Joshimath - Dhak by surface - Khullara by Trek.</p>
          </li>
          <li>
              <p>Day 3: Khullara - Pangarchulla – Tali.</p>
          </li>
          <li>
             <p>Day 4: Tali - Auli by Trek- Joshimath.</p>
          </li>
          <li>
