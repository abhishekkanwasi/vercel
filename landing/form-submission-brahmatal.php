<?php
    ...
    $email_to = "atuljaideep@gmail.com,amit@trekveda.com";
    $email_subject = "Form Submission PPC Brahmatal";
...
<!-- Favicons-->
    ...
    <link rel="apple-touch-icon" type="image/x-icon" sizes="72x72" href="../../../i../../../mg/apple-touch-icon-72x72-precomposed.png"/>
...
<div class="container">
	<div class="row text-center">
        ...
        <a href="https://trekveda.com/trek/brahmatal-trek.php" class="btn btn-success">     Read More      </a>
    <br><br>
        </div>
