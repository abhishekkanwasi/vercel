...
<head>
  ...
  <title>Rupin Pass Trek 2022 - Early Bird Sale Upto 50% OFF - Trekveda</title>
  <!-- Favicons-->
  <!-- Favicons-->
...
<body>
  <style>
    .from_conatinaer {
      ...
      background-image: url("http://trekveda.com/images/slides/rupin-pass-trek-offer-banner.webp");
      /* The image used */
  ...
  <section class="jumbotron text-center from_conatinaer py-4" id="main-form">
    ...
    <div class="container">
      <h1 class="jumbotron-heading">Rupin Pass Trek</h1>
      ...
      <div class="form-container text-center d-flex justify-content-center">
        ...
        <form method="post" action="form-submission.php" class="landing_page_submit_form col-md-8 p-0 m-0">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="trek_name" value="Rupin Pass Trek" />
            <input type="hidden" name="Package_link" value="https://trekveda.com/trek/rupin-pass-trek.php" />
          </div>
  ...
  <div class="container my-4">
    <div class="row">
          ...
          <div class="card-body" id="pack_detail_card">
            ...
            <ul>
              <li class="flex-container mb-2">
                ...
                <div style="border-right: 2px solid #dadada;"><i class="fa fa-mountain" style="color: #ff6219"></i>  15,250 ft.</div>
                <div><i class="fa fa-route" style="color: #ff6219"></i> 52 Km</div>
              </li>
              <hr>

              <li class="flex-container mb-2">
                <div style="border-right: 2px solid #dadada;"><b>Start</b> : Dhaula</div>
                <div style="border-right: 2px solid #dadada;"><b>End</b> : Sangla</div>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12">
        ...
        <ul class="timeline">
           <li>
            <p>Day 1: Reach Dhaula.</p>
          </li>
          <li>
            <p>Day 2: Dhaula to Sewa.</p>
          </li>
          <li>
            <p>Day 3: Sewa to Bawta.</p>
          </li>
          <li>
            <p>Day 4: Bawta to Jakha.</p>
          </li>
          <li>
            <p>Day 5: Jakha to Dhanderas Thatch.</p>
          </li>
          <li>
            <p>Day 6: Dhanderas Thatch Camp to Upper Waterfall camp.</p>
          </li>
          <li>
            <p>Day 7: Upper Waterfall Camp to Rupin Pass; Rupin Pass to Ronti Gad Camp.</p>
          </li>
          <li>
            <p>Day 8: Ronti Gad to Sangla.</p>
          </li>
        </ul>
          <div class="see_more_btn">
                <a>Read more </a>
