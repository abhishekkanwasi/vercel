  ...
  <div class="container">
    ...
    <style>
      ...
      .top-treks {
        ...
        font-weight: bold;
        color: white;
        background: linear-gradient(45deg, #ff4e00, #ff9e00);
...
<h1 class="top-treks">Himachal Tour Packages</h1>

<div class="offer slider">
    <div>
        <a><img data-lazy="img/packageImage/himachal-banner.jpg" data-sizes="100vw" alt="Himachal Tour"></a>
    </div>
        ...
        <p>Himachal Pradesh, nestled in the Himalayas, offers a blend of scenic beauty, adventure, and cultural experiences. Several reputable travel companies provide a variety of tour packages to explore this enchanting state.</p>
    ...
    <section id="section-all" class="filter-section active">
      ...
      <!--<h2>Recommended Yatras Himachal</h2>-->
      <!-- Wrap the grid in a slider container -->
      <!--<div class="card-slider">-->
      <!--  <div class="card-grid">-->
          <!-- Example Card -->
      ...
      <!--        </div>-->
      <!--        <div class="ribbon-review"><i style="color: #ffd604;margin-left: 8px" class="fa fa-star mr-2"></i>4.8 <small>(126 Reviews)</small> </div>-->
      <!--        <img class="card-img-top" width="355" height="220" src="img/test/kedarkantha.jpg" data-lazy="img/test/kedarkantha.jpg" alt="Chopta Trek">-->
      <!--        <div class="p-2">-->
      <!--          <div class="price-details">-->
      <!--            <div style="padding-top: 5px;">-->
      <!--              <h5 class="card-trek-name" style="text-align: center; font-size: 1.2em; font-weight: bold;">-->
      ...
      <!--<h2>Recommended Expeditions Himachal</h2>-->
      <!-- Wrap the grid in a slider container -->
      <!--<div class="card-slider">-->
      <!--  <div class="card-grid">-->
          <!-- Example Card -->
    ...
    <section id="section-treks" class="filter-section active ">
      ...
      <h2>Best Selling Treks Himachal</h2>
      <!-- Wrap the grid in a slider container -->
      <div class="card-slider">
        <div class="card-grid">
          <!-- Example Card -->
       ...
       <h2>Best Monsoon Treks Himachal</h2>
      <!-- Wrap the grid in a slider container -->
      <div class="card-slider">
        <div class="card-grid">
          <!-- Example Card -->
    ...
    <!--  <h2>Best Selling Yatras Himachal</h2>-->
      <!-- Wrap the grid in a slider container -->
    <!--  <div class="card-slider">-->
    <!--    <div class="card-grid">-->
          <!-- Example Card -->
    ...
    <!--  <h2>Best Selling Expeditions Himachal</h2>-->
      <!-- Wrap the grid in a slider container -->
    <!--  <div class="card-slider">-->
    <!--    <div class="card-grid">-->
          <!-- Example Card -->
