...
<head>
  ...
  <title>Yatra Packages in India - Himalaya Yatri</title>
...
$(document).ready(function(){
    ...
    <h1 class="top-treks">Englighten Your Spiritual Journey</h1>


<div class="offer slider">
    <div>
        <a><img data-lazy="img/packageImage/yamunotri-banner.jpg" data-sizes="100vw" alt="yamunotri"></a>
    </div>
    <div>
        <a><img data-lazy="img/packageImage/gangotri-banner.jpg" data-sizes="100vw" alt="gangotri"></a>
    </div>
    <div>
        <a><img data-lazy="img/packageImage/kedarnath-banner.jpg" data-sizes="100vw" alt="kedarnath"></a>
    </div>
    <div>
        <a><img data-lazy="img/packageImage/badrinath-banner.jpg" data-sizes="100vw" alt="badrinath"></a>
    </div>
</div>
    ...
    <section id="section-uttarakhand" class="filter-section active ">
      <h2>Recommended Yatra Uttarakhand</h2>
      <!-- Wrap the grid in a slider container -->
            <div class="card-slider">
        <div class="card-grid">
          <!-- Example Card -->
      ...
      <h2>Best Selling Uttarakhand</h2>
      <!-- Wrap the grid in a slider container -->
            <div class="card-slider">
        <div class="card-grid">
          <!-- Example Card -->
    ...
    <!--  <h2>Recommended Yatra Himachal</h2>-->
      <!-- Wrap the grid in a slider container -->
    <!--  <div class="card-slider">-->
    <!--    <div class="card-grid">-->
          <!-- Example Card -->
    ...
    <!--  <h2>Recommended Yatra Kashmir</h2>-->
      <!-- Wrap the grid in a slider container -->
    <!--  <div class="card-slider">-->
    <!--    <div class="card-grid">-->
          <!-- Example Card -->
