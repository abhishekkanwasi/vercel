...
if(isset($_POST['email'])) {
    ...
    $email_subject = "Form Submission Pangarchulla Package Page";
    ...
    $email_from = "pankaj@trekveda.com";
    $telephone = $_POST['telephone']; // required
    $comments = "Pangarchulla";
...
<div class="container">
	<div class="row text-center">
        ...
        <a href="javascript: history.go(-1)" class="btn btn-success">     Read More      </a>
    <br><br>
        </div>
