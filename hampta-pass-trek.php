...
$Title = "Hampta Pass Trek"; // Replace with the actual title of the trek
$canonical_link = "https://himalayayatri.com/hampta-pass-trek.php"; // Replace with the actual canonical link for the trek
?>
...
<head>
  ...
  <title>Hampta Pass Trek | The Trekker</title>
  <meta name="description" content="Hampta Pass Trek is one of the most captivating high-altitude treks in the Himalayas, offering a unique blend of landscapes, adventure, and breathtaking scenery. Situated in Himachal Pradesh, this trek is ideal for beginners and seasoned trekkers.">
  <meta name="author" content="Fusejack">
  <meta name="keywords" content="Hampta Pass Trek, Hampta Pass, Hampta Pass Trek package, Hampta Pass Trek best time" />
...
<body>
  ...
  <div class="gallery-container">
    ...
    <div class="gallery-main">
      <a href="img/packageImage/hampta-pass-trek.jpg" data-lightbox="trek-gallery">
        <img src="img/packageImage/hampta-pass-trek.jpg" alt="Hampta Pass Trek">
      </a>
    </div>

    <!-- Side Images -->
    <div class="gallery-side">
      <a href="img/packageImage/hampta-pass-trek-1.jpg" data-lightbox="trek-gallery">
        <img src="img/packageImage/hampta-pass-trek-1.jpg" alt="Hampta Pass Trek">
      </a>
      <a href="img/packageImage/hampta-pass-trek-2.jpg" data-lightbox="trek-gallery">
        <img src="img/packageImage/hampta-pass-trek-2.jpg" alt="Hampta Pass Trek">
      </a>
      <a href="img/packageImage/hampta-pass-trek-3.jpg" data-lightbox="trek-gallery">
        <img src="img/packageImage/hampta-pass-trek-3.jpg" alt="Hampta Pass Trek">
      </a>
      <a href="img/packageImage/hampta-pass-trek-4.jpg" data-lightbox="trek-gallery">
        <img src="img/packageImage/hampta-pass-trek-4.jpg" alt="Hampta Pass Trek">
      </a>
    </div>
  ...
  <div class="slider-container">
    ...
    <!-- Images -->
    <img src="img/packageImage/hampta-pass-trek.jpg" alt="Hampta Pass Trek" class="active">
    <img src="img/packageImage/hampta-pass-trek-1.jpg" alt="Hampta Pass Trek">
    <img src="img/packageImage/hampta-pass-trek-2.jpg" alt="Hampta Pass Trek">
    <img src="img/packageImage/hampta-pass-trek-3.jpg" alt="Hampta Pass Trek">
  ...
  <h1 class="responsive-heading">Hampta Pass Trek</h1>
  ...
  <div id="newPackageCard" class="package-box">
    <div class="">
      ...
      <div class="package-details" style="margin-top: 5px;margin-bottom: 5px; font-size: 14px;">
        <span style="font-weight: bold;">Package Option:</span> INR 6500/- Manali to Manali
      </div>
  ...
  <div id="packageCard" class="sticky-package">
    <div class="package-container-price">
      <div class="pricing-wrapper">
        <div>
          <small>Starting from <span class="crossed-price">&#8377; 8124</span></small><br>
  ...
  <div class="tour-details">
    ...
    <div class="detail">
      ...
      <p class="value">Himachal, India</p>
    </div>
    <div class="detail">
          ...
          <div class="card ellipsis mb-5 mb-lg-0">
            <div class="card-body">
              ...
              <ul style="list-style: none; padding: 0;">
                ...
                Scenic Drive to Jobra: Witness lush valleys, pine forests, and rivers while driving from Manali to Jobra.
                </li>

                <li style="position: relative; padding-left: 20px; margin-bottom: 8px;">
                  <span style="left: 0; top: 4px; color:#ff5a13; font-size: 1.2em;">&#9679;</span>
             Chika Campsite: A beautiful meadow beside the Rani River, surrounded by mountains.
                </li>

                <li style="position: relative; padding-left: 20px; margin-bottom: 8px;">
                  <span style=" left: 0; top: 4px; color:#ff5a13; font-size: 1.2em;">&#9679;</span>
                Balu Ka Ghera: A vast open ground with mesmerizing views of the Dhauladhar range.
                </li>

                <li style="position: relative; padding-left: 20px; margin-bottom: 8px;">
                  <span style=" left: 0; top: 4px; color:#ff5a13; font-size: 1.2em;">&#9679;</span>
             Sehagoru Campsite: A remote, peaceful location amidst glaciers and streams.
                </li>

              
                <li style="position: relative; padding-left: 20px; margin-bottom: 8px;">
                  <span style=" left: 0; top: 4px; color:#ff5a13; font-size: 1.2em;">&#9679;</span>
            Chandratal Lake: A stunning high-altitude lake with crystal-clear blue waters.
                </li>
              
                <li style="position: relative; padding-left: 20px; margin-bottom: 8px;">
                  <span style=" left: 0; top: 4px; color:#ff5a13; font-size: 1.2em;">&#9679;</span>
           Varied Landscapes: Experience lush green valleys, barren mountains, snowy trails, and river crossings in one trek.
                </li>
                
                 <li style="position: relative; padding-left: 20px; margin-bottom: 8px;">
                  <span style=" left: 0; top: 4px; color:#ff5a13; font-size: 1.2em;">&#9679;</span>
          Adventure & Thrill: River crossings, snow trekking, and high-altitude mountain passes make it an exhilarating experience.
                </li>
                
                <li style="position: relative; padding-left: 20px; margin-bottom: 8px;">
                  <span style=" left: 0; top: 4px; color:#ff5a13; font-size: 1.2em;">&#9679;</span>
          Stargazing at Campsites: Enjoy unpolluted, clear night skies at high-altitude campsites.
                </li>
        ...
        <div class="col-lg-4 d-sm-block d-md-block d-lg-block order-3 order-lg-2">
          <div class="card ellipsis mb-5 mb-lg-0">
            <div class="card-body">
              ...
              <p><i class="fa-solid fa-hotel"></i> 4 Nights Accommodation during the trek will be provided using Std. Category of camps and Home stay Triple or Quad sharing basis.</p>
        ...
        <div class="col-lg-8 active show scroll-offset" id="OVERVIEW-ITINERARY" role="tabpanel" aria-labelledby="OVERVIEW-ITINERARY-tab">
          ...
          <div id="ITINERARY" class="scroll-offset " role="tabpanel" aria-labelledby="Things-To-Carry-tab">
            ...
            <div class="package-side-box mobile-short-itinerary p-4 mb-8" style="background:#f6f6f6;border-radius:15px">
              ...
              <br>
              <h2>Hampta Pass Trek Overview</h2>
             ...
             <p>The trek begins from Jobra, a small yet scenic village near Manali. A short drive from Manali (6,726 ft) to Jobra (9,800 ft) marks the beginning of this mesmerizing trek. The trail starts with a gentle ascent through dense pine forests, where you will encounter diverse flora and fauna. The journey is filled with meandering streams, wooden bridges, and vast meadows, creating a perfect introduction to the trek. Trekkers often take a moment to soak in the beauty of towering deodar and maple trees, setting the stage for the adventure ahead.</p>
              <hr/>
               ...
               <p><b>First Milestone: Chika Campsite</b></p>
               <p>A few hours of trekking from Jobra leads you to the Chika campsite (10,100 ft), a peaceful location beside the Rani River. The area is surrounded by snow-capped peaks and rolling green meadows, making it a perfect spot to rest. This campsite is an excellent place to acclimatize before heading to higher altitudes. As night falls, trekkers can enjoy stargazing, as the sky lights up with countless twinkling stars. The experience of camping in such pristine surroundings is one of the highlights of the Hampta Pass Trek.</p>
<p></p>
...
<hr/>
                ...
                <ul>
                <li>Nearest airport: Bhuntar Airport, 58 km from Manali.</li>
                <li>Regular flights connect Manali with major cities like Delhi and Mumbai.</li>
                 </ul>
                <ul>
                <p>By Road:</p>
                </ul>
                <ul>
                <li>From Delhi: 520 km, 10-12 hours by bus or private cab.</li>
               </ul>
                <hr/>
              <h3>Hampta Pass Trek Itinerary</h3>

              

              
              <p>Day 1: Manali to Jobra by Drive and Trek to Chika</p>
              <ul>
               <li><strong> Altitude Jobra:</strong> 9,800 Ft.</li>
                <li><strong> Altitude Chika:</strong> 10,100 Ft.</li>
               <li><strong> Drive Duration Manali to Jobra:</strong> 16 km | 1 Hours</li>
               <li><strong>Trek Distance:</strong> 3 km | 2 Hours</li>
             
               
              </ul>
              <p>Your adventure begins in Manali, a popular hill station nestled in the lap of the Himalayas. From here, embark on a scenic drive to Jobra (9,800 ft). The road winds through dense forests of pine and maple, offering stunning views of the Beas River. Upon reaching Jobra, the actual trekking starts.</p>
              <p>The trek from Jobra to Chika is an easy ascent, covering 3 km in about 2 hours. The trail takes you through lush green meadows, gushing streams, and wooden bridges. Upon reaching Chika campsite, set up your tents and enjoy a warm meal while soaking in the mesmerizing landscapes.</p>
              
              

              <p>Day 2: Chika to Balu Ka Ghera</p>
              <ul>
                 <li><strong> Altitude Balu Ka Ghera:</strong> 11,900 Ft.</li>
                 
                <li><strong>Trek Distance:</strong> 8 km | 5-6 Hours</li>
                
           
                
              </ul>
              <p>Wake up to the sound of birds chirping and fresh mountain air. After breakfast, start trekking toward Balu Ka Ghera. The trail follows the Rani Nallah, with occasional river crossings. The landscape transitions from lush meadows to a rocky terrain, with stunning views of snow-clad peaks.</p>
              <p>"Balu Ka Ghera" literally means "bed of sand" and serves as a base for Hampta Pass ascent. The campsite is surrounded by towering mountains and vast open spaces, making it an ideal place to rest and acclimatize.</p>

              <p>Day 3: Balu Ka Ghera to Hampta Pass to Sehagoru</p>
              <ul>
                  <li><strong>Altitude Hampta Pass:</strong> 14,100 Ft.</li>
                  <li><strong>Altitude Sehagoru:</strong> 12,900 Ft.</li>
                  <li><strong>Trek Distance:</strong> 14 km | 8-9 Hours</li>
               
                
              </ul>
              <p>Today is the most challenging yet rewarding part of the trek. Start early as you ascend toward Hampta Pass. The trail gets steeper, and you may have to walk over snow patches. As you reach the top at 14,100 ft, you'll be greeted with breathtaking 360° views of Lahaul Valley and Spiti Valley.</p>
              <p>After spending some time at the Hampta Pass summit, begin the descent toward Sehagoru, a remote and peaceful campsite in the Lahaul region. The trail down is steep, so trekking poles and good grip shoes are recommended.</p>

             <p>Day 4: Sehagoru to Chatru and Drive to Chandratal and Back to Chatru</p>
              <ul>
                  <li><strong>Altitude Sehagoru:</strong> 13,200 Ft.</li>
                  <li><strong>Altitude Chatru:</strong> 14,640 Ft.</li>
                  <li><strong>Altitude Chandratal:</strong> 14,640 Ft.</li>
                  <li><strong>Drive Distance:</strong> 70 km round trip | 3-4 Hours</li>
                   <li><strong>Trek Distance:</strong> 8 km | 4-5 Hours</li>
               
              
              </ul>
              <p>After a rejuvenating night at Sehagoru, begin your descent to Chatru, a small settlement in Spiti Valley. The trek involves crossing glacial streams and navigating rocky paths. Upon reaching Chatru, a vehicle will take you to Chandratal Lake (also called the "Moon Lake").</p>
              <p>The 70 km drive to Chandratal Lake is nothing short of spectacular, with barren landscapes and towering peaks. Chandratal, at 14,100 ft, is famous for its turquoise blue water and mystical aura. After spending some time here, drive back to Chatru, where you'll camp for the night.</p>

             <p>Day 5: Chatru to Manali</p>
              <ul>
                 
                  <li><strong>Drive Distance:</strong> 85 km | 5-6 Hours</li>
                 
               
              
              </ul>
              
              <p>On the final day, drive back to Manali via the Atal Tunnel or the Rohtang Pass (depending on weather conditions). The road journey offers mesmerizing views of the Pir Panjal Range. You’ll reach Manali by afternoon, marking the end of an unforgettable trekking experience.</p>
          ...
          <div class="scroll-offset " id="SHORT-ITINERARY" role="tabpanel" aria-labelledby="Things-To-Carry-tab">
            ...
            <div class="package-side-box mobile-short-itinerary p-4 mb-4" style="background:#f6f6f6;">
             ...
             <p><b>Day 1:</b> Manali to Jobra by Drive and Trek to Chika</p>
             

              <p><b>Day 2:</b> Chika to Balu Ka Ghera</p>
              

             <p><b>Day 3:</b> Balu Ka Ghera to Hampta Pass to Sehagoru</p>
             

              <p><b>Day 4:</b>Sehagoru to Chatru and Drive to Chandratal and Back to Chatru</p>
              

              <p><b>Day 5:</b>Chatru to Manali</p>
...
<p><b>1. What is the best time to do the Hampta Pass Trek?</b></p>
<p>The best time for Hampta Pass Trek is from June to September, as the weather is pleasant, and the trails are accessible.</p>
<p><b>2. How difficult is the Hampta Pass Trek?</b></p>
<p>The trek is moderate and suitable for beginners with basic fitness. However, it includes steep ascents and river crossings.</p>
<p><b>3. Do I need prior trekking experience?</b></p>
<p>No, prior experience is not mandatory, but good fitness is required for the long trekking hours.</p>
<p><b>4. What is the total trekking distance?</b></p>
<p>The Hampta Pass Trek covers approximately 35-40 km over 5 days.</p>
<p><b>5. What is the highest altitude reached?</b></p>
<p>The highest point of the trek is Hampta Pass at 14,100 ft.</p>
<p><b>6. Will there be snow on the trek?</b></p>
<p>Yes, June and early July have snow at Hampta Pass, while August and September have greener landscapes.</p>
<p><b>7. Is a permit required for the trek?</b></p>
<p>Yes, permits are required and can be obtained in Manali. Trek organizers usually arrange them.</p>
<p><b>8. What should I pack for the trek?</b></p>
<p>Carry waterproof trekking shoes, warm clothes, rain gear, trekking poles, a sleeping bag, a headlamp, and essential medicines.</p>
<p><b>9. Are there mobile networks on the trek?</b></p>
<p>No, you will lose network connectivity after Jobra and regain it only after returning to Manali.</p>
