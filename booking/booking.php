...
if (isset($_POST['submit'])) {
  ...
  $Total = $Subtotal + $GST;
  $TransactionCharges = ($Total * 3) / 100;
  $GrandTotal = $Total + $TransactionCharges;
...
<body onload="submitPayuForm()">
  ...
  <div class="container mb-4">
      ...
      <div class="col-md-12 px-0">
        <ul id="progressbar" class=" py-4 my-4">
        ...
        <form action="<?php echo $action; ?>" method="post" name="payuForm">
                    ...
                    <div class="card-body">
                      <div class="row mb-4">
                        ...
                        <div class="col-sm-4">
                          ...
                          <div>Booking Date : <?php echo date("j M Y") ?></div>
                        </div>
                      </div>
                      <div class="table-responsive-sm">
                        <table class="table table-striped">
                          ...
                          <tbody>
                            ...
                            ?>
                              <tr>
                                <td class="left">Off-loading</td>
                                <td class="center"><?php echo $PersonCount ?></td>
                                <td class="right"><SPAN class="RupeeSign">&#8377;</SPAN> <?php echo moneyFormatIndia($Offloading) ?></td>
                                <td class="right"><SPAN class="RupeeSign">&#8377;</SPAN> <?php echo moneyFormatIndia($Offloading * $PersonCount) ?></td>
                              </tr>
                            <?php
                            }
                            ?>
                            ...
                            ?>
                              <tr>
                                ...
                                <td class="center"><?php echo $PersonCount ?></td>
                                <td class="right"><SPAN class="RupeeSign">&#8377;</SPAN> <?php echo moneyFormatIndia($Rental) ?></td>
                                <td class="right"><SPAN class="RupeeSign">&#8377;</SPAN> <?php echo moneyFormatIndia($Rental * $PersonCount) ?></td>
                              </tr>
                            <?php
                            }
                            ?>
                            ...
                            ?>
                              <tr>
                                <td class="left">Zip line</td>
                                <td class="center"><?php echo $PersonCount ?></td>
                                <td class="right"><SPAN class="RupeeSign">&#8377;</SPAN> <?php echo moneyFormatIndia($ZIPADD) ?></td>
                                <td class="right"><SPAN class="RupeeSign">&#8377;</SPAN> <?php echo moneyFormatIndia($ZIPADD * $PersonCount) ?></td>
                              </tr>
                            <?php
                            }
                            ?>
                          ...
                          <table class="table table-clear">
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td class="right">
                                  <strong><SPAN class="RupeeSign">&#8377;</SPAN> <?php echo  moneyFormatIndia($Total) ?></strong>
                                </td>
                              </tr>
                              <tr>
                                <td class="left">
                                  <strong>Online Transaction Charges</strong>
                                </td>
                                <td class="right">
                                  <strong><SPAN class="RupeeSign">&#8377;</SPAN> <?php echo  moneyFormatIndia($TransactionCharges) ?></strong>
                                </td>
                              </tr>
          ...
          <table style="display: none;">
            ...
            <tr>
              <td>Amount: </td>
              <td><input name="amount" type="number" value="<?php echo $_SESSION["GrandTotal"] ?>" /></td>
              <td>First Name: </td>
            ...
            <tr>
              ...
              <td>Phone: </td>
              <td><input name="phone" value="<?php echo $_SESSION["Contact"]; ?>" /></td>
            </tr>
            <tr>
              <td>Product Info: </td>
              <td colspan="3"><textarea name="productinfo"><?php echo $_SESSION["Invoice_No"] ?></textarea></td>
            </tr>
            <tr>
              <td>Success URI: </td>
              <td colspan="3"><input name="surl" value="<?php echo $root1 ?>/booking/success.php" size="64" /></td>
            </tr>
            <tr>
              <td>Failure URI: </td>
              <td colspan="3"><input name="furl" value="<?php echo $root1 ?>/booking/failure.php" size="64" /></td>
            </tr>
            ...
            <tr>
              <td>Address1: </td>
              <td><input name="address1" value="<?php echo $_SESSION["Name"]; ?>" /></td>
              <td>Address2: </td>
