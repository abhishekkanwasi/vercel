...
<h1 class="top-treks">Best Himalayan Treks in India</h1>

<div class="offer slider">
    <div>
        <a><img data-lazy="img/packageImage/uttarakhand-treks.jpg" data-sizes="100vw" alt="uttarakhand treks"></a>
    </div>
    <div>
        <a><img data-lazy="img/packageImage/Kashmir-treks.jpg" data-sizes="100vw" alt="Kashmir treks"></a>
    </div>
    
    <div>
        <a><img data-lazy="img/packageImage/himachal-treks.jpg" data-sizes="100vw" alt="himachal treks"></a>
    </div>
    ...
    <div class="custom-dropdown" id="filterDropdown">
      <div class="dropdown-select">Select by destination </div>
  ...
  window.addEventListener('DOMContentLoaded', (event) => {
        ...
        <div class="card-grid">
          ...
          <a class="my_card" href="kedarkantha-trek.php" target="_Blank">
            <div style="border: 1px solid #e0e0e0;" class="box">
              ...
              <img class="card-img-top" width="355" height="220" src="img/packageImage/kedarkantha-trek-2.jpg" data-lazy="img/packageImage/kedarkantha-trek-2.jpg" alt="Kedarkantha Trek">
              <div class="p-2">
          ...
          <a class="my_card" href="borasu-pass-trek.php" target="_Blank">
            <div style="border: 1px solid #e0e0e0;" class="box">
              ...
              <div class="ribbon-review"><i style="color: #ffd604;margin-left: 8px" class="fa fa-star mr-2"></i>4.8 <small>(126 Reviews)</small> </div>
              <img class="card-img-top" width="355" height="220" src="img/packageImage/borasu-pass-trek.jpg" data-lazy="img/packageImage/borasu-pass-trek.jpg" alt="Borasu Pass Trek">
              <div class="p-2">
                <div class="price-details">
                  <div style="padding-top: 5px;">
                    <h5 class="card-trek-name" style="text-align: center; font-size: 1.2em; font-weight: bold;">
        ...
        <div class="card-grid">
          ...
          <a class="my_card" href="dodital-darwa-pass-trek.php" target="_Blank">
            <div style="border: 1px solid #e0e0e0;" class="box">
              ...
              <div class="ribbon-review"><i style="color: #ffd604;margin-left: 8px" class="fa fa-star mr-2"></i>4.8 <small>(126 Reviews)</small> </div>
              <img class="card-img-top" width="355" height="220" src="img/packageImage/dodital-trek.jpg" data-lazy="img/packageImage/dodital-trek.jpg" alt="Dodital Darwa Pass Trek">
              <div class="p-2">
                <div class="price-details">
                  <div style="padding-top: 5px;">
                    <h5 class="card-trek-name" style="text-align: center; font-size: 1.2em; font-weight: bold;">
          ...
          <a class="my_card" href="gaumukh-tapovan-trek.php" target="_Blank">
            <div style="border: 1px solid #e0e0e0;" class="box">
              ...
              <div class="ribbon-review"><i style="color: #ffd604;margin-left: 8px" class="fa fa-star mr-2"></i>4.8 <small>(126 Reviews)</small> </div>
              <img class="card-img-top" width="355" height="220" src="img/packageImage/gaumukh-tapovan-trek.jpg" data-lazy="img/packageImage/gaumukh-tapovan-trek.jpg" alt="Gaumukh Tapovan Trek">
              <div class="p-2">
                <div class="price-details">
                  <div style="padding-top: 5px;">
                    <h5 class="card-trek-name" style="text-align: center; font-size: 1.2em; font-weight: bold;">
          ...
          <a class="my_card" href="phulara-ridge-trek.php" target="_Blank">
            <div style="border: 1px solid #e0e0e0;" class="box">
              ...
              <div class="ribbon-review"><i style="color: #ffd604;margin-left: 8px" class="fa fa-star mr-2"></i>4.8 <small>(126 Reviews)</small> </div>
              <img class="card-img-top" width="355" height="220" src="img/packageImage/phulara-ridge-trek.jpg" data-lazy="img/packageImage/phulara-ridge-trek.jpg" alt="Phulara Ridge Trek">
              <div class="p-2">
                <div class="price-details">
                  <div style="padding-top: 5px;">
                    <h5 class="card-trek-name" style="text-align: center; font-size: 1.2em; font-weight: bold;">
        ...
        <div class="card-grid">
          ...
          <a class="my_card" href="kuari-pass-trek.php" target="_Blank">
            <div style="border: 1px solid #e0e0e0;" class="box">
              ...
              <div class="ribbon-review"><i style="color: #ffd604;margin-left: 8px" class="fa fa-star mr-2"></i>4.8 <small>(126 Reviews)</small> </div>
              <img class="card-img-top" width="355" height="220" src="img/packageImage/kuari-pass-trek.jpg" data-lazy="img/packageImage/kuari-pass-trek.jpg" alt="Kuari Pass Trek">
              <div class="p-2">
                <div class="price-details">
                  <div style="padding-top: 5px;">
                    <h5 class="card-trek-name" style="text-align: center; font-size: 1.2em; font-weight: bold;">
        ...
        <div class="card-grid">
          ...
          <a class="my_card" href="kashmir-great-lakes-trek.php" target="_Blank">
            <div style="border: 1px solid #e0e0e0;" class="box">
              ...
              <div class="ribbon-review"><i style="color: #ffd604;margin-left: 8px" class="fa fa-star mr-2"></i>4.8 <small>(126 Reviews)</small> </div>
              <img class="card-img-top" width="355" height="220" src="img/packageImage/kashmir-great-lakes-1.jpg" data-lazy="img/packageImage/kashmir-great-lakes-1.jpg" alt="Kashmir Great Lakes Trek">
              <div class="p-2">
                <div class="price-details">
                  <div style="padding-top: 5px;">
                    <h5 class="card-trek-name" style="text-align: center; font-size: 1.2em; font-weight: bold;">
          ...
          <a class="my_card" href="valley-of-flowers-trek.php" target="_Blank">
            <div style="border: 1px solid #e0e0e0;" class="box">
              ...
              <div class="ribbon-review"><i style="color: #ffd604;margin-left: 8px" class="fa fa-star mr-2"></i>4.8 <small>(126 Reviews)</small> </div>
              <img class="card-img-top" width="355" height="220" src="img/packageImage/valley-of-flowers-trek.jpg" data-lazy="img/packageImage/valley-of-flowers-trek.jpg" alt="Valley of Flowers Trek">
              <div class="p-2">
                <div class="price-details">
                  <div style="padding-top: 5px;">
                    <h5 class="card-trek-name" style="text-align: center; font-size: 1.2em; font-weight: bold;">
    ...
    <section id="section-uttarakhand" class="filter-section active ">
      ...
      <h2>Summer Treks Uttarakhand</h2>
      <!-- Wrap the grid in a slider container -->
      <div class="card-slider">
        <div class="card-grid">
          <!-- Example Card -->
          ...
          <!-- Add additional cards as needed -->
            ...
            <h2>Winter Treks Uttarakhand</h2>
      <!-- Wrap the grid in a slider container -->
      <div class="card-slider">
        <div class="card-grid">
          <!-- Example Card -->
          ...
          <!-- Add additional cards as needed -->
            ...
            <h2>Monsoon Treks Uttarakhand</h2>
      <!-- Wrap the grid in a slider container -->
      <div class="card-slider">
        <div class="card-grid">
          <!-- Example Card -->
    ...
    <section id="section-kashmir" class="filter-section active">
      <h2>Recommended Treks Kashmir</h2>
      <!-- Wrap the grid in a slider container -->
      <div class="card-slider">
        <div class="card-grid">
          <!-- Example Card -->
