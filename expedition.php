...
$(document).ready(function(){
    ...
    <h1 class="top-treks">Discover New Expeditions
    </h1>

<div class="offer slider">
    <div>
        <a><img data-lazy="img/packageImage/expedition-banner.jpg" data-sizes="100vw" alt="expedition"></a>
    </div>
    <div>
        <a><img data-lazy="img/packageImage/expedition-banner-1.jpg" data-sizes="100vw" alt="expedition 1"></a>
    </div>
    <div>
        <a><img data-lazy="img/packageImage/expedition-banner-2.jpg" data-sizes="100vw" alt="expedition 2"></a>
    </div>
