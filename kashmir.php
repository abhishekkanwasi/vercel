...
<h1 class="top-treks">Kashmir Tour Packages</h1>

<div class="offer slider">
    <div>
        <a><img data-lazy="img/packageImage/kashmir-banner.jpg" data-sizes="100vw" alt="kashmir Tour Package"></a>
    </div>
   
</div>


        <p>Kashmir, often referred to as "Paradise on Earth," offers breathtaking landscapes, serene lakes, and a rich cultural heritage, making it a sought-after destination for travelers. From the picturesque Dal Lake in Srinagar to the lush meadows of Gulmarg and the tranquil valleys of Pahalgam, there's much to explore.</p>
...
<a class="my_card" href="kashmir-great-lakes-trek.php" target="_Blank">
            <div style="border: 1px solid #e0e0e0;" class="box">
              ...
              <div class="ribbon-review"><i style="color: #ffd604;margin-left: 8px" class="fa fa-star mr-2"></i>4.9 <small>(106 Reviews)</small> </div>
      ...
      <!--<h2>Recommended Yatras Kashmir</h2>-->
      <!-- Wrap the grid in a slider container -->
      <!--<div class="card-slider">-->
      <!--  <div class="card-grid">-->
          <!-- Example Card -->
      ...
      <!--<h2>Recommended Expeditions Kashmir</h2>-->
      <!-- Wrap the grid in a slider container -->
      <!--<div class="card-slider">-->
      <!--  <div class="card-grid">-->
          <!-- Example Card -->
    ...
    <section id="section-treks" class="filter-section active ">
      ...
      <h2>Best Selling Treks Kashmir</h2>
      <!-- Wrap the grid in a slider container -->
      <div class="card-slider">
        <div class="card-grid">
          <!-- Example Card -->
      ...
      <h2>Best Monsoon Treks Kashmir</h2>
      <!-- Wrap the grid in a slider container -->
      <div class="card-slider">
        <div class="card-grid">
          <!-- Example Card -->
    ...
    <!--  <h2>Best Selling Yatras Kashmir</h2>-->
      <!-- Wrap the grid in a slider container -->
    <!--  <div class="card-slider">-->
    <!--    <div class="card-grid">-->
          <!-- Example Card -->
    ...
    <!--  <h2>Best Selling Expeditions Kashmir</h2>-->
      <!-- Wrap the grid in a slider container -->
    <!--  <div class="card-slider">-->
    <!--    <div class="card-grid">-->
          <!-- Example Card -->
