...
<head>
  ...
  <link rel="shortcut icon" href="src/icons/" type="image/x-icon" />
  <link rel="apple-touch-icon" type="image/x-icon" href="src/icons/" />
  <link rel="apple-touch-icon" type="image/x-icon" sizes="72x72" href="src/icons/" />
  <link rel="apple-touch-icon" type="image/x-icon" sizes="114x114" href="src/icons/" />
  <link rel="apple-touch-icon" type="image/x-icon" sizes="144x144" href="src/icons/" />
...
<h1 class="top-treks">UTTARAKHAND</h1>


    <div class="custom-dropdown" id="filterDropdown">
      <div class="dropdown-select">Filter by destination </div>
